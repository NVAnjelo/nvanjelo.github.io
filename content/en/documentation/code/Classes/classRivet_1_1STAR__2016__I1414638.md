...
title: "Rivet::STAR_2016_I1414638"
summary: "Third harmonic of azimuthal correlations in Au+Au collisions. "

---

# Rivet::STAR_2016_I1414638



Third harmonic of azimuthal correlations in Au+Au collisions. 
...
|                | Name           |
| -------------- | -------------- |
| | **[STAR_2016_I1414638](http://example.org/classes/classrivet_1_1star__2016__i1414638/#function-star-2016-i1414638)**()<br>Constructor  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__2016__i1414638/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__2016__i1414638/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__2016__i1414638/#function-finalize)**()<br>Normalise histograms etc., after the run.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< double > | **[centralityBins](http://example.org/classes/classrivet_1_1star__2016__i1414638/#variable-centralitybins)**  |
| map< double, <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> > | **[h_v32](http://example.org/classes/classrivet_1_1star__2016__i1414638/#variable-h-v32)**  |
...
### function STAR_2016_I1414638

```cpp
inline STAR_2016_I1414638()
```
...
Projections The centrality projection. 
