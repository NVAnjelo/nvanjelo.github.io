...
title: "Rivet::ATLAS_2014_I1288706"

---

# Rivet::ATLAS_2014_I1288706
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1288706/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1288706/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillPlots](http://example.org/classes/classrivet_1_1atlas__2014__i1288706/#function-fillplots)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zfinder, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist, double leading_pT)<br>Helper function to fill the histogram if a Z is found with the required lepton cuts.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1288706/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2014_I1288706](http://example.org/classes/classrivet_1_1atlas__2014__i1288706/#function-atlas-2014-i1288706)**()<br>Constructor.  |
...
### function ATLAS_2014_I1288706

```cpp
inline ATLAS_2014_I1288706()
```
