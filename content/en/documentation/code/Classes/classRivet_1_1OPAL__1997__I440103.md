...
title: "Rivet::OPAL_1997_I440103"
summary: "Add a short analysis description here. "

---

# Rivet::OPAL_1997_I440103
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1opal__1997__i440103/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1opal__1997__i440103/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcRho](http://example.org/classes/classrivet_1_1opal__1997__i440103/#function-calcrho)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist, unsigned int mode) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1opal__1997__i440103/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1opal__1997__i440103/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1opal__1997__i440103/">OPAL_1997_I440103</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_B](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-b)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_B2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-b2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_ctheta](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_ctheta2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-ctheta2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_ctheta3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-ctheta3)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_ctheta4](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-ctheta4)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_alpha](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-alpha)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_alpha2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-alpha2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_alpha3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-alpha3)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_alpha4](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-alpha4)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_beta](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-beta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_beta2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-beta2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_beta3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-beta3)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_phi_beta4](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-phi-beta4)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_plus](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-plus)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_neg](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-neg)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_plus2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-plus2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_neg2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-neg2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_plus3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-plus3)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_cos_neg3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-cos-neg3)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_plus](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-plus)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_neg](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-neg)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_plus2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-plus2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_neg2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-neg2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_plus3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-plus3)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_phi_sin_neg3](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--c-phi-sin-neg3)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DS_ctheta](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-ds-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DS_ctheta2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-ds-ctheta2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DS_alpha](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-ds-alpha)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DS_alpha2](http://example.org/classes/classrivet_1_1opal__1997__i440103/#variable--h-ds-alpha2)**  |
...
TodoYuck... does this _really_ have to be quark-based?!? 
...
```cpp
inline pair< double, double > calcRho(
    Histo1DPtr hist,
    unsigned int mode
)
```
...
### variable _h_phi_ctheta

```cpp
Histo1DPtr _h_phi_ctheta;
```


### variable _h_phi_ctheta2

```cpp
Histo1DPtr _h_phi_ctheta2;
```


### variable _h_phi_ctheta3

```cpp
Histo1DPtr _h_phi_ctheta3;
```


### variable _h_phi_ctheta4

```cpp
Histo1DPtr _h_phi_ctheta4;
```


### variable _h_phi_alpha

```cpp
Histo1DPtr _h_phi_alpha;
```


### variable _h_phi_alpha2

```cpp
Histo1DPtr _h_phi_alpha2;
```


### variable _h_phi_alpha3

```cpp
Histo1DPtr _h_phi_alpha3;
```


### variable _h_phi_alpha4

```cpp
Histo1DPtr _h_phi_alpha4;
```


### variable _h_phi_beta

```cpp
Histo1DPtr _h_phi_beta;
```


### variable _h_phi_beta2

```cpp
Histo1DPtr _h_phi_beta2;
```


### variable _h_phi_beta3

```cpp
Histo1DPtr _h_phi_beta3;
```


### variable _h_phi_beta4

```cpp
Histo1DPtr _h_phi_beta4;
```


### variable _c_phi_cos_plus

```cpp
CounterPtr _c_phi_cos_plus;
```


### variable _c_phi_cos_neg

```cpp
CounterPtr _c_phi_cos_neg;
```


### variable _c_phi_cos_plus2

```cpp
CounterPtr _c_phi_cos_plus2;
```


### variable _c_phi_cos_neg2

```cpp
CounterPtr _c_phi_cos_neg2;
```


### variable _c_phi_cos_plus3

```cpp
CounterPtr _c_phi_cos_plus3;
```


### variable _c_phi_cos_neg3

```cpp
CounterPtr _c_phi_cos_neg3;
```


### variable _c_phi_sin_plus

```cpp
CounterPtr _c_phi_sin_plus;
```


### variable _c_phi_sin_neg

```cpp
CounterPtr _c_phi_sin_neg;
```


### variable _c_phi_sin_plus2

```cpp
CounterPtr _c_phi_sin_plus2;
```


### variable _c_phi_sin_neg2

```cpp
CounterPtr _c_phi_sin_neg2;
```


### variable _c_phi_sin_plus3

```cpp
CounterPtr _c_phi_sin_plus3;
```


### variable _c_phi_sin_neg3

```cpp
CounterPtr _c_phi_sin_neg3;
```


### variable _h_DS_ctheta

```cpp
Histo1DPtr _h_DS_ctheta;
```


### variable _h_DS_ctheta2

```cpp
Histo1DPtr _h_DS_ctheta2;
```


### variable _h_DS_alpha

```cpp
Histo1DPtr _h_DS_alpha;
```


### variable _h_DS_alpha2

```cpp
Histo1DPtr _h_DS_alpha2;
```
