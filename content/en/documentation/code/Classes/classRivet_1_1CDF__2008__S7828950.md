...
title: "Rivet::CDF_2008_S7828950"
summary: "CDF Run II inclusive jet cross-section using the Midpoint algorithm. "

---

# Rivet::CDF_2008_S7828950



CDF Run II inclusive jet cross-section using the Midpoint algorithm.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2008__s7828950/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2008__s7828950/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2008__s7828950/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2008__s7828950/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2008__s7828950/">CDF_2008_S7828950</a> ) |
...
```cpp
class Rivet::CDF_2008_S7828950;
```

CDF Run II inclusive jet cross-section using the Midpoint algorithm. 

The analysis includes 1.1fb^-1 of CDF data and is the first with a cone algorithm to include the forward region of the detector. arXiv:0807.2204 to be published in PRD 
