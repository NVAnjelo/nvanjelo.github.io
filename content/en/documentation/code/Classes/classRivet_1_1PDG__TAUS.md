...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pdg__taus/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pdg__taus/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pdg__taus/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| bool | **[contains](http://example.org/classes/classrivet_1_1pdg__taus/#function-contains)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, int id, bool abs =false) |
| int | **[countProngs](http://example.org/classes/classrivet_1_1pdg__taus/#function-countprongs)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother) |
| void | **[populateDecayMap](http://example.org/classes/classrivet_1_1pdg__taus/#function-populatedecaymap)**() |
| bool | **[analyzeDecay](http://example.org/classes/classrivet_1_1pdg__taus/#function-analyzedecay)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, vector< int > ids, bool absolute) |
| void | **[analyzeRadiativeDecay](http://example.org/classes/classrivet_1_1pdg__taus/#function-analyzeradiativedecay)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, vector< int > ids, <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> & w_incl, bool absolute, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> h_ratio) |
| | **[PDG_TAUS](http://example.org/classes/classrivet_1_1pdg__taus/#function-pdg-taus)**()<br>Constructor.  |
...
### function countProngs

```cpp
inline int countProngs(
    Particle mother
)
```


### function populateDecayMap

```cpp
inline void populateDecayMap()
```
...
### function analyzeRadiativeDecay

```cpp
inline void analyzeRadiativeDecay(
    Particle mother,
    vector< int > ids,
    CounterPtr & w_incl,
    bool absolute,
