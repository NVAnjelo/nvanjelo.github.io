...
title: "Rivet::LHCB_2013_I1243156"
summary: "Add a short analysis description here. "

---

# Rivet::LHCB_2013_I1243156
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & dstar, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & d0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi, unsigned int & ncount)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/">LHCB_2013_I1243156</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D1_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-d1-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-d2-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DStar2S_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-dstar2s-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D3_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-d3-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2S_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-d2s-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D21D_ctheta](http://example.org/classes/classrivet_1_1lhcb__2013__i1243156/#variable--h-d21d-ctheta)**  |
...
### variable _h_D1_ctheta

```cpp
Histo1DPtr _h_D1_ctheta;
```


### variable _h_D2_ctheta
...
### variable _h_DStar2S_ctheta

```cpp
Histo1DPtr _h_DStar2S_ctheta;
```


### variable _h_D3_ctheta

```cpp
Histo1DPtr _h_D3_ctheta;
```


### variable _h_D2S_ctheta

```cpp
Histo1DPtr _h_D2S_ctheta;
```


### variable _h_D21D_ctheta

```cpp
Histo1DPtr _h_D21D_ctheta;
```
