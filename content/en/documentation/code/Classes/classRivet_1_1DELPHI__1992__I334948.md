...
title: "Rivet::DELPHI_1992_I334948"
summary: "Charged multiplicity for different numbers of final state jets. "

---

# Rivet::DELPHI_1992_I334948



Charged multiplicity for different numbers of final state jets. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1delphi__1992__i334948/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1delphi__1992__i334948/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1delphi__1992__i334948/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1delphi__1992__i334948/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1delphi__1992__i334948/">DELPHI_1992_I334948</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_mult](http://example.org/classes/classrivet_1_1delphi__1992__i334948/#variable--h-mult)**  |
