...
title: "Rivet::MC_MUONS"
summary: "MC validation analysis for muons. "
...
MC validation analysis for muons. 
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_MUONS](http://example.org/classes/classrivet_1_1mc__muons/#function-mc-muons)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__muons/#function-init)**()<br>Bookings as usual, using the particle name specified by the derived classe.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__muons/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>To be implemented by derived classes, making particle selection then calling _analyze.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__muons/#function-finalize)**()<br>Normalization, division, etc.  |
