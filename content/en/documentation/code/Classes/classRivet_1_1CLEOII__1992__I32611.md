...
title: "Rivet::CLEOII_1992_I32611"
summary: "chi_b(2S) decays "

---

# Rivet::CLEOII_1992_I32611
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> parent, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & children, unsigned int & nCharged) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__1992__i32611/">CLEOII_1992_I32611</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_N](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#variable--h-n)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_R2](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#variable--h-r2)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> > | **[_h_N_aver](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#variable--h-n-aver)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> > | **[_h_R2_aver](http://example.org/classes/classrivet_1_1cleoii__1992__i32611/#variable--h-r2-aver)**  |
...
```cpp
vector< Profile1DPtr > _h_R2_aver;
```
