...
title: "Rivet::CDF_2009_S8233977"
summary: "CDF Run II min-bias cross-section. "

---

# Rivet::CDF_2009_S8233977



CDF Run II min-bias cross-section.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2009__s8233977/#function-init)**()<br>Book histograms and projections.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2009__s8233977/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & evt)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2009__s8233977/#function-finalize)**()<br>Normalize histos.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2009__s8233977/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2009__s8233977/">CDF_2009_S8233977</a> ) |
...
Measurement of \( \langle p_T \rangle \) vs. \( n_\text{ch} \), the track \( p_T \) distribution, and the \( \sum E_T \) distribution. <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> are selected within |eta|<1 and with pT>0.4 GeV. There is no pT cut for the \( \sum E_T \) measurement.
...
TodoThe pT and sum(ET) distributions look slightly different from Niccolo's Monte Carlo plots. Still waiting for his answer. 
