...
title: "Rivet::BELLE_2002_I563840"
summary: "charmonium production at 10.6 GeV "

---

# Rivet::BELLE_2002_I563840



charmonium production at 10.6 GeV 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findLeptons](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-findleptons)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lp, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lm) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, pair< double, double > > | **[calcAlpha](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1belle__2002__i563840/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1belle__2002__i563840/">BELLE_2002_I563840</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Jpsi](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-jpsi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Psi2](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-psi2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_feed](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-feed)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_JPsi_all](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-sig-jpsi-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_Jpsi_high](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-sig-jpsi-high)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_Jpsi_feed](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-sig-jpsi-feed)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_Psi2_high](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-sig-psi2-high)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cS_low](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-cs-low)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cS_high](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-cs-high)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cH_low](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-ch-low)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cH_high](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-ch-high)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_cThetaStar](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-cthetastar)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_cThetaH](http://example.org/classes/classrivet_1_1belle__2002__i563840/#variable--h-cthetah)**  |
...
### function findLeptons

```cpp
inline void findLeptons(
...
```cpp
inline pair< double, pair< double, double > > calcAlpha(
    Histo1DPtr hist
)
```
...
### variable _h_sig_JPsi_all

```cpp
Histo1DPtr _h_sig_JPsi_all;
```


### variable _h_sig_Jpsi_high

```cpp
Histo1DPtr _h_sig_Jpsi_high;
```


### variable _h_sig_Jpsi_feed

```cpp
Histo1DPtr _h_sig_Jpsi_feed;
```


### variable _h_sig_Psi2_high

```cpp
Histo1DPtr _h_sig_Psi2_high;
```
...
```cpp
Histo1DPtr _h_cH_high;
```


### variable _h_cThetaStar

```cpp
BinnedHistogram _h_cThetaStar;
```
