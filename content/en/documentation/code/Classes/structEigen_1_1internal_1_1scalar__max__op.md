...
title: "Eigen::internal::scalar_max_op"
...
|                | Name           |
| -------------- | -------------- |
| typedef <a href="http://example.org/classes/structeigen_1_1scalarbinaryoptraits/">ScalarBinaryOpTraits</a>< LhsScalar, RhsScalar, <a href="http://example.org/classes/structeigen_1_1internal_1_1scalar__max__op/">scalar_max_op</a> >::ReturnType | **[result_type](http://example.org/classes/structeigen_1_1internal_1_1scalar__max__op/#typedef-result-type)**  |
...
```cpp
typedef ScalarBinaryOpTraits<LhsScalar,RhsScalar,scalar_max_op>::ReturnType Eigen::internal::scalar_max_op< LhsScalar, RhsScalar >::result_type;
```
