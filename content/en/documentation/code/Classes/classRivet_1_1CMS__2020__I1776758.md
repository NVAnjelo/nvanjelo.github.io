...
title: "Rivet::CMS_2020_I1776758"
summary: "Ratios of cross sections in the associated production of a Z boson with at least one charm or bottom quark jet are measured in proton-proton collisions at 13 TeV. "

---

# Rivet::CMS_2020_I1776758



Ratios of cross sections in the associated production of a Z boson with at least one charm or bottom quark jet are measured in proton-proton collisions at 13 TeV. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2020__i1776758/">CMS_2020_I1776758</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_jet_pt_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-jet-pt-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_jet_pt_cjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-jet-pt-cjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_jet_pt_bjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-jet-pt-bjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Z_pt_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-z-pt-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Z_pt_cjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-z-pt-cjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Z_pt_bjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-z-pt-bjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_jet_pt_cjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-jet-pt-cjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_jet_pt_bjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-jet-pt-bjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_jet_pt_cb_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-jet-pt-cb-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_Z_pt_cjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-z-pt-cjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_Z_pt_bjet_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-z-pt-bjet-combined)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_R_Z_pt_cb_combined](http://example.org/classes/classrivet_1_1cms__2020__i1776758/#variable--h-r-z-pt-cb-combined)**  |
...
### variable _h_jet_pt_cjet_combined
...
### variable _h_jet_pt_bjet_combined
...
### variable _h_Z_pt_combined

```cpp
Histo1DPtr _h_Z_pt_combined;
```


### variable _h_Z_pt_cjet_combined

```cpp
Histo1DPtr _h_Z_pt_cjet_combined;
```


### variable _h_Z_pt_bjet_combined

```cpp
Histo1DPtr _h_Z_pt_bjet_combined;
```


### variable _h_R_jet_pt_cjet_combined

```cpp
Scatter2DPtr _h_R_jet_pt_cjet_combined;
```


### variable _h_R_jet_pt_bjet_combined

```cpp
Scatter2DPtr _h_R_jet_pt_bjet_combined;
```


### variable _h_R_jet_pt_cb_combined

```cpp
Scatter2DPtr _h_R_jet_pt_cb_combined;
```


### variable _h_R_Z_pt_cjet_combined

```cpp
Scatter2DPtr _h_R_Z_pt_cjet_combined;
```


### variable _h_R_Z_pt_bjet_combined

```cpp
Scatter2DPtr _h_R_Z_pt_bjet_combined;
```


### variable _h_R_Z_pt_cb_combined

```cpp
Scatter2DPtr _h_R_Z_pt_cb_combined;
```
