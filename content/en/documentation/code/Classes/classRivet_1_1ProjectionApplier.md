...
title: "Rivet::ProjectionApplier"
summary: "Common base class for Projection and Analysis, used for internal polymorphism. "
...
Common base class for <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> and <a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a>, used for internal polymorphism.  [More...](#detailed-description)


`#include <ProjectionApplier.hh>`

Inherited by [Rivet::Analysis](http://example.org/classes/classrivet_1_1analysis/), [Rivet::CentralityBinner< T, MDist >](http://example.org/classes/classrivet_1_1centralitybinner/), [Rivet::Projection](http://example.org/classes/classrivet_1_1projection/)
...
Common base class for <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> and <a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a>, used for internal polymorphism. 

Empty interface used for storing <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> and <a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a> pointers in the same container (used by the <a href="http://example.org/classes/classrivet_1_1projectionhandler/">ProjectionHandler</a>) 
