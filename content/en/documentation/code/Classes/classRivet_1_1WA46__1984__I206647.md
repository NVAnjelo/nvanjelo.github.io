...
title: "Rivet::WA46_1984_I206647"
summary: "Omega decay asymmetries. "

---

# Rivet::WA46_1984_I206647
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcAlpha](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1wa46__1984__i206647/">WA46_1984_I206647</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetalam](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#variable--h-cthetalam)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetaxi0](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#variable--h-cthetaxi0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetaxim](http://example.org/classes/classrivet_1_1wa46__1984__i206647/#variable--h-cthetaxim)**  |
...
### variable _h_cthetalam

```cpp
Histo1DPtr _h_cthetalam;
```


### variable _h_cthetaxi0

```cpp
Histo1DPtr _h_cthetaxi0;
```


### variable _h_cthetaxim

```cpp
Histo1DPtr _h_cthetaxim;
```
