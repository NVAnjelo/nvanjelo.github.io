...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2011_S9041966](http://example.org/classes/classrivet_1_1atlas__2011__s9041966/#function-atlas-2011-s9041966)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__s9041966/#function-init)**()<br>Book histograms and initialize projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__s9041966/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__s9041966/#function-finalize)**() |
...
### function ATLAS_2011_S9041966

```cpp
inline ATLAS_2011_S9041966()
```
