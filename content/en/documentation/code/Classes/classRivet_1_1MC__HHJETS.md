...
title: "Rivet::MC_HHJETS"
summary: "MC validation analysis for higgs pairs events (stable Higgses) "
...
MC validation analysis for higgs pairs events (stable Higgses) 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__hhjets/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__hhjets/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__hhjets/#function-finalize)**()<br>Finalize.  |
| | **[MC_HHJETS](http://example.org/classes/classrivet_1_1mc__hhjets/#function-mc-hhjets)**()<br>Default constructor.  |
