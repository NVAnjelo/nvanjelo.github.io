...
title: "Rivet::ZEUS_2008_I810112"
summary: "Measurement of $D^{avoidpm}$ and $D^0$ production in deep inelastic scattering using a lifetime tag at HERA. "

---

# Rivet::ZEUS_2008_I810112



Measurement of $D^{\pm}$ and $D^0$ production in deep inelastic scattering using a lifetime tag at HERA.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| int | **[_getbinQ2_OK](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#function--getbinq2-ok)**(const <a href="http://example.org/classes/classrivet_1_1diskinematics/">DISKinematics</a> & dk)<br><a href="http://example.org/classes/classrivet_1_1a/">A</a> routine that selects the bin in kinematic space.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual Normalise histograms after the run void | **[finalize](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1zeus__2008__i810112/">ZEUS_2008_I810112</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| Normalise histograms | **[etc](http://example.org/classes/classrivet_1_1zeus__2008__i810112/#variable-etc)**  |
...
### function _getbinQ2_OK

```cpp
inline int _getbinQ2_OK(
    const DISKinematics & dk
)
```

<a href="http://example.org/classes/classrivet_1_1a/">A</a> routine that selects the bin in kinematic space. 
...
```cpp
inline virtual Normalise histograms after the run void finalize()
```
