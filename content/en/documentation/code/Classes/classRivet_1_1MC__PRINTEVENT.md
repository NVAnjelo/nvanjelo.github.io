...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__printevent/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__printevent/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__printevent/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[MC_PRINTEVENT](http://example.org/classes/classrivet_1_1mc__printevent/#function-mc-printevent)**()<br>Constructor.  |
...
TodoWouldn't this be nice... if HepMC::IO_AsciiParticles was sane :-/ 
...
### function MC_PRINTEVENT

```cpp
inline MC_PRINTEVENT()
```
