...
title: "Rivet::MC_PHOTONS"
summary: "MC validation analysis for photons. "
...
MC validation analysis for photons.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_PHOTONS](http://example.org/classes/classrivet_1_1mc__photons/#function-mc-photons)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__photons/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__photons/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__photons/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::MC_PHOTONS;
```

MC validation analysis for photons. 
