...
title: "Rivet::MC_DILEPTON"
summary: "Study of prompt dilepton kinematics sensitive to boson polarizations. "
...
Study of prompt dilepton kinematics sensitive to boson polarizations. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__dilepton/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__dilepton/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__dilepton/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__dilepton/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__dilepton/">MC_DILEPTON</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pt_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-pt-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pt_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-pt-l2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppara_com](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-ppara-com)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pperp_com](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-pperp-com)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_costheta_com](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-costheta-com)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppara_com_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-ppara-com-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppara_com_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-ppara-com-l2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_costheta_com_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-costheta-com-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_costheta_com_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-costheta-com-l2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppara_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-ppara-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pperp_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-pperp-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_costheta_l1](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-costheta-l1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppara_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-ppara-l2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pperp_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-pperp-l2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_costheta_l2](http://example.org/classes/classrivet_1_1mc__dilepton/#variable--h-costheta-l2)**  |
...
### variable _h_ppara_com

```cpp
Histo1DPtr _h_ppara_com;
```


### variable _h_pperp_com

```cpp
Histo1DPtr _h_pperp_com;
```


### variable _h_costheta_com

```cpp
Histo1DPtr _h_costheta_com;
```


### variable _h_ppara_com_l1

```cpp
Histo1DPtr _h_ppara_com_l1;
```


### variable _h_ppara_com_l2

```cpp
Histo1DPtr _h_ppara_com_l2;
```


### variable _h_costheta_com_l1

```cpp
Histo1DPtr _h_costheta_com_l1;
```


### variable _h_costheta_com_l2

```cpp
Histo1DPtr _h_costheta_com_l2;
```


### variable _h_ppara_l1

```cpp
Histo1DPtr _h_ppara_l1;
```


### variable _h_pperp_l1

```cpp
Histo1DPtr _h_pperp_l1;
```


### variable _h_costheta_l1

```cpp
Histo1DPtr _h_costheta_l1;
```


### variable _h_ppara_l2

```cpp
Histo1DPtr _h_ppara_l2;
```


### variable _h_pperp_l2

```cpp
Histo1DPtr _h_pperp_l2;
```


### variable _h_costheta_l2

```cpp
Histo1DPtr _h_costheta_l2;
```
