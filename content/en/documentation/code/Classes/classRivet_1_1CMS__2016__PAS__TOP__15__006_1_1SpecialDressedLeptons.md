...
title: "Rivet::CMS_2016_PAS_TOP_15_006::SpecialDressedLeptons"
summary: "Special dressed lepton finder. "

---

# Rivet::CMS_2016_PAS_TOP_15_006::SpecialDressedLeptons



Special dressed lepton finder.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[SpecialDressedLeptons](http://example.org/classes/classrivet_1_1cms__2016__pas__top__15__006_1_1specialdressedleptons/#function-specialdressedleptons)**(const <a href="http://example.org/classes/classrivet_1_1finalstate/">FinalState</a> & fs, const Cut & cut)<br>Constructor.  |
| virtual unique_ptr< <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> > | **[clone](http://example.org/classes/classrivet_1_1cms__2016__pas__top__15__006_1_1specialdressedleptons/#function-clone)**() const<br>Clone on the heap.  |
| const vector< <a href="http://example.org/classes/classrivet_1_1dressedlepton/">DressedLepton</a> > & | **[dressedLeptons](http://example.org/classes/classrivet_1_1cms__2016__pas__top__15__006_1_1specialdressedleptons/#function-dressedleptons)**() const<br>Retrieve the dressed leptons.  |
| virtual void | **[project](http://example.org/classes/classrivet_1_1cms__2016__pas__top__15__006_1_1specialdressedleptons/#function-project)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Perform the calculation.  |
...
```cpp
class Rivet::CMS_2016_PAS_TOP_15_006::SpecialDressedLeptons;
```

Special dressed lepton finder. 

Find dressed leptons by clustering all leptons and photons 

## Public Functions Documentation

### function SpecialDressedLeptons

```cpp
inline SpecialDressedLeptons(
    const FinalState & fs,
    const Cut & cut
)
```
...
```cpp
inline virtual unique_ptr< Projection > clone() const
```
...
```cpp
inline const vector< DressedLepton > & dressedLeptons() const
```
