...
title: "Rivet::ATLAS_2012_I1094564"
summary: "ATLAS jet substructure measurement. "

---

# Rivet::ATLAS_2012_I1094564
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1094564](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-atlas-2012-i1094564)**() |
| <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> | **[splitjet](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-splitjet)**(fastjet::PseudoJet jet, double & last_R, const <a href="http://example.org/classes/classrivet_1_1fastjets/">FastJets</a> & fj, bool & unclustered) const |
| fastjet::PseudoJet | **[filterjet](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-filterjet)**(<a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> jets, double & stingy_R, const double def_R) const |
| <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> | **[jetGetAxes](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-jetgetaxes)**(int n_jets, const <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> & inputJets, double subR) const |
| double | **[jetTauValue](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-jettauvalue)**(double beta, double jet_rad, const <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> & particles, const <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> & axes, double Rcut) const |
| void | **[jetUpdateAxes](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-jetupdateaxes)**(double beta, const <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> & particles, <a href="http://example.org/namespaces/namespacerivet/#typedef-pseudojets">PseudoJets</a> & axes) const |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1094564/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2012_I1094564

```cpp
inline ATLAS_2012_I1094564()
```
...
```cpp
inline fastjet::PseudoJet filterjet(
    PseudoJets jets,
    double & stingy_R,
    const double def_R
) const
...
```cpp
inline PseudoJets jetGetAxes(
    int n_jets,
    const PseudoJets & inputJets,
    double subR
) const
```


### function jetTauValue

```cpp
inline double jetTauValue(
    double beta,
    double jet_rad,
    const PseudoJets & particles,
    const PseudoJets & axes,
    double Rcut
) const
```


### function jetUpdateAxes

```cpp
inline void jetUpdateAxes(
    double beta,
    const PseudoJets & particles,
    PseudoJets & axes
) const
