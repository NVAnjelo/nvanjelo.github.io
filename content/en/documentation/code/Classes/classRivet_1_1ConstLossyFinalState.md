...
**Protected Attributes inherited from [Rivet::LossyFinalState< ConstRandomFilter >](http://example.org/classes/classrivet_1_1lossyfinalstate/)**

|                | Name           |
| -------------- | -------------- |
| FILTER | **[_filter](http://example.org/classes/classrivet_1_1lossyfinalstate/#variable--filter)** <br>Filtering object: must support operator(const Particle&) and compare(const Filter&)  |
