...
title: "Rivet::TASSO_1985_I205119"
summary: "K0 and Lambda spectra at 14, 22 and 34 GeV. "

---

# Rivet::TASSO_1985_I205119



K0 and Lambda spectra at 14, 22 and 34 GeV. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1tasso__1985__i205119/">TASSO_1985_I205119</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_kaon_x](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#variable--h-kaon-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lambda_x](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#variable--h-lambda-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_kaon_p](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#variable--h-kaon-p)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lambda_p](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#variable--h-lambda-p)**  |
| double | **[sqs](http://example.org/classes/classrivet_1_1tasso__1985__i205119/#variable-sqs)**  |
...
```cpp
Histo1DPtr _h_kaon_x;
```


### variable _h_lambda_x

```cpp
Histo1DPtr _h_lambda_x;
```
...
```cpp
Histo1DPtr _h_kaon_p;
```


### variable _h_lambda_p

```cpp
Histo1DPtr _h_lambda_p;
```
