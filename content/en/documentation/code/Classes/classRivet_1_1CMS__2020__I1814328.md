...
title: "Rivet::CMS_2020_I1814328"
summary: "Measurements of W+W- boson pair production in pp collisions at 13 TeV. "

---

# Rivet::CMS_2020_I1814328



Measurements of W+W- boson pair production in pp collisions at 13 TeV. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[normalizeToSum](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#function-normalizetosum)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2020__i1814328/">CMS_2020_I1814328</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_njets_norm](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-njets-norm)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_mll_norm](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-mll-norm)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_ptlmax_norm](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-ptlmax-norm)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_ptlmin_norm](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-ptlmin-norm)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_dphill_norm](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-dphill-norm)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_WW_njet0](http://example.org/classes/classrivet_1_1cms__2020__i1814328/#variable--h-ww-njet0)**  |
...
```cpp
inline void normalizeToSum(
    Histo1DPtr hist
)
```


**Todo**: Replace with <a href="http://example.org/modules/group__analysis__manip/#function-barchart">barchart()</a>
...
### variable _h_WW_mll_norm

```cpp
Histo1DPtr _h_WW_mll_norm;
```


### variable _h_WW_ptlmax_norm

```cpp
Histo1DPtr _h_WW_ptlmax_norm;
```


### variable _h_WW_ptlmin_norm

```cpp
Histo1DPtr _h_WW_ptlmin_norm;
```


### variable _h_WW_dphill_norm

```cpp
Histo1DPtr _h_WW_dphill_norm;
```


### variable _h_WW_njet0
