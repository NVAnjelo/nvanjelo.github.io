...
title: "Rivet::CLEOC_2008_I769777"
summary: "D -> pi,K semi-leptonic q^2. "

---

# Rivet::CLEOC_2008_I769777



D -> pi,K semi-leptonic q^2. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[q2](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-q2)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & B, int mesonID) |
| bool | **[isSemileptonicDecay](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-issemileptonicdecay)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, vector< int > ids) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoc__2008__i769777/">CLEOC_2008_I769777</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_D0_pi](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--h-q2-d0-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_D0_K](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--h-q2-d0-k)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_Dp_pi](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--h-q2-dp-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_Dp_K](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--h-q2-dp-k)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_nD0](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--nd0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_nDp](http://example.org/classes/classrivet_1_1cleoc__2008__i769777/#variable--ndp)**  |
...
### function isSemileptonicDecay

```cpp
inline bool isSemileptonicDecay(
...
### variable _h_q2_D0_pi

```cpp
Histo1DPtr _h_q2_D0_pi;
```
...
```cpp
Histo1DPtr _h_q2_D0_K;
```


### variable _h_q2_Dp_pi

```cpp
Histo1DPtr _h_q2_Dp_pi;
```
