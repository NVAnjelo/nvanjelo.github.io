...
title: "Rivet::LHCB_2015_I1333223"

---

# Rivet::LHCB_2015_I1333223
...
|                | Name           |
| -------------- | -------------- |
| | **[LHCB_2015_I1333223](http://example.org/classes/classrivet_1_1lhcb__2015__i1333223/#function-lhcb-2015-i1333223)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2015__i1333223/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2015__i1333223/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2015__i1333223/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function LHCB_2015_I1333223

```cpp
inline LHCB_2015_I1333223()
```
