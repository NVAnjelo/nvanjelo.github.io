...
title: "Rivet::HRS_1989_I276948"
summary: "rho0, K*=, K*0 spectra at 29 GeV "

---

# Rivet::HRS_1989_I276948



rho0, K*=, K*0 spectra at 29 GeV 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1hrs__1989__i276948/">HRS_1989_I276948</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_x_rho](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-x-rho)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_x_Kstar0](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-x-kstar0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_x_Kstarp](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-x-kstarp)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_rho](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-sig-rho)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_sig_Kstar0](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-sig-kstar0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_mult_rho](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-mult-rho)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_mult_Kstar0](http://example.org/classes/classrivet_1_1hrs__1989__i276948/#variable--h-mult-kstar0)**  |
...
### variable _h_x_Kstar0

```cpp
Histo1DPtr _h_x_Kstar0;
```


### variable _h_x_Kstarp

```cpp
Histo1DPtr _h_x_Kstarp;
```
...
```cpp
Histo1DPtr _h_sig_rho;
```


### variable _h_sig_Kstar0

```cpp
Histo1DPtr _h_sig_Kstar0;
```


### variable _h_mult_rho

```cpp
Histo1DPtr _h_mult_rho;
```


### variable _h_mult_Kstar0

```cpp
Histo1DPtr _h_mult_Kstar0;
```
