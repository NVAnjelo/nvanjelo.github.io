...
title: "Rivet::ARGUS_1990_I278933"
summary: "pi0 and eta at Upsilon 1,2 and continuum "

---

# Rivet::ARGUS_1990_I278933



pi0 and eta at Upsilon 1,2 and continuum 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1argus__1990__i278933/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1argus__1990__i278933/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & unstable)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1argus__1990__i278933/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1argus__1990__i278933/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1argus__1990__i278933/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1argus__1990__i278933/">ARGUS_1990_I278933</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_pi1](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-cont-pi1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_pi2](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-cont-pi2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups1_pi](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-ups1-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups2_pi](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-ups2-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_eta1](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-cont-eta1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_eta2](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-cont-eta2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups1_eta](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-ups1-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups2_eta](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--h-ups2-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Eta](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--n-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Pi](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--n-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_cont](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--weightsum-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups1](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--weightsum-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups2](http://example.org/classes/classrivet_1_1argus__1990__i278933/#variable--weightsum-ups2)**  |
...
### variable _h_cont_pi1

```cpp
Histo1DPtr _h_cont_pi1;
```


### variable _h_cont_pi2

```cpp
Histo1DPtr _h_cont_pi2;
```
...
```cpp
Histo1DPtr _h_ups2_pi;
```


### variable _h_cont_eta1

```cpp
Histo1DPtr _h_cont_eta1;
```


### variable _h_cont_eta2

```cpp
Histo1DPtr _h_cont_eta2;
```


### variable _h_ups1_eta

```cpp
Histo1DPtr _h_ups1_eta;
```


### variable _h_ups2_eta

```cpp
Histo1DPtr _h_ups2_eta;
```
...
### variable _weightSum_Ups2

```cpp
CounterPtr _weightSum_Ups2;
```
