...
title: "Rivet::CDF_1998_S3618439"
summary: "CDF diff cross-section in events with large missing energy. "

---

# Rivet::CDF_1998_S3618439



CDF diff cross-section in events with large missing energy. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__1998__s3618439/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__1998__s3618439/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__1998__s3618439/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__1998__s3618439/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__1998__s3618439/">CDF_1998_S3618439</a> ) |
