...
title: "Rivet::OPAL_1997_I447188"
summary: "Lambda polarization at LEP1. "

---

# Rivet::OPAL_1997_I447188
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcAlpha](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| pair< double, double > | **[calcAsymmetry](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-calcasymmetry)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hist, unsigned int mode) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1opal__1997__i447188/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1opal__1997__i447188/">OPAL_1997_I447188</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_ctheta](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-ctheta)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_cphi](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-cphi)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_plus_lam](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-plus-lam)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_minus_lam](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-minus-lam)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ctheta_large](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-ctheta-large)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cphi_low](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-cphi-low)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cphi_mid](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-cphi-mid)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cphi_high](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-cphi-high)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_plus_lam_large1](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-plus-lam-large1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_plus_lam_large2](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-plus-lam-large2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_minus_lam_large1](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-minus-lam-large1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_minus_lam_large2](http://example.org/classes/classrivet_1_1opal__1997__i447188/#variable--h-minus-lam-large2)**  |
...
### variable _h_cphi_low

```cpp
Histo1DPtr _h_cphi_low;
```


### variable _h_cphi_mid

```cpp
Histo1DPtr _h_cphi_mid;
```


### variable _h_cphi_high

```cpp
Histo1DPtr _h_cphi_high;
```


### variable _h_plus_lam_large1

```cpp
Histo1DPtr _h_plus_lam_large1;
```


### variable _h_plus_lam_large2

```cpp
Histo1DPtr _h_plus_lam_large2;
```


### variable _h_minus_lam_large1

```cpp
Histo1DPtr _h_minus_lam_large1;
```


### variable _h_minus_lam_large2

```cpp
Histo1DPtr _h_minus_lam_large2;
```
