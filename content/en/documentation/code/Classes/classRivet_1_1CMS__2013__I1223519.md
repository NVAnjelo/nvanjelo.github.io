...
title: "Rivet::CMS_2013_I1223519"
summary: "Searches for SUSY using $avoidalpha_T$ and $b$-quark multiplicity at 8~avoidTeV. "

---

# Rivet::CMS_2013_I1223519



Searches for SUSY using $\alpha_T$ and $b$-quark multiplicity at 8~\TeV. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| template <size_t N\> <br>pair< double, double > | **[partition_sum](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-partition-sum)**(const std::bitset< N > & mask, const vector< double > & vals) const<br>Sum the given values into two subsets according to the provided bitmask.  |
| template <size_t N\> <br>double | **[partition_diff](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-partition-diff)**(const std::bitset< N > & mask, const vector< double > & vals) const<br>Return the difference between summed subsets according to the provided bitmask.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2013__i1223519/">CMS_2013_I1223519</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_alphaT23](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#variable--h-alphat23)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_alphaT4](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#variable--h-alphat4)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> > | **[_h_srcounters](http://example.org/classes/classrivet_1_1cms__2013__i1223519/#variable--h-srcounters)**  |
...
< Charm mistag and exact b-tag eff not given

TodoAdd HT histograms 
...
It's not clear if different HTs are used to choose the HT bins

There'd better not be more than 10 jets...

TodoNeed to include trigger efficiency sampling or weighting? 
...
### function partition_sum

```cpp
template <size_t N>
inline pair< double, double > partition_sum(
...
### function partition_diff

```cpp
template <size_t N>
inline double partition_diff(
    const std::bitset< N > & mask,
    const vector< double > & vals
) const
```
...
### variable _h_alphaT23

```cpp
Histo1DPtr _h_alphaT23;
```
...
```cpp
Histo1DPtr _h_alphaT4;
```


### variable _h_srcounters
