...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| bool | **[isBackToBack_zj](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-isbacktoback-zj)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zf, const fastjet::PseudoJet & psjet) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__jet__in__hi/">MC_JET_IN_HI</a> )<br>Constructor.  |
| string | **[ts](http://example.org/classes/classrivet_1_1mc__jet__in__hi/#function-ts)**(int in) |
