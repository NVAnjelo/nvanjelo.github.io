...
title: "Rivet::ATLAS_2012_I946427"

---

# Rivet::ATLAS_2012_I946427
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i946427/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i946427/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i946427/#function-finalize)**() |
| | **[ATLAS_2012_I946427](http://example.org/classes/classrivet_1_1atlas__2012__i946427/#function-atlas-2012-i946427)**()<br>Constructor.  |
...
```cpp
class Rivet::ATLAS_2012_I946427;
```
...
### function ATLAS_2012_I946427

```cpp
inline ATLAS_2012_I946427()
```
