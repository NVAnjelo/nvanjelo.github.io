...
title: "Rivet::CDF_2010_S8591881_QCD"
summary: "CDF Run II underlying event in leading jet events. "

---

# Rivet::CDF_2010_S8591881_QCD



CDF Run II underlying event in leading jet events.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2010__s8591881__qcd/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2010__s8591881__qcd/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2010__s8591881__qcd/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2010__s8591881__qcd/">CDF_2010_S8591881_QCD</a> ) |
...
```cpp
class Rivet::CDF_2010_S8591881_QCD;
```
...
Rick Field's measurement of the underlying event in "leading jet" events. The leading jet (CDF midpoint \( R = 0.7 \)) must be within \(|\eta| < 2 \) and defines the "toward" phi direction. <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> are selected in \( |\eta| < 1 \). For the \( p_\perp \)-related observables there is a \( p_\perp > 0.5 \) GeV cut. For \( \sum E_\perp \) there is no \( p_\perp \) cut.
...
TodoImplement <a href="http://example.org/classes/classrivet_1_1run/">Run</a> II min bias trigger cf. CDF_2009? 
