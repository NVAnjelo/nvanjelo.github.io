...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__wwktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__wwktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__wwktsplittings/#function-finalize)**()<br>Finalize.  |
| | **[MC_WWKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__wwktsplittings/#function-mc-wwktsplittings)**()<br>Default constructor.  |
...
### function MC_WWKTSPLITTINGS

```cpp
inline MC_WWKTSPLITTINGS()
```
