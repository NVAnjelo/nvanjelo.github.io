...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__dis/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__dis/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__dis/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__dis/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__dis/">MC_DIS</a> )<br>Constructor.  |
...
transverse momentum of all particles but the scattered lepton

transverse momentum of all leptons but the scattered one

transverse momentum of all hadrons

transverse momentum of all gammas
