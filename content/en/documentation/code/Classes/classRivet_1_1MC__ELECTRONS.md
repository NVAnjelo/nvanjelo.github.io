...
title: "Rivet::MC_ELECTRONS"
summary: "MC validation analysis for electrons. "
...
MC validation analysis for electrons. 

Inherits from [Rivet::MC_ParticleAnalysis](http://example.org/classes/classrivet_1_1mc__particleanalysis/), [Rivet::Analysis](http://example.org/classes/classrivet_1_1analysis/), [Rivet::ProjectionApplier](http://example.org/classes/classrivet_1_1projectionapplier/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[MC_ELECTRONS](http://example.org/classes/classrivet_1_1mc__electrons/#function-mc-electrons)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__electrons/#function-init)**()<br>Bookings as usual, using the particle name specified by the derived classe.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__electrons/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>To be implemented by derived classes, making particle selection then calling _analyze.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__electrons/#function-finalize)**()<br>Normalization, division, etc.  |

## Additional inherited members

**Public Functions inherited from [Rivet::MC_ParticleAnalysis](http://example.org/classes/classrivet_1_1mc__particleanalysis/)**
...
**Protected Attributes inherited from [Rivet::MC_ParticleAnalysis](http://example.org/classes/classrivet_1_1mc__particleanalysis/)**
...
**Reimplements**: [Rivet::MC_ParticleAnalysis::init](http://example.org/classes/classrivet_1_1mc__particleanalysis/#function-init)
...
**Reimplements**: [Rivet::MC_ParticleAnalysis::analyze](http://example.org/classes/classrivet_1_1mc__particleanalysis/#function-analyze)
...
**Reimplements**: [Rivet::MC_ParticleAnalysis::finalize](http://example.org/classes/classrivet_1_1mc__particleanalysis/#function-finalize)
