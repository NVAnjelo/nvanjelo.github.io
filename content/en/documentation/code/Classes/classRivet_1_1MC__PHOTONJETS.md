...
title: "Rivet::MC_PHOTONJETS"
summary: "MC validation analysis for photon + jets events. "
...
MC validation analysis for photon + jets events. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__photonjets/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__photonjets/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__photonjets/#function-finalize)**() |
| | **[MC_PHOTONJETS](http://example.org/classes/classrivet_1_1mc__photonjets/#function-mc-photonjets)**()<br>Default constructor.  |
...
Todoshare IsolatedPhoton projection between all MC_*PHOTON* analyses 
...
### function MC_PHOTONJETS

```cpp
inline MC_PHOTONJETS()
```
