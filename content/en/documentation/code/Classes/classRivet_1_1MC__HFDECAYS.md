...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__hfdecays/">MC_HFDECAYS</a> )<br>Constructor.  |
| const string | **[whoDis](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-whodis)**(const int pid) const |
| void | **[addBinned](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-addbinned)**(const string & name, const YODA::HistoBin1D & ptbin, const int nbins, const double lo, const double hi) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[p_annulus](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-p-annulus)**(const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & jet, const double a, const double b) const |
| void | **[count_mult](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-count-mult)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) |
| double | **[pTrel](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-ptrel)**(const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & jet, const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) const |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__hfdecays/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
inline void addBinned(
    const string & name,
    const YODA::HistoBin1D & ptbin,
    const int nbins,
    const double lo,
    const double hi
)
