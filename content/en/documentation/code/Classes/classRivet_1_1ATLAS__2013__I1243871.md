...
title: "Rivet::ATLAS_2013_I1243871"

---

# Rivet::ATLAS_2013_I1243871
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2013_I1243871](http://example.org/classes/classrivet_1_1atlas__2013__i1243871/#function-atlas-2013-i1243871)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2013__i1243871/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2013__i1243871/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
...
### function ATLAS_2013_I1243871

```cpp
inline ATLAS_2013_I1243871()
```
...
TodoWhy rewrite the jets collection as a vector of pointers? 

TodoUse direct kinematics access 

TodoUse built-in identification on <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a>, avoid HepMC 

TodoUse built-in dR < 0.3 <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> tagging, avoid HepMC 

TodoUse direct momentum accessor / delta functions 

TodoUse built-in b-tagging (dR < 0.3 defn), avoid HepMC 

TodoUse direct momentum accessor / delta functions 

TodoUse C++11 vector/array initialization 

TodoUse <a href="http://example.org/namespaces/namespaceyoda/">YODA</a> bin index lookup tools 
