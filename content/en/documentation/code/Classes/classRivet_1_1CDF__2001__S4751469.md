...
title: "Rivet::CDF_2001_S4751469"
summary: "Field-Stuart CDF Run I track-jet underlying event analysis. "

---

# Rivet::CDF_2001_S4751469



Field-Stuart CDF Run I track-jet underlying event analysis.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2001__s4751469/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2001__s4751469/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2001__s4751469/#function-finalize)**()<br>Normalize histos.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2001__s4751469/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2001__s4751469/">CDF_2001_S4751469</a> ) |
...
```cpp
class Rivet::CDF_2001_S4751469;
```

Field-Stuart CDF Run I track-jet underlying event analysis. 
...
* \( \sqrt{s} = \) 1800 GeV 
* <a href="http://example.org/classes/classrivet_1_1run/">Run</a> with generic QCD events. 
* Several \( p_\perp^\text{min} \) cutoffs are probably required to fill the profile histograms: 
* \( p_\perp^\text{min} = \) 0 (min bias), 10, 20 GeV 
...
TodoReplace <a href="http://example.org/classes/classrivet_1_1constlossyfinalstate/">ConstLossyFinalState</a> with <a href="http://example.org/classes/classrivet_1_1smearedparticles/">SmearedParticles</a>
...
TodoNon-trackjet track efficiencies are corrected? 

< TodoShould really explicitly iterate over nbins for each temp histo 
