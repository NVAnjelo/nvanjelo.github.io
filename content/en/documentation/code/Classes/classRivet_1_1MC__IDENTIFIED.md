...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__identified/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__identified/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__identified/#function-finalize)**()<br>Finalize.  |
| | **[MC_IDENTIFIED](http://example.org/classes/classrivet_1_1mc__identified/#function-mc-identified)**()<br>Constructor.  |
...
### function MC_IDENTIFIED

```cpp
inline MC_IDENTIFIED()
```
