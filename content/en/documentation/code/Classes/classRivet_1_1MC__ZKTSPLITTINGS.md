...
title: "Rivet::MC_ZKTSPLITTINGS"
summary: "MC validation analysis for Z + jets events. "

---

# Rivet::MC_ZKTSPLITTINGS
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__zktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__zktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__zktsplittings/#function-finalize)**()<br>Finalize.  |
| | **[MC_ZKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__zktsplittings/#function-mc-zktsplittings)**()<br>Default constructor.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| double | **[_dR](http://example.org/classes/classrivet_1_1mc__zktsplittings/#variable--dr)**  |
| PdgId | **[_lepton](http://example.org/classes/classrivet_1_1mc__zktsplittings/#variable--lepton)**  |
...
### function MC_ZKTSPLITTINGS

```cpp
inline MC_ZKTSPLITTINGS()
```
