...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1h1__1996__i424463/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1h1__1996__i424463/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1h1__1996__i424463/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1h1__1996__i424463/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1h1__1996__i424463/">H1_1996_I424463</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| map< string, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--h)**  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> > | **[_p](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--p)**  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> > | **[_c](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--c)**  |
| array< <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a>, 10 > | **[_Nevt_after_cuts](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--nevt-after-cuts)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_dndpt_low_eta_bin](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--h-dndpt-low-eta-bin)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_dndpt_high_eta_bin](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--h-dndpt-high-eta-bin)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_hdndeta_bin](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--hdndeta-bin)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_hdndeta_pt1_bin](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--hdndeta-pt1-bin)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_hdndptmax_low_eta_bin](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--hdndptmax-low-eta-bin)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_NevAll](http://example.org/classes/classrivet_1_1h1__1996__i424463/#variable--nevall)**  |
...
### variable _h_dndpt_low_eta_bin

```cpp
vector< Histo1DPtr > _h_dndpt_low_eta_bin;
```


### variable _h_dndpt_high_eta_bin

```cpp
vector< Histo1DPtr > _h_dndpt_high_eta_bin;
```


### variable _hdndeta_bin

```cpp
vector< Histo1DPtr > _hdndeta_bin;
```


### variable _hdndeta_pt1_bin

```cpp
vector< Histo1DPtr > _hdndeta_pt1_bin;
```


### variable _hdndptmax_low_eta_bin

```cpp
vector< Histo1DPtr > _hdndptmax_low_eta_bin;
```
