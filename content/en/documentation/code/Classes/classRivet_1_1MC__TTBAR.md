...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__ttbar/#function-init)**()<br>Set up projections and book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__ttbar/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| double | **[findZcomponent](http://example.org/classes/classrivet_1_1mc__ttbar/#function-findzcomponent)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & lepton, const <a href="http://example.org/classes/classrivet_1_1vector3/">Vector3</a> & met) const |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__ttbar/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__ttbar/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__ttbar/">MC_TTBAR</a> )<br>Minimal constructor.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1mc__ttbar/#variable--mode)**  |
...
### function findZcomponent

```cpp
inline double findZcomponent(
