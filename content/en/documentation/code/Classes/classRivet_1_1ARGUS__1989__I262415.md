...
title: "Rivet::ARGUS_1989_I262415"
summary: "Lambda(1520) production. "

---

# Rivet::ARGUS_1989_I262415
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1argus__1989__i262415/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1argus__1989__i262415/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & unstable)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1argus__1989__i262415/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1argus__1989__i262415/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1argus__1989__i262415/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1argus__1989__i262415/">ARGUS_1989_I262415</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups1](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups1_obs](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-ups1-obs)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_obs](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-cont-obs)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ups1_all](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-ups1-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cont_all](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--h-cont-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_cont](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--weightsum-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups1](http://example.org/classes/classrivet_1_1argus__1989__i262415/#variable--weightsum-ups1)**  |
...
### variable _h_ups1_obs

```cpp
Histo1DPtr _h_ups1_obs;
```


### variable _h_cont_obs

```cpp
Histo1DPtr _h_cont_obs;
```


### variable _h_ups1_all

```cpp
Histo1DPtr _h_ups1_all;
```


### variable _h_cont_all

```cpp
Histo1DPtr _h_cont_all;
```
