...
title: "Rivet::MC_WKTSPLITTINGS"
summary: "MC validation analysis for kt splitting scales in W + jets events. "

---

# Rivet::MC_WKTSPLITTINGS



MC validation analysis for kt splitting scales in W + jets events. 

Inherits from [Rivet::MC_JetSplittings](http://example.org/classes/classrivet_1_1mc__jetsplittings/), [Rivet::Analysis](http://example.org/classes/classrivet_1_1analysis/), [Rivet::ProjectionApplier](http://example.org/classes/classrivet_1_1projectionapplier/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__wktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__wktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__wktsplittings/#function-finalize)**()<br>Finalize.  |
| | **[MC_WKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__wktsplittings/#function-mc-wktsplittings)**()<br>Default constructor.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| double | **[_dR](http://example.org/classes/classrivet_1_1mc__wktsplittings/#variable--dr)**  |
| PdgId | **[_lepton](http://example.org/classes/classrivet_1_1mc__wktsplittings/#variable--lepton)**  |

## Additional inherited members

**Public Functions inherited from [Rivet::MC_JetSplittings](http://example.org/classes/classrivet_1_1mc__jetsplittings/)**
...
**Protected Attributes inherited from [Rivet::MC_JetSplittings](http://example.org/classes/classrivet_1_1mc__jetsplittings/)**
...
**Reimplements**: [Rivet::MC_JetSplittings::init](http://example.org/classes/classrivet_1_1mc__jetsplittings/#function-init)
...
**Reimplements**: [Rivet::MC_JetSplittings::analyze](http://example.org/classes/classrivet_1_1mc__jetsplittings/#function-analyze)
...
**Reimplements**: [Rivet::MC_JetSplittings::finalize](http://example.org/classes/classrivet_1_1mc__jetsplittings/#function-finalize)


### function MC_WKTSPLITTINGS

```cpp
inline MC_WKTSPLITTINGS()
```
