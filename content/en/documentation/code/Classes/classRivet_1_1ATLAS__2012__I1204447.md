...
title: "Rivet::ATLAS_2012_I1204447"

---

# Rivet::ATLAS_2012_I1204447
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1204447](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-atlas-2012-i1204447)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| vector< string > | **[getSignalRegions](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-getsignalregions)**()<br>Helper functions.  |
| vector< int > | **[getCutsPerSignalRegion](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-getcutspersignalregion)**(const string & signal_region, int onZ =0)<br>Function giving all cut vales per kinematic variable (taking onZ for MET into account)  |
| void | **[fillEventCountsPerSR](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-filleventcountspersr)**(const string & basic_signal_region, int onZ, double HTlep, double eTmiss, double HTjets, double meff) |
| <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> | **[get_tau_neutrino_mom](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-get-tau-neutrino-mom)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) |
| void | **[get_prong_number](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-get-prong-number)**(<a href="http://example.org/namespaces/namespacerivet/#typedef-constgenparticleptr">ConstGenParticlePtr</a> p, unsigned int & nprong, bool & lep_decaying_tau) |
| double | **[apply_reco_eff](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-apply-reco-eff)**(int flavor, const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p)<br>Function giving fiducial lepton efficiency.  |
| double | **[getUpperLimit](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-getupperlimit)**(const string & signal_region, bool observed)<br>Function giving observed upper limit (visible cross-section)  |
| int | **[isonZ](http://example.org/classes/classrivet_1_1atlas__2012__i1204447/#function-isonz)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & particles) |
...
### function ATLAS_2012_I1204447

```cpp
inline ATLAS_2012_I1204447()
```
...
TodoThis could benefit from a tau finder projection 

TodoHuh? Unstable taus with no decay vtx? Can use <a href="http://example.org/classes/classrivet_1_1particle/#function-isstable">Particle.isStable()</a>? But why in this situation? 
...
### function get_tau_neutrino_mom

```cpp
inline FourMomentum get_tau_neutrino_mom(
    const Particle & p
)
```


**Todo**: Move to <a href="http://example.org/classes/classrivet_1_1taufinder/">TauFinder</a> and make less HepMC-ish 
