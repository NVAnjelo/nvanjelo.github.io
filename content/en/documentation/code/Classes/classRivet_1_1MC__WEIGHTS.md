...
title: "Rivet::MC_WEIGHTS"
summary: "Analysis of the generated event-weight distributions. "
...
<a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a> of the generated event-weight distributions. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__weights/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__weights/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__weights/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__weights/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__weights/">MC_WEIGHTS</a> ) |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_xsfraction_neg](http://example.org/classes/classrivet_1_1mc__weights/#variable--h-xsfraction-neg)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_weight_100](http://example.org/classes/classrivet_1_1mc__weights/#variable--h-weight-100)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_weight_10](http://example.org/classes/classrivet_1_1mc__weights/#variable--h-weight-10)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_logweight_pos](http://example.org/classes/classrivet_1_1mc__weights/#variable--h-logweight-pos)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_logweight_neg](http://example.org/classes/classrivet_1_1mc__weights/#variable--h-logweight-neg)**  |
...
TodoConvert to Scatter1D or Counter 
...
### variable _h_weight_100

```cpp
Histo1DPtr _h_weight_100;
```


### variable _h_weight_10

```cpp
Histo1DPtr _h_weight_10;
```


### variable _h_logweight_pos

```cpp
Histo1DPtr _h_logweight_pos;
```


### variable _h_logweight_neg

```cpp
Histo1DPtr _h_logweight_neg;
```
