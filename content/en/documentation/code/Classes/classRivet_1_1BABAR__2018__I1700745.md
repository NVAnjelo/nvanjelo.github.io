...
title: "Rivet::BABAR_2018_I1700745"
summary: "Add a short analysis description here. "

---

# Rivet::BABAR_2018_I1700745
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2018__i1700745/">BABAR_2018_I1700745</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_num5Pi](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#variable--num5pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_num2PiEta](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#variable--num2pieta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_numOmegaPiPi](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#variable--numomegapipi)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_num4PiEta](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#variable--num4pieta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_numOmegaPiEta](http://example.org/classes/classrivet_1_1babar__2018__i1700745/#variable--numomegapieta)**  |
...
```cpp
CounterPtr _num2PiEta;
```


### variable _numOmegaPiPi
...
```cpp
CounterPtr _num4PiEta;
```


### variable _numOmegaPiEta

```cpp
CounterPtr _numOmegaPiEta;
```
