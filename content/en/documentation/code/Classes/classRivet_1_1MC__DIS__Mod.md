...
|                | Name           |
| -------------- | -------------- |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__dis__mod/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__dis__mod/">MC_DIS_Mod</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__dis__mod/#function-init)**()<br>Initialize histograms, projections etc.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__dis__mod/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__dis__mod/#function-finalize)**()<br>Normalise histograms etc., after the run.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-q2)** <br>The histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_y](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-y)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_x](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_W2](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-w2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_multeta1](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-multeta1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_multeta2](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-multeta2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[sow1](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable-sow1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[sow2](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable-sow2)**  |
| map< double, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[histEtaPerc](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable-histetaperc)**  |
| map< double, <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> > | **[sowPerc](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable-sowperc)**  |
| vector< double > | **[percentileBins](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable-percentilebins)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_njets](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-njets)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_jetET](http://example.org/classes/classrivet_1_1mc__dis__mod/#variable--hist-jetet)**  |
...
### variable _hist_multeta1

```cpp
Histo1DPtr _hist_multeta1;
```


### variable _hist_multeta2

```cpp
Histo1DPtr _hist_multeta2;
```
...
### variable _hist_jetET

```cpp
Histo1DPtr _hist_jetET;
```
