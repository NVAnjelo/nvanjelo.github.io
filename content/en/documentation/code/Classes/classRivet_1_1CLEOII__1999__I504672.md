...
title: "Rivet::CLEOII_1999_I504672"
summary: "Charged particle multplicity in Upsilon 4s decays. "

---

# Rivet::CLEOII_1999_I504672



Charged particle multplicity in Upsilon 4s decays. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, int & nCharged, int & nLep) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__1999__i504672/">CLEOII_1999_I504672</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_n](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--h-n)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_n_tot](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-tot)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_n_lep](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-lep)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_n_nolep](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-nolep)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Ups_All](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-ups-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Ups_Lep](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-ups-lep)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Ups_NoLep](http://example.org/classes/classrivet_1_1cleoii__1999__i504672/#variable--n-ups-nolep)**  |
...
```cpp
CounterPtr _n_Ups_Lep;
```


### variable _n_Ups_NoLep

```cpp
CounterPtr _n_Ups_NoLep;
```
