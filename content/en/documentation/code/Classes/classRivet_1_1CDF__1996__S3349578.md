...
title: "Rivet::CDF_1996_S3349578"
summary: "CDF properties of high-mass multi-jet events. "

---

# Rivet::CDF_1996_S3349578
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| void | **[_threeJetAnalysis](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function--threejetanalysis)**(const <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets) |
| void | **[_fourJetAnalysis](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function--fourjetanalysis)**(const <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets) |
| void | **[_fiveJetAnalysis](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function--fivejetanalysis)**(const <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__1996__s3349578/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__1996__s3349578/">CDF_1996_S3349578</a> ) |
...
### function _threeJetAnalysis

```cpp
inline void _threeJetAnalysis(
    const Jets & jets
)
```


### function _fourJetAnalysis

```cpp
inline void _fourJetAnalysis(
    const Jets & jets
)
```


### function _fiveJetAnalysis

```cpp
inline void _fiveJetAnalysis(
    const Jets & jets
)
```
