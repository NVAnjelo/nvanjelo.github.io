...
title: "Rivet::ATLAS_2011_I945498"
summary: "ATLAS Z+jets in pp at 7 TeV. "

---

# Rivet::ATLAS_2011_I945498
...
|                | Name           |
| -------------- | -------------- |
| double | **[ratio](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-ratio)**(double a, double b)<br>Calculate the ratio, being careful about div-by-zero.  |
| double | **[ratio_err](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-ratio-err)**(double a, double b)<br>Calculate the ratio error, being careful about div-by-zero.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-finalize)**() |
| | **[ATLAS_2011_I945498](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-atlas-2011-i945498)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> | **[selectJets](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-selectjets)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> * zf, const <a href="http://example.org/classes/classrivet_1_1fastjets/">FastJets</a> * allJets) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i945498/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
...
### function ATLAS_2011_I945498

```cpp
inline ATLAS_2011_I945498()
```
...
```cpp
inline Jets selectJets(
    const ZFinder * zf,
    const FastJets * allJets
)
```
