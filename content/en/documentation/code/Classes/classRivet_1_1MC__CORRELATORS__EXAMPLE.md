...
title: "Rivet::MC_CORRELATORS_EXAMPLE"

---

# Rivet::MC_CORRELATORS_EXAMPLE
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_CORRELATORS_EXAMPLE](http://example.org/classes/classrivet_1_1mc__correlators__example/#function-mc-correlators-example)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__correlators__example/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__correlators__example/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__correlators__example/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function MC_CORRELATORS_EXAMPLE

```cpp
inline MC_CORRELATORS_EXAMPLE()
```
