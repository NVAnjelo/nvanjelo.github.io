...
title: "Rivet::ATLAS_2014_I1307243"
summary: "ATLAS azimuthal decorrelation with jet veto analysis. "

---

# Rivet::ATLAS_2014_I1307243



ATLAS azimuthal decorrelation with jet veto analysis.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2014__i1307243/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2014__i1307243/">ATLAS_2014_I1307243</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1307243/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1307243/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillHists](http://example.org/classes/classrivet_1_1atlas__2014__i1307243/#function-fillhists)**(const size_t region, const size_t nGapJets, const vector< double > & vars) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1307243/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::ATLAS_2014_I1307243;
```

ATLAS azimuthal decorrelation with jet veto analysis. 

**Author**: James Robinson <a href="mailto:james.robinson@cern.ch">james.robinson@cern.ch</a>
