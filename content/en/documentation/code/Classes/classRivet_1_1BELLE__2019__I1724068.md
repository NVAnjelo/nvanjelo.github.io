...
title: "Rivet::BELLE_2019_I1724068"
summary: "D* polarization in B0 -> D* tau nu_tau. "

---

# Rivet::BELLE_2019_I1724068



D* polarization in B0 -> D* tau nu_tau. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#function-init)**()<br>Book histograms and initialise projections before the run.  |
...
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcF](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#function-calcf)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1belle__2019__i1724068/">BELLE_2019_I1724068</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cTheta](http://example.org/classes/classrivet_1_1belle__2019__i1724068/#variable--h-ctheta)**  |
...
```cpp
inline pair< double, double > calcF(
    Histo1DPtr hist
)
```
