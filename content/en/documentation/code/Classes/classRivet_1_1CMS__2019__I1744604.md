...
title: "Rivet::CMS_2019_I1744604"
summary: "Differential cross sections and charge ratios for 13 TeV t-channel single top-quark production. "

---

# Rivet::CMS_2019_I1744604
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2019__i1744604/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2019__i1744604/">CMS_2019_I1744604</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2019__i1744604/#function-init)**() override<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2019__i1744604/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) override<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2019__i1744604/#function-finalize)**() override<br>Normalise histograms etc., after the run.  |
...
construct the pseudo top quark momentum by summing the W boson and the jet that yields a top quark mass closest to TOPMASS
