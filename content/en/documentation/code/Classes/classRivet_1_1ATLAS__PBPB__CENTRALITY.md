...
title: "Rivet::ATLAS_PBPB_CENTRALITY"

---

# Rivet::ATLAS_PBPB_CENTRALITY
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__pbpb__centrality/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__pbpb__centrality/">ATLAS_PBPB_CENTRALITY</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__pbpb__centrality/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__pbpb__centrality/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__pbpb__centrality/#function-finalize)**()<br>Finalize.  |
