...
title: "Rivet::ALEPH_1996_I421984"
summary: "tau -> omega pi(pi) "

---

# Rivet::ALEPH_1996_I421984
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pip, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pim, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi0) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1aleph__1996__i421984/">ALEPH_1996_I421984</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_omegapi_momega](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#variable--h-omegapi-momega)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_omegapi_momegapi](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#variable--h-omegapi-momegapi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_omegapipi_momega](http://example.org/classes/classrivet_1_1aleph__1996__i421984/#variable--h-omegapipi-momega)**  |
...
### variable _h_omegapi_momega

```cpp
Histo1DPtr _h_omegapi_momega;
```


### variable _h_omegapi_momegapi

```cpp
Histo1DPtr _h_omegapi_momegapi;
```


### variable _h_omegapipi_momega

```cpp
Histo1DPtr _h_omegapipi_momega;
```
