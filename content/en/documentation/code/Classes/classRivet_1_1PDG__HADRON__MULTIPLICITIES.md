...
title: "Rivet::PDG_HADRON_MULTIPLICITIES"
summary: "Implementation of PDG hadron multiplicities. "

---

# Rivet::PDG_HADRON_MULTIPLICITIES



Implementation of PDG hadron multiplicities.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities/#function-init)**() |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities/#function-finalize)**() |
| | **[PDG_HADRON_MULTIPLICITIES](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities/#function-pdg-hadron-multiplicities)**()<br>Constructor.  |
...
```cpp
class Rivet::PDG_HADRON_MULTIPLICITIES;
```
...
### function PDG_HADRON_MULTIPLICITIES

```cpp
inline PDG_HADRON_MULTIPLICITIES()
```
