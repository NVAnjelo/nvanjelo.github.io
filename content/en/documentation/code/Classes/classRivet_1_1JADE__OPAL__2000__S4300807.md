...
title: "Rivet::JADE_OPAL_2000_S4300807"
summary: "Jet rates in $ e^+ e^- $ at OPAL and JADE. "

---

# Rivet::JADE_OPAL_2000_S4300807



Jet rates in \( e^+ e^- \) at OPAL and JADE.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1jade__opal__2000__s4300807/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1jade__opal__2000__s4300807/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1jade__opal__2000__s4300807/#function-finalize)**()<br>Finalize.  |
...
```cpp
class Rivet::JADE_OPAL_2000_S4300807;
```

Jet rates in \( e^+ e^- \) at OPAL and JADE. 
