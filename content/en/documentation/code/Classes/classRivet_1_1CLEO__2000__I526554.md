...
title: "Rivet::CLEO_2000_I526554"
summary: "Add a short analysis description here. "

---

# Rivet::CLEO_2000_I526554
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleo__2000__i526554/">CLEO_2000_I526554</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Ds](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#variable--h-ds)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Ds_primary](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#variable--h-ds-primary)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Ds_star1](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#variable--h-ds-star1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Ds_star2](http://example.org/classes/classrivet_1_1cleo__2000__i526554/#variable--h-ds-star2)**  |
...
### variable _h_Ds_primary

```cpp
Histo1DPtr _h_Ds_primary;
```


### variable _h_Ds_star1

```cpp
Histo1DPtr _h_Ds_star1;
```


### variable _h_Ds_star2

```cpp
Histo1DPtr _h_Ds_star2;
```
