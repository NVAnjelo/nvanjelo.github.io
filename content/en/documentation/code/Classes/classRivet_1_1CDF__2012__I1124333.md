...
title: "Rivet::CDF_2012_I1124333"

---

# Rivet::CDF_2012_I1124333
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2012__i1124333/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2012__i1124333/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2012__i1124333/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2012__i1124333/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2012__i1124333/">CDF_2012_I1124333</a> )<br>Constructor.  |
...
```cpp
class Rivet::CDF_2012_I1124333;
```


**Author**: Simone Amoroso 

@ CDF <a href="http://example.org/classes/classrivet_1_1run/">Run</a> II Z \( p_\perp \) in Drell-Yan events 
