...
title: "Rivet::CDF_2008_S7541902"
summary: "CDF jet pT and multiplicity distributions in W + jets events. "

---

# Rivet::CDF_2008_S7541902



CDF jet pT and multiplicity distributions in W + jets events.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2008__s7541902/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2008__s7541902/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2008__s7541902/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2008__s7541902/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2008__s7541902/">CDF_2008_S7541902</a> ) |
...
```cpp
class Rivet::CDF_2008_S7541902;
```

CDF jet pT and multiplicity distributions in W + jets events. 

This CDF analysis provides jet pT distributions for 4 jet multiplicity bins as well as the jet multiplicity distribution in W + jets events. 
...
TodoThese would be better off as YODA::Counter until <a href="http://example.org/classes/classrivet_1_1cdf__2008__s7541902/#function-finalize">finalize()</a>
...
TodoThis isn't really a histogram: replace with a YODA::Counter when we have one! 
...
TodoThis special case for 1-to-0 will disappear if we use Counters for all mults including 0. 

< This 1/sqrt{N} error treatment isn't right for weighted events: use YODA::Counter
