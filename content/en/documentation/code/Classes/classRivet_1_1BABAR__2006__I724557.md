...
title: "Rivet::BABAR_2006_I724557"
summary: "Omega_c*0 production. "

---

# Rivet::BABAR_2006_I724557



Omega_c*0 production. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2006__i724557/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2006__i724557/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2006__i724557/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2006__i724557/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2006__i724557/">BABAR_2006_I724557</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_c_Omega](http://example.org/classes/classrivet_1_1babar__2006__i724557/#variable--c-omega)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_c_Omega_Star](http://example.org/classes/classrivet_1_1babar__2006__i724557/#variable--c-omega-star)**  |
...
### variable _c_Omega_Star

```cpp
Histo1DPtr _c_Omega_Star;
```
