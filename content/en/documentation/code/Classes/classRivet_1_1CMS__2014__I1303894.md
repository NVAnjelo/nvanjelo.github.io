...
title: "Rivet::CMS_2014_I1303894"
summary: "Differential cross-section of W bosons + jets in pp collisions at sqrt(s)=7 TeV. "

---

# Rivet::CMS_2014_I1303894



Differential cross-section of W bosons + jets in pp collisions at sqrt(s)=7 TeV.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2014_I1303894](http://example.org/classes/classrivet_1_1cms__2014__i1303894/#function-cms-2014-i1303894)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2014__i1303894/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2014__i1303894/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2014__i1303894/#function-finalize)**() |
...
```cpp
class Rivet::CMS_2014_I1303894;
```

Differential cross-section of W bosons + jets in pp collisions at sqrt(s)=7 TeV. 

**Author**: Darin Baumgartel (<a href="mailto:darinb@cern.ch">darinb@cern.ch</a>)


Based on <a href="http://example.org/namespaces/namespacerivet/">Rivet</a> analysis originally created by Anil Singh (<a href="mailto:anil@cern.ch">anil@cern.ch</a>), Lovedeep Saini (<a href="mailto:lovedeep@cern.ch">lovedeep@cern.ch</a>) 

## Public Functions Documentation

### function CMS_2014_I1303894

```cpp
inline CMS_2014_I1303894()
```
