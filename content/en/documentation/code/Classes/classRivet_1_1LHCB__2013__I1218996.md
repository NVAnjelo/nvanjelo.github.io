...
|                | Name           |
| -------------- | -------------- |
| | **[LHCB_2013_I1218996](http://example.org/classes/classrivet_1_1lhcb__2013__i1218996/#function-lhcb-2013-i1218996)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2013__i1218996/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2013__i1218996/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2013__i1218996/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function LHCB_2013_I1218996

```cpp
inline LHCB_2013_I1218996()
```
...
Avoid the implicit division by the bin width in the <a href="http://example.org/classes/classrivet_1_1binnedhistogram/#function-scale">BinnedHistogram::scale</a> method.
