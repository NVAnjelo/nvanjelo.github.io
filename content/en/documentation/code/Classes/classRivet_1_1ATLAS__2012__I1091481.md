...
title: "Rivet::ATLAS_2012_I1091481"

---

# Rivet::ATLAS_2012_I1091481
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1091481](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-atlas-2012-i1091481)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[getPionEnergy](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-getpionenergy)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) |
| double | **[getSeta](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-getseta)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & part, double xi) |
| double | **[getSE](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-getse)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & part, double omega) |
| void | **[fillS](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-fills)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> h, const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & part, bool SE =true) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1091481/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2012_I1091481

```cpp
inline ATLAS_2012_I1091481()
```
...
### function getPionEnergy

```cpp
inline double getPionEnergy(
    const Particle & p
)
```
