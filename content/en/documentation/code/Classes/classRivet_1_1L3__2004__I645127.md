...
title: "Rivet::L3_2004_I645127"
summary: "mu+mu- and tau+tau- in gamma gamma "

---

# Rivet::L3_2004_I645127



mu+mu- and tau+tau- in gamma gamma 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1l3__2004__i645127/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1l3__2004__i645127/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1l3__2004__i645127/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1l3__2004__i645127/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1l3__2004__i645127/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1l3__2004__i645127/">L3_2004_I645127</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_sigma_mu1](http://example.org/classes/classrivet_1_1l3__2004__i645127/#variable--c-sigma-mu1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_sigma_mu2](http://example.org/classes/classrivet_1_1l3__2004__i645127/#variable--c-sigma-mu2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_sigma_tau](http://example.org/classes/classrivet_1_1l3__2004__i645127/#variable--c-sigma-tau)**  |
| unsigned int | **[_mode](http://example.org/classes/classrivet_1_1l3__2004__i645127/#variable--mode)**  |
...
### variable _c_sigma_mu1

```cpp
CounterPtr _c_sigma_mu1;
```


### variable _c_sigma_mu2

```cpp
CounterPtr _c_sigma_mu2;
```


### variable _c_sigma_tau

```cpp
CounterPtr _c_sigma_tau;
```
