...
title: "Rivet::H1_2009_I810046"
summary: "Cross-sections of $K_{0}$avoidf and $avoidLambda$avoidf in DIS. "

---

# Rivet::H1_2009_I810046



Cross-sections of \(K_{0}$\f and \)\Lambda$\f in DIS. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1h1__2009__i810046/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1h1__2009__i810046/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1h1__2009__i810046/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1h1__2009__i810046/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1h1__2009__i810046/">H1_2009_I810046</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0S_pt](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-k0s-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0S_eta](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-k0s-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0S_x](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-k0s-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0S_q2](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-k0s-q2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_LAMBDA_pt](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-lambda-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_LAMBDA_eta](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-lambda-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_LAMBDA_x](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-lambda-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_LAMBDA_q2](http://example.org/classes/classrivet_1_1h1__2009__i810046/#variable--h-lambda-q2)**  |
...
```cpp
Histo1DPtr _h_K0S_q2;
```


### variable _h_LAMBDA_pt

```cpp
Histo1DPtr _h_LAMBDA_pt;
```


### variable _h_LAMBDA_eta

```cpp
Histo1DPtr _h_LAMBDA_eta;
```
...
### variable _h_LAMBDA_q2

```cpp
Histo1DPtr _h_LAMBDA_q2;
```
