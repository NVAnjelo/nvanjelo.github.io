...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__hfjets/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__hfjets/">MC_HFJETS</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__hfjets/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__hfjets/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__hfjets/#function-finalize)**()<br>Normalise histograms etc., after the run.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptCJetLead](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptcjetlead)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptCHadrLead](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptchadrlead)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptFracC](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptfracc)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_eFracC](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-efracc)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptBJetLead](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptbjetlead)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptBHadrLead](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptbhadrlead)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ptFracB](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-ptfracb)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_eFracB](http://example.org/classes/classrivet_1_1mc__hfjets/#variable--h-efracb)**  |
...
### variable _h_ptCJetLead

```cpp
Histo1DPtr _h_ptCJetLead;
```


### variable _h_ptCHadrLead

```cpp
Histo1DPtr _h_ptCHadrLead;
```
...
```cpp
Histo1DPtr _h_eFracC;
```


### variable _h_ptBJetLead

```cpp
Histo1DPtr _h_ptBJetLead;
```


### variable _h_ptBHadrLead

```cpp
Histo1DPtr _h_ptBHadrLead;
```
