...
title: "Rivet::ATLAS_2011_I919017"

---

# Rivet::ATLAS_2011_I919017
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i919017/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i919017/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i919017/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2011_I919017](http://example.org/classes/classrivet_1_1atlas__2011__i919017/#function-atlas-2011-i919017)**()<br>Constructor.  |
...
### function ATLAS_2011_I919017

```cpp
inline ATLAS_2011_I919017()
```
