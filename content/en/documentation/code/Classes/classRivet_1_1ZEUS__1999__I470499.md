...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1zeus__1999__i470499/">ZEUS_1999_I470499</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| map< string, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#variable--h)**  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> > | **[_p](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#variable--p)**  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> > | **[_c](http://example.org/classes/classrivet_1_1zeus__1999__i470499/#variable--c)**  |
