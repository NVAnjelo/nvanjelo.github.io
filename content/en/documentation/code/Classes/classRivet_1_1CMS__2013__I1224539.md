...
title: "Rivet::CMS_2013_I1224539"

---

# Rivet::CMS_2013_I1224539
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| bool | **[isBackToBack_wj](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-isbacktoback-wj)**(const <a href="http://example.org/classes/classrivet_1_1wfinder/">WFinder</a> & wf, const fastjet::PseudoJet & psjet) |
| bool | **[isBackToBack_zj](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-isbacktoback-zj)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zf, const fastjet::PseudoJet & psjet) |
| size_t | **[findPtBin_vj](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-findptbin-vj)**(double ptJ) |
| size_t | **[findPtBin_jj](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-findptbin-jj)**(double ptJ) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[CMS_2013_I1224539](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#function-cms-2013-i1224539)**()<br>Constructor.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| bool | **[WJET](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#variable-wjet)**  |
| bool | **[ZJET](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#variable-zjet)**  |
| bool | **[DIJET](http://example.org/classes/classrivet_1_1cms__2013__i1224539/#variable-dijet)**  |
...
These are 2D histos rendered into slices

These are 2D histos rendered into slices


### function isBackToBack_wj

```cpp
inline bool isBackToBack_wj(
    const WFinder & wf,
    const fastjet::PseudoJet & psjet
)
```


TodoWe should make <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> know how to construct itself from a PseudoJet 


### function isBackToBack_zj

```cpp
inline bool isBackToBack_zj(
    const ZFinder & zf,
    const fastjet::PseudoJet & psjet
)
```
...
### function findPtBin_vj

```cpp
inline size_t findPtBin_vj(
    double ptJ
)
```


**Todo**: Use a <a href="http://example.org/namespaces/namespaceyoda/">YODA</a> axis/finder alg when available 

### function findPtBin_jj

```cpp
inline size_t findPtBin_jj(
    double ptJ
)
```
...
### function CMS_2013_I1224539

```cpp
inline CMS_2013_I1224539()
```
