...
title: "Rivet::STAR_2009_UE_HELEN"
summary: "STAR underlying event. "

---

# Rivet::STAR_2009_UE_HELEN



STAR underlying event.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__2009__ue__helen/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__2009__ue__helen/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__2009__ue__helen/#function-finalize)**() |
| | **[STAR_2009_UE_HELEN](http://example.org/classes/classrivet_1_1star__2009__ue__helen/#function-star-2009-ue-helen)**()<br>Constructor.  |
...
```cpp
class Rivet::STAR_2009_UE_HELEN;
```
...
### function STAR_2009_UE_HELEN

```cpp
inline STAR_2009_UE_HELEN()
```
