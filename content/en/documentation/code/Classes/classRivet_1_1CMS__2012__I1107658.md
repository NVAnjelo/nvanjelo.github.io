...
title: "Rivet::CMS_2012_I1107658"
summary: "Underlying event activity in the Drell-Yan process at 7 TeV. "

---

# Rivet::CMS_2012_I1107658
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2012_I1107658](http://example.org/classes/classrivet_1_1cms__2012__i1107658/#function-cms-2012-i1107658)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2012__i1107658/#function-init)**()<br>Initialization.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2012__i1107658/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2012__i1107658/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function CMS_2012_I1107658

```cpp
inline CMS_2012_I1107658()
```
...
Using a bare muon Z (but with a clustering radius!?)
