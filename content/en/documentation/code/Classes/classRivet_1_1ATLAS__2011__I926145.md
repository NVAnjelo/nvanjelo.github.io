...
title: "Rivet::ATLAS_2011_I926145"
summary: "Measurement of electron and muon differential cross section from heavy flavour production. "

---

# Rivet::ATLAS_2011_I926145



Measurement of electron and muon differential cross section from heavy flavour production.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2011__i926145/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2011__i926145/">ATLAS_2011_I926145</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i926145/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i926145/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i926145/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::ATLAS_2011_I926145;
```

Measurement of electron and muon differential cross section from heavy flavour production. 
