...
title: "Rivet::CMS_2013_I1122847"

---

# Rivet::CMS_2013_I1122847
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2013__i1122847/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2013__i1122847/">CMS_2013_I1122847</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1122847/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[cosThetaCS](http://example.org/classes/classrivet_1_1cms__2013__i1122847/#function-costhetacs)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & l1, const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & l2) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1122847/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1122847/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
TodoWhy include factors of sqrt2 which then get immediately multiplied then divided out? 

TodoCan be done more nicely via PID-ordered references to mom1, mom2 
