...
title: "Rivet::MC_WWINC"
summary: "MC validation analysis for W^+[enu]W^-[munu] events. "
...
MC validation analysis for W^+[enu]W^-[munu] events. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__wwinc/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__wwinc/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__wwinc/#function-finalize)**()<br>Finalize.  |
| | **[MC_WWINC](http://example.org/classes/classrivet_1_1mc__wwinc/#function-mc-wwinc)**()<br>Default constructor.  |
