...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2017__i1610623/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[_fill](http://example.org/classes/classrivet_1_1cms__2017__i1610623/#function--fill)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> & _histJetMult, std::vector< <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> > & finaljet_list) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2017__i1610623/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2017__i1610623/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2017__i1610623/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2017__i1610623/">CMS_2017_I1610623</a> )<br>Constructor.  |
...
inline void _fill(
    ...
    std::vector< FourMomentum > & finaljet_list
)
```
