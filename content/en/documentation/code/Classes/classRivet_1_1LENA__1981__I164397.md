...
title: "Rivet::LENA_1981_I164397"
summary: "Thrust like variable at Upsilon(1s,2S) "

---

# Rivet::LENA_1981_I164397



Thrust like variable at Upsilon(1s,2S) 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & charged)<br>Recursively walk the decay tree to find the charged decay products of _p_.  |
| double | **[thrustPrime](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-thrustprime)**(const <a href="http://example.org/classes/classrivet_1_1lorentztransform/">LorentzTransform</a> & boost, const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & particles) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lena__1981__i164397/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lena__1981__i164397/">LENA_1981_I164397</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_cont](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--weightsum-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups1](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--weightsum-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups2](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--weightsum-ups2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_charge_cont](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--charge-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_charge_Ups1](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--charge-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_charge_Ups2](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--charge-ups2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_T_cont](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--hist-t-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_T_Ups1](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--hist-t-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_T_Ups2](http://example.org/classes/classrivet_1_1lena__1981__i164397/#variable--hist-t-ups2)**  |
...
Recursively walk the decay tree to find the charged decay products of _p_. 

### function thrustPrime

```cpp
inline double thrustPrime(
...
### variable _charge_cont

```cpp
CounterPtr _charge_cont;
```


### variable _charge_Ups1

```cpp
CounterPtr _charge_Ups1;
```


### variable _charge_Ups2

```cpp
CounterPtr _charge_Ups2;
```


### variable _hist_T_cont

```cpp
Histo1DPtr _hist_T_cont;
```


### variable _hist_T_Ups1

```cpp
Histo1DPtr _hist_T_Ups1;
```


### variable _hist_T_Ups2

```cpp
Histo1DPtr _hist_T_Ups2;
```
