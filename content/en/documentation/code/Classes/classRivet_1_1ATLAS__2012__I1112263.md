...
title: "Rivet::ATLAS_2012_I1112263"

---

# Rivet::ATLAS_2012_I1112263
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1112263/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1112263/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1112263/#function-finalize)**() |
| | **[ATLAS_2012_I1112263](http://example.org/classes/classrivet_1_1atlas__2012__i1112263/#function-atlas-2012-i1112263)**()<br>Constructor.  |
...
```cpp
class Rivet::ATLAS_2012_I1112263;
```
...
### function ATLAS_2012_I1112263

```cpp
inline ATLAS_2012_I1112263()
```
