...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__zzktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__zzktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__zzktsplittings/#function-finalize)**()<br>Finalize.  |
| | **[MC_ZZKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__zzktsplittings/#function-mc-zzktsplittings)**()<br>Default constructor.  |
...
### function MC_ZZKTSPLITTINGS

```cpp
inline MC_ZZKTSPLITTINGS()
```
