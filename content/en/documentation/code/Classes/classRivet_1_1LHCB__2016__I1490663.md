...
title: "Rivet::LHCB_2016_I1490663"
summary: "LHCb prompt charm hadron pT and rapidity spectra. "

---

# Rivet::LHCB_2016_I1490663
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2016__i1490663/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2016__i1490663/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2016__i1490663/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lhcb__2016__i1490663/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lhcb__2016__i1490663/">LHCB_2016_I1490663</a> )<br>Constructor.  |
...
Book histograms TodoMake this interface nicer! 
...
TodoUse <a href="http://example.org/classes/classrivet_1_1primaryhadrons/">PrimaryHadrons</a> to avoid double counting and automatically remove the contributions from unstable? 

< Double analysis efficiency with a "two-sided LHCb"
...
Avoid the implicit division by the bin width in the <a href="http://example.org/classes/classrivet_1_1binnedhistogram/#function-scale">BinnedHistogram::scale</a> method. TodoAnother thing to make nicer / more flexible in BinnedHisto 
