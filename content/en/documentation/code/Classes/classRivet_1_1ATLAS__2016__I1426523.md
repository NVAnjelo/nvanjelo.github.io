...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[bookHandler](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-bookhandler)**(const string & tag, size_t ID) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillWithOverflow](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-fillwithoverflow)**(const string & tag, const double value, const double overflow) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| void | **[makeScatterWithoutDividingByBinwidth](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-makescatterwithoutdividingbybinwidth)**(const string & tag) |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2016__i1426523/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2016__i1426523/">ATLAS_2016_I1426523</a> )<br>Constructor.  |
...
### function fillWithOverflow

```cpp
inline void fillWithOverflow(
    const string & tag,
    const double value,
...
### function makeScatterWithoutDividingByBinwidth

```cpp
inline void makeScatterWithoutDividingByBinwidth(
    const string & tag
)
```
