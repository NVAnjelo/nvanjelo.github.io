...
title: "Rivet::D0_2000_I503361"

---

# Rivet::D0_2000_I503361
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1d0__2000__i503361/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1d0__2000__i503361/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1d0__2000__i503361/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1d0__2000__i503361/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1d0__2000__i503361/">D0_2000_I503361</a> )<br>Constructor.  |
...
```cpp
class Rivet::D0_2000_I503361;
```


**Author**: Simone Amoroso 

@ D0 <a href="http://example.org/classes/classrivet_1_1run/">Run</a> I Z \( p_\perp \) in Drell-Yan events 
