...
title: "Rivet::PLUTO_1977_I110272"
summary: "R for energies between 3.1 and 4.8 GeV. "

---

# Rivet::PLUTO_1977_I110272



R for energies between 3.1 and 4.8 GeV. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1pluto__1977__i110272/">PLUTO_1977_I110272</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_hadrons](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#variable--c-hadrons)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_muons](http://example.org/classes/classrivet_1_1pluto__1977__i110272/#variable--c-muons)**  |
