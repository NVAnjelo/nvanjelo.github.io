...
title: "Rivet::MC_PARTONICTOPS"
summary: "Find and plot partonic top properties (requires tops in event record) "

---

# Rivet::MC_PARTONICTOPS
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__partonictops/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__partonictops/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__partonictops/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__partonictops/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__partonictops/">MC_PARTONICTOPS</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_n](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-n)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_n_first](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-n-first)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tlep_n](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tlep-n)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_thad_n](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-thad-n)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_pt](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_pt_first](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-pt-first)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tlep_pt](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tlep-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_thad_pt](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-thad-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_y](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-y)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_y_first](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-y-first)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tlep_y](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tlep-y)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_thad_y](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-thad-y)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_tall_pt_dfirstlast](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--h-tall-pt-dfirstlast)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_tall_pt_dfirstlast](http://example.org/classes/classrivet_1_1mc__partonictops/#variable--p-tall-pt-dfirstlast)**  |
...
```cpp
Histo1DPtr _h_tall_n;
```


### variable _h_tall_n_first

```cpp
Histo1DPtr _h_tall_n_first;
```
...
```cpp
Histo1DPtr _h_tall_pt;
```


### variable _h_tall_pt_first

```cpp
Histo1DPtr _h_tall_pt_first;
```
...
```cpp
Histo1DPtr _h_tall_y;
```


### variable _h_tall_y_first

```cpp
Histo1DPtr _h_tall_y_first;
```
...
```cpp
Histo1DPtr _h_thad_y;
```


### variable _h_tall_pt_dfirstlast
...
### variable _p_tall_pt_dfirstlast
