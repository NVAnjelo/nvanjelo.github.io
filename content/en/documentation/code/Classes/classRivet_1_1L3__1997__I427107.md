...
title: "Rivet::L3_1997_I427107"
summary: "eta' and omega production at mz "

---

# Rivet::L3_1997_I427107



eta' and omega production at mz 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1l3__1997__i427107/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1l3__1997__i427107/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1l3__1997__i427107/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1l3__1997__i427107/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1l3__1997__i427107/">L3_1997_I427107</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histXpEtaP1](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histxpetap1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histXpEtaP2](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histxpetap2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histLnXpEtaP1](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histlnxpetap1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histLnXpEtaP2](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histlnxpetap2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histXpOmega](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histxpomega)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histLnXpOmega](http://example.org/classes/classrivet_1_1l3__1997__i427107/#variable--histlnxpomega)**  |
...
### variable _histXpEtaP1

```cpp
Histo1DPtr _histXpEtaP1;
```


### variable _histXpEtaP2

```cpp
Histo1DPtr _histXpEtaP2;
```


### variable _histLnXpEtaP1

```cpp
Histo1DPtr _histLnXpEtaP1;
```


### variable _histLnXpEtaP2

```cpp
Histo1DPtr _histLnXpEtaP2;
```


### variable _histXpOmega
