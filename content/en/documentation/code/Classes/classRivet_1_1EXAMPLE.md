...
title: "Rivet::EXAMPLE"
summary: "Just measures a few observables as a demo. "
...
Just measures a few observables as a demo. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1example/#function-init)**()<br>Set up projections and book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1example/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1example/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1example/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1example/">EXAMPLE</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histTot](http://example.org/classes/classrivet_1_1example/#variable--histtot)** <br>Histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histChTot](http://example.org/classes/classrivet_1_1example/#variable--histchtot)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histHadrTot](http://example.org/classes/classrivet_1_1example/#variable--histhadrtot)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histHadrChTot](http://example.org/classes/classrivet_1_1example/#variable--histhadrchtot)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histThrust](http://example.org/classes/classrivet_1_1example/#variable--histthrust)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histMajor](http://example.org/classes/classrivet_1_1example/#variable--histmajor)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histSphericity](http://example.org/classes/classrivet_1_1example/#variable--histsphericity)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histAplanarity](http://example.org/classes/classrivet_1_1example/#variable--histaplanarity)**  |
