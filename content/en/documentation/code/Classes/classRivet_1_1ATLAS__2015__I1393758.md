...
title: "Rivet::ATLAS_2015_I1393758"

---

# Rivet::ATLAS_2015_I1393758
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2015__i1393758/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2015__i1393758/">ATLAS_2015_I1393758</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2015__i1393758/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2015__i1393758/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| double | **[CalculateJetCharge](http://example.org/classes/classrivet_1_1atlas__2015__i1393758/#function-calculatejetcharge)**(<a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & jet, double kappa =0.5, double pTcut =0.5, double Qmax =1.2) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2015__i1393758/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function CalculateJetCharge

```cpp
inline double CalculateJetCharge(
    Jet & jet,
    double kappa =0.5,
    double pTcut =0.5,
    double Qmax =1.2
