...
title: "Rivet::CLEOII_1998_I467642"
summary: "Upsilon(2S) -> Upsilon(1S) pi+pi-. "

---

# Rivet::CLEOII_1998_I467642
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pip, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pim, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & onium) |
| void | **[findLeptons](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-findleptons)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lp, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lm) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__1998__i467642/">CLEOII_1998_I467642</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_charged_ex](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-charged-ex)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_charged_inc](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-charged-inc)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_neutral_ex](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-neutral-ex)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lept_ctheta](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-lept-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lept_phi](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-lept-phi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_piStar_ctheta](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-pistar-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_piStar_phi](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-pistar-phi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pi_ctheta](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-pi-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pi_phi](http://example.org/classes/classrivet_1_1cleoii__1998__i467642/#variable--h-pi-phi)**  |
...
### variable _h_charged_ex

```cpp
Histo1DPtr _h_charged_ex;
```


### variable _h_charged_inc

```cpp
Histo1DPtr _h_charged_inc;
```


### variable _h_neutral_ex

```cpp
Histo1DPtr _h_neutral_ex;
```


### variable _h_lept_ctheta

```cpp
Histo1DPtr _h_lept_ctheta;
```


### variable _h_lept_phi

```cpp
Histo1DPtr _h_lept_phi;
```


### variable _h_piStar_ctheta

```cpp
Histo1DPtr _h_piStar_ctheta;
```


### variable _h_piStar_phi

```cpp
Histo1DPtr _h_piStar_phi;
```


### variable _h_pi_ctheta

```cpp
Histo1DPtr _h_pi_ctheta;
```
