...
title: "Rivet::CMS_2020_I1837084"
summary: "Measurements of differential Z-boson -> ll and vv production cross-sections in 13 TeV pp collisions. "

---

# Rivet::CMS_2020_I1837084
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[normalizeToSum](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#function-normalizetosum)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2020__i1837084/">CMS_2020_I1837084</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Z_pt](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#variable--h-z-pt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Z_pt_norm](http://example.org/classes/classrivet_1_1cms__2020__i1837084/#variable--h-z-pt-norm)**  |
...
### variable _h_Z_pt_norm

```cpp
Histo1DPtr _h_Z_pt_norm;
```
