...
title: "Rivet::TASSO_1990_I284251"
summary: "K0 and K*+ spectra. "

---

# Rivet::TASSO_1990_I284251
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1tasso__1990__i284251/">TASSO_1990_I284251</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0_x](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--h-k0-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Kstar_x](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--h-kstar-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_K0_S_1](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--p-k0-s-1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_K0_S_2](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--p-k0-s-2)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_Kstar_S_1](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--p-kstar-s-1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_Kstar_S_2](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--p-kstar-s-2)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_K0](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--n-k0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_Kstar](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--n-kstar)**  |
| int | **[_ih](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--ih)**  |
| int | **[_iy](http://example.org/classes/classrivet_1_1tasso__1990__i284251/#variable--iy)**  |
...
```cpp
Profile1DPtr _p_K0_S_2;
```


### variable _p_Kstar_S_1

```cpp
Profile1DPtr _p_Kstar_S_1;
```


### variable _p_Kstar_S_2

```cpp
Profile1DPtr _p_Kstar_S_2;
```
