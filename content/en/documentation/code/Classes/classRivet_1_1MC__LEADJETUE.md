...
title: "Rivet::MC_LEADJETUE"
summary: "MC validation analysis for underlying event in jet events. "
...
MC validation analysis for underlying event in jet events.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__leadjetue/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__leadjetue/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__leadjetue/#function-finalize)**() |
| | **[MC_LEADJETUE](http://example.org/classes/classrivet_1_1mc__leadjetue/#function-mc-leadjetue)**()<br>Constructor.  |
...
```cpp
class Rivet::MC_LEADJETUE;
```

MC validation analysis for underlying event in jet events. 
