...
title: "Rivet::ARGUS_1988_I251097"
summary: "hyperon production "

---

# Rivet::ARGUS_1988_I251097
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1argus__1988__i251097/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1argus__1988__i251097/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & unstable)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1argus__1988__i251097/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1argus__1988__i251097/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1argus__1988__i251097/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1argus__1988__i251097/">ARGUS_1988_I251097</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_ups1_lambda](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-ups1-lambda)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_ups2_lambda](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-ups2-lambda)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_cont_lambda1](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-cont-lambda1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_cont_lambda2](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-cont-lambda2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_ups1_xi](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-ups1-xi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_ups2_xi](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-ups2-xi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_cont_xi](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--hist-cont-xi)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_mult](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--mult)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_cont](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--weightsum-cont)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups1](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--weightsum-ups1)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum_Ups2](http://example.org/classes/classrivet_1_1argus__1988__i251097/#variable--weightsum-ups2)**  |
...
### variable _hist_ups1_lambda

```cpp
Histo1DPtr _hist_ups1_lambda;
```


### variable _hist_ups2_lambda

```cpp
Histo1DPtr _hist_ups2_lambda;
```


### variable _hist_cont_lambda1

```cpp
Histo1DPtr _hist_cont_lambda1;
```


### variable _hist_cont_lambda2

```cpp
Histo1DPtr _hist_cont_lambda2;
```


### variable _hist_ups1_xi

```cpp
Histo1DPtr _hist_ups1_xi;
```


### variable _hist_ups2_xi

```cpp
Histo1DPtr _hist_ups2_xi;
```


### variable _hist_cont_xi

```cpp
Histo1DPtr _hist_cont_xi;
```
