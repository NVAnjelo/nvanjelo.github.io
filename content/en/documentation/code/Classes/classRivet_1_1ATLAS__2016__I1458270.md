...
title: "Rivet::ATLAS_2016_I1458270"
summary: "ATLAS 0-lepton SUSY search with 3.2/fb of 13 TeV pp data. "

---

# Rivet::ATLAS_2016_I1458270



ATLAS 0-lepton SUSY search with 3.2/fb of 13 TeV pp data. 
...
|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[convertToScatterWithoutBinWidthDivision](http://example.org/classes/classrivet_1_1atlas__2016__i1458270/#function-converttoscatterwithoutbinwidthdivision)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> input, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> output) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2016__i1458270/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2016__i1458270/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2016__i1458270/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2016__i1458270/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2016__i1458270/">ATLAS_2016_I1458270</a> )<br>Constructor.  |
...
### function convertToScatterWithoutBinWidthDivision

```cpp
inline Scatter2DPtr convertToScatterWithoutBinWidthDivision(
    Histo1DPtr input,
    Scatter2DPtr output
)
```
...
< TodoPile-up subtraction 

TodoAdd track efficiency random filtering 

TodoWould be nice to pass a "tail view" for the filtering, but awkward without range API / iterator guts 
