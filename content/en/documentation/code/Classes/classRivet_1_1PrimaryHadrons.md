...
| | **[PrimaryHadrons](http://example.org/classes/classrivet_1_1primaryhadrons/#function-primaryhadrons)**(double mineta, double maxeta, double minpt =0.0 *<a href="http://example.org/namespaces/namespacerivet/#variable-gev">GeV</a>) |
...
TodoAre hadrons from tau decays "primary hadrons"? I guess not 
