...
title: "Rivet::ALICE_2016_I1507157"
summary: "Correlations of identified particles in pp. Also showcasing use of EventMixingFinalState. "

---

# Rivet::ALICE_2016_I1507157



Correlations of identified particles in pp. Also showcasing use of EventMixingFinalState. 
...
|                | Name           |
| -------------- | -------------- |
| double | **[phaseDif](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#function-phasedif)**(double a1, double a2)<br>Calculate angular distance between particles.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1alice__2016__i1507157/">ALICE_2016_I1507157</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< pair< int, int > > | **[pid](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-pid)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[signal](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-signal)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[background](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-background)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> > | **[ratio](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-ratio)**  |
| vector< double > | **[nsp](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-nsp)**  |
| vector< double > | **[nmp](http://example.org/classes/classrivet_1_1alice__2016__i1507157/#variable-nmp)**  |
...
```cpp
inline double phaseDif(
    double a1,
    double a2
)
```

Calculate angular distance between particles. 
