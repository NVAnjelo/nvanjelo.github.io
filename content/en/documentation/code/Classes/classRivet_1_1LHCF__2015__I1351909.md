...
title: "Rivet::LHCF_2015_I1351909"
summary: "Add a short analysis description here. "

---

# Rivet::LHCF_2015_I1351909
...
|                | Name           |
| -------------- | -------------- |
| bool | **[isParticleFromCollision](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-isparticlefromcollision)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & parents, const <a href="http://example.org/classes/classrivet_1_1beam/">Beam</a> & beams) const |
| bool | **[isParticleFromDecay](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-isparticlefromdecay)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p, const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & parents) const |
| bool | **[isDeviated](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-isdeviated)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p, <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> parent) |
| bool | **[isSameParticle](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-issameparticle)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p1, <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p2) |
| bool | **[isAlreadyProcessed](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-isalreadyprocessed)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p, vector< <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> > list) |
| double | **[RecomputeEta](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-recomputeeta)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> p)<br>This method return a fake pseudorapidity to check id decayed particle is in LHCf acceptance.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/">LHCF_2015_I1351909</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| constexpr bool | **[lhcf_like](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-lhcf-like)**  |
| constexpr int | **[ndecay](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-ndecay)**  |
| constexpr int | **[nbeam](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-nbeam)**  |
| constexpr double | **[D1_begin](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-d1-begin)**  |
| constexpr double | **[D1_end](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-d1-end)**  |
| constexpr double | **[IPtoLHCf](http://example.org/classes/classrivet_1_1lhcf__2015__i1351909/#variable-iptolhcf)**  |
...
### function isParticleFromCollision

```cpp
inline bool isParticleFromCollision(
    const Particle & p,
    const Particles & parents,
    const Beam & beams
) const
```


### function isParticleFromDecay

```cpp
inline bool isParticleFromDecay(
    const Particle p,
    const Particles & parents
) const
```
...
### function isSameParticle

```cpp
inline bool isSameParticle(
    Particle p1,
    Particle p2
)
```
...
```cpp
static constexpr double D1_begin = 82000.;
```
...
```cpp
static constexpr double D1_end = 82000;
```
...
```cpp
static constexpr double IPtoLHCf = 141050.;
```
