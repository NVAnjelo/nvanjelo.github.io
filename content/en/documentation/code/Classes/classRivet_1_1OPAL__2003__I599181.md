...
title: "Rivet::OPAL_2003_I599181"
summary: "OPAL b-fragmentation measurement for weak B-hadron decays. "

---

# Rivet::OPAL_2003_I599181



OPAL b-fragmentation measurement for weak B-hadron decays.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1opal__2003__i599181/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1opal__2003__i599181/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1opal__2003__i599181/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1opal__2003__i599181/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1opal__2003__i599181/">OPAL_2003_I599181</a> )<br>Constructor.  |
...
```cpp
class Rivet::OPAL_2003_I599181;
```

OPAL b-fragmentation measurement for weak B-hadron decays. 
