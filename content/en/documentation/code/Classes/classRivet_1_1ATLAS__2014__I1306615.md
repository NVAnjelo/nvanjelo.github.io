...
title: "Rivet::ATLAS_2014_I1306615"
summary: "ATLAS H->yy differential cross-sections measurement. "

---

# Rivet::ATLAS_2014_I1306615



ATLAS H->yy differential cross-sections measurement.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2014_I1306615](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-atlas-2014-i1306615)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-finalize)**() |
| bool | **[passVBFCuts](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-passvbfcuts)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & H, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & j1, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & j2) |
| double | **[cosTS_CS](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-costs-cs)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & y1, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & y2) |
| double | **[pTt](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-ptt)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & y1, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & y2) |
| double | **[tau_jet](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-tau-jet)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & H, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & jet) |
| double | **[tau_jet_max](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-tau-jet-max)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & H, const <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets, double tau_jet_cut =8.) |
| double | **[sum_tau_jet](http://example.org/classes/classrivet_1_1atlas__2014__i1306615/#function-sum-tau-jet)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & H, const <a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets, double tau_jet_cut =8.) |
...
```cpp
class Rivet::ATLAS_2014_I1306615;
```

ATLAS H->yy differential cross-sections measurement. 

**Author**: Michaela Queitsch-Maitland <a href="mailto:michaela.queitsch-maitland@cern.ch">michaela.queitsch-maitland@cern.ch</a>
## Public Functions Documentation

### function ATLAS_2014_I1306615

```cpp
inline ATLAS_2014_I1306615()
```
...
### function passVBFCuts

```cpp
inline bool passVBFCuts(
    const FourMomentum & H,
    const FourMomentum & j1,
...
```cpp
inline double cosTS_CS(
    const FourMomentum & y1,
    const FourMomentum & y2
)
```
...
```cpp
inline double tau_jet(
    const FourMomentum & H,
    const FourMomentum & jet
)
```


### function tau_jet_max

```cpp
inline double tau_jet_max(
    const FourMomentum & H,
    const Jets & jets,
...
### function sum_tau_jet

```cpp
inline double sum_tau_jet(
    const FourMomentum & H,
    const Jets & jets,
    double tau_jet_cut =8.
)
