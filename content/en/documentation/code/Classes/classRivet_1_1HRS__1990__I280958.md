...
title: "Rivet::HRS_1990_I280958"
summary: "Add a short analysis description here. "

---

# Rivet::HRS_1990_I280958
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1hrs__1990__i280958/">HRS_1990_I280958</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_X](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--h-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_rap_all](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--h-rap-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_rap_light](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--h-rap-light)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_rap_charm](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--h-rap-charm)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_wLight](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--wlight)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_wCharm](http://example.org/classes/classrivet_1_1hrs__1990__i280958/#variable--wcharm)**  |
...
```cpp
Histo1DPtr _h_rap_all;
```


### variable _h_rap_light

```cpp
Histo1DPtr _h_rap_light;
```


### variable _h_rap_charm

```cpp
Histo1DPtr _h_rap_charm;
```
