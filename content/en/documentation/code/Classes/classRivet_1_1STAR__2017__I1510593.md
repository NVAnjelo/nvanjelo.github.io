...
title: "Rivet::STAR_2017_I1510593"
summary: "pT distributions, ratios and production yields of hadrons in STAR "

---

# Rivet::STAR_2017_I1510593
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1star__2017__i1510593/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1star__2017__i1510593/">STAR_2017_I1510593</a> ) |
| string | **[coStr](http://example.org/classes/classrivet_1_1star__2017__i1510593/#function-costr)**(int i, int j, int k) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__2017__i1510593/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__2017__i1510593/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__2017__i1510593/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
TodoRaw arrays would be a _lot_ easier to read here (and N_cent is fixed) 
...
<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> Ratios

<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> Yields
...
Filling the bins with a value (here out of the defined screening range of the plot) when it has not been filled by anything, otherwise it won't want to plot
