...
Inherited by [Rivet::MC_ELECTRONS](http://example.org/classes/classrivet_1_1mc__electrons/), [Rivet::MC_MUONS](http://example.org/classes/classrivet_1_1mc__muons/), [Rivet::MC_TAUS](http://example.org/classes/classrivet_1_1mc__taus/)
...
| virtual void | **[_analyze](http://example.org/classes/classrivet_1_1mc__particleanalysis/#function--analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event, const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & particles)<br>For derived classes to call, passing the sorted particle collection that they wish to analyse.  |
...
|                | Name           |
| -------------- | -------------- |
| size_t | **[_nparts](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--nparts)** <br>The number of particles for which histograms are to be initialised.  |
| std::string | **[_pname](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--pname)** <br>The name of the particle species/group being analysed.  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_pt](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-pt)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_eta](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-eta)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_eta_plus](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-eta-plus)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_eta_minus](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-eta-minus)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_rap](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-rap)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_rap_plus](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-rap-plus)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_rap_minus](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-rap-minus)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> > | **[tmpeta](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable-tmpeta)**  |
| std::vector< <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> > | **[tmprap](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable-tmprap)**  |
| std::map< std::pair< size_t, size_t >, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_deta](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-deta)**  |
| std::map< std::pair< size_t, size_t >, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_dphi](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-dphi)**  |
| std::map< std::pair< size_t, size_t >, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h_dR](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-dr)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_multi_exclusive](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-exclusive)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_multi_inclusive](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-inclusive)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_multi_exclusive_prompt](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-exclusive-prompt)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_multi_inclusive_prompt](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-inclusive-prompt)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_multi_ratio](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-ratio)**  |
| <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> | **[_h_multi_ratio_prompt](http://example.org/classes/classrivet_1_1mc__particleanalysis/#variable--h-multi-ratio-prompt)**  |
...
**Reimplemented by**: [Rivet::MC_ELECTRONS::init](http://example.org/classes/classrivet_1_1mc__electrons/#function-init), [Rivet::MC_MUONS::init](http://example.org/classes/classrivet_1_1mc__muons/#function-init), [Rivet::MC_TAUS::init](http://example.org/classes/classrivet_1_1mc__taus/#function-init)
...
**Reimplemented by**: [Rivet::MC_ELECTRONS::analyze](http://example.org/classes/classrivet_1_1mc__electrons/#function-analyze), [Rivet::MC_MUONS::analyze](http://example.org/classes/classrivet_1_1mc__muons/#function-analyze), [Rivet::MC_TAUS::analyze](http://example.org/classes/classrivet_1_1mc__taus/#function-analyze)
...
**Reimplemented by**: [Rivet::MC_ELECTRONS::finalize](http://example.org/classes/classrivet_1_1mc__electrons/#function-finalize), [Rivet::MC_MUONS::finalize](http://example.org/classes/classrivet_1_1mc__muons/#function-finalize), [Rivet::MC_TAUS::finalize](http://example.org/classes/classrivet_1_1mc__taus/#function-finalize)
...
### variable _h_eta_plus

```cpp
std::vector< Histo1DPtr > _h_eta_plus;
```


### variable _h_eta_minus

```cpp
std::vector< Histo1DPtr > _h_eta_minus;
```
...
### variable _h_rap_plus

```cpp
std::vector< Histo1DPtr > _h_rap_plus;
```


### variable _h_rap_minus

```cpp
std::vector< Histo1DPtr > _h_rap_minus;
```
...
### variable _h_multi_exclusive

```cpp
Histo1DPtr _h_multi_exclusive;
```


### variable _h_multi_inclusive

```cpp
Histo1DPtr _h_multi_inclusive;
```


### variable _h_multi_exclusive_prompt

```cpp
Histo1DPtr _h_multi_exclusive_prompt;
```


### variable _h_multi_inclusive_prompt

```cpp
Histo1DPtr _h_multi_inclusive_prompt;
```


### variable _h_multi_ratio
...
### variable _h_multi_ratio_prompt

```cpp
Scatter2DPtr _h_multi_ratio_prompt;
```
