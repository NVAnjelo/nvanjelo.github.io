...
title: "Rivet::ATLAS_2012_I1204784"
summary: "ATLAS Z phi* measurement. "

---

# Rivet::ATLAS_2012_I1204784
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1204784](http://example.org/classes/classrivet_1_1atlas__2012__i1204784/#function-atlas-2012-i1204784)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1204784/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1204784/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillPlots](http://example.org/classes/classrivet_1_1atlas__2012__i1204784/#function-fillplots)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zfind, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist, <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> & binnedHist, double weight) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1204784/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2012_I1204784

```cpp
inline ATLAS_2012_I1204784()
```
