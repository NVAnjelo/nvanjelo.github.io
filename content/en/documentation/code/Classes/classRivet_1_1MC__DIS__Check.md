...
title: "Rivet::MC_DIS_Check"
summary: "A simple analysis to illustrate how to use the DISKinematics projection together with different options. "
...
<a href="http://example.org/classes/classrivet_1_1a/">A</a> simple analysis to illustrate how to use the <a href="http://example.org/classes/classrivet_1_1diskinematics/">DISKinematics</a> projection together with different options. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__dis__check/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__dis__check/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__dis__check/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__dis__check/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__dis__check/">MC_DIS_Check</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2](http://example.org/classes/classrivet_1_1mc__dis__check/#variable--hist-q2)** <br>The histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_y](http://example.org/classes/classrivet_1_1mc__dis__check/#variable--hist-y)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_x](http://example.org/classes/classrivet_1_1mc__dis__check/#variable--hist-x)**  |
