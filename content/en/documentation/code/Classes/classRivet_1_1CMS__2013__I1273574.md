...
title: "Rivet::CMS_2013_I1273574"
summary: "CMS 4-jet production at 7 TeV. "

---

# Rivet::CMS_2013_I1273574
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2013_I1273574](http://example.org/classes/classrivet_1_1cms__2013__i1273574/#function-cms-2013-i1273574)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1273574/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1273574/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1273574/#function-finalize)**()<br>Normalise histograms (mostly to cross-section)  |
...
### function CMS_2013_I1273574

```cpp
inline CMS_2013_I1273574()
```
...
TodoUse jetsByPt(ptGtr(20*GeV) & absetaIn(4.7)), then no need for the lower loop; 
