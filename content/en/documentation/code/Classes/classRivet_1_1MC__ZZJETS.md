...
title: "Rivet::MC_ZZJETS"
summary: "MC validation analysis for Z[ee]Z[mumu] + jets events. "
...
MC validation analysis for Z[ee]Z[mumu] + jets events. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__zzjets/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__zzjets/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__zzjets/#function-finalize)**()<br>Finalize.  |
| | **[MC_ZZJETS](http://example.org/classes/classrivet_1_1mc__zzjets/#function-mc-zzjets)**()<br>Default constructor.  |
