...
title: "Rivet::ATLAS_2017_I1609448"
summary: "ATLAS pTmiss+jets cross-section ratios at 13 TeV. "
...
|                | Name           |
| -------------- | -------------- |
| struct | **[HistoHandler](http://example.org/classes/structrivet_1_1atlas__2017__i1609448_1_1histohandler/)**  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2017_I1609448](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-atlas-2017-i1609448)**(const string name ="ATLAS_2017_I1609448", const string ref_data ="ATLAS_2017_I1609448")<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-init)**()<br>Initialize.  |
| <a href="http://example.org/classes/structrivet_1_1atlas__2017__i1609448_1_1histohandler/">HistoHandler</a> | **[bookHandler](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-bookhandler)**(unsigned int id_d, unsigned int id_x, unsigned int id_y) |
| bool | **[isBetweenJets](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-isbetweenjets)**(const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & probe, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & boundary1, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & boundary2) |
| int | **[centralJetVeto](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-centraljetveto)**(<a href="http://example.org/classes/classrivet_1_1jets/">Jets</a> & jets) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-finalize)**()<br>Normalise, scale and otherwise manipulate histograms here.  |
| void | **[constructRmiss](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#function-constructrmiss)**(<a href="http://example.org/classes/structrivet_1_1atlas__2017__i1609448_1_1histohandler/">HistoHandler</a> & handler) |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#variable--mode)**  |
| map< string, <a href="http://example.org/classes/structrivet_1_1atlas__2017__i1609448_1_1histohandler/">HistoHandler</a> > | **[_h](http://example.org/classes/classrivet_1_1atlas__2017__i1609448/#variable--h)** <br>Histograms.  |
...
### function ATLAS_2017_I1609448

```cpp
inline ATLAS_2017_I1609448(
    const string name ="ATLAS_2017_I1609448",
    const string ref_data ="ATLAS_2017_I1609448"
)
```
...
```cpp
inline HistoHandler bookHandler(
    unsigned int id_d,
    unsigned int id_x,
    unsigned int id_y
)
...
### function isBetweenJets

```cpp
inline bool isBetweenJets(
    const Jet & probe,
    const Jet & boundary1,
    const Jet & boundary2
)
...
### function centralJetVeto

```cpp
inline int centralJetVeto(
    Jets & jets
)
```
...
```cpp
inline void constructRmiss(
    HistoHandler & handler
)
```
