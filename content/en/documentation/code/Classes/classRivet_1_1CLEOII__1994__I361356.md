...
title: "Rivet::CLEOII_1994_I361356"
summary: "Sigma_c 0,++ spectra. "

---

# Rivet::CLEOII_1994_I361356
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> parent, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & Sigma) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__1994__i361356/">CLEOII_1994_I361356</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Sigma_0](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#variable--h-sigma-0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Sigma_pp](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#variable--h-sigma-pp)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_b_Sigma_0](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#variable--b-sigma-0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_b_Sigma_pp](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#variable--b-sigma-pp)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_ups](http://example.org/classes/classrivet_1_1cleoii__1994__i361356/#variable--c-ups)**  |
...
```cpp
Histo1DPtr _h_Sigma_0;
```


### variable _h_Sigma_pp

```cpp
Histo1DPtr _h_Sigma_pp;
```
...
```cpp
Histo1DPtr _b_Sigma_0;
```


### variable _b_Sigma_pp

```cpp
Histo1DPtr _b_Sigma_pp;
```
