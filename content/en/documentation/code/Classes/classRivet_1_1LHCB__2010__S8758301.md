...
title: "Rivet::LHCB_2010_S8758301"
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[LHCB_2010_S8758301](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#function-lhcb-2010-s8758301)**()<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_y_30](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-y-30)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_y_35](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-y-35)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_y_40](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-y-40)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_30](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-30)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_35](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-35)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_40](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-40)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_K0s_pt_y_all](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--h-k0s-pt-y-all)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[sumKs0_30](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-30)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[sumKs0_35](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-35)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[sumKs0_40](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-40)**  |
| size_t | **[sumKs0_all](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-all)**  |
| size_t | **[sumKs0_outup](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-outup)**  |
| size_t | **[sumKs0_outdwn](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sumks0-outdwn)**  |
| size_t | **[sum_low_pt_loss](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sum-low-pt-loss)**  |
| size_t | **[sum_high_pt_loss](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-sum-high-pt-loss)**  |
| const double | **[MIN_PT](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable-min-pt)**  |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1lhcb__2010__s8758301/#variable--mode)** <br>Mode switch.  |
...
### function LHCB_2010_S8758301

```cpp
inline LHCB_2010_S8758301()
```
...
### variable _h_K0s_pt_30

```cpp
Histo1DPtr _h_K0s_pt_30;
```


### variable _h_K0s_pt_35

```cpp
Histo1DPtr _h_K0s_pt_35;
```


### variable _h_K0s_pt_40

```cpp
Histo1DPtr _h_K0s_pt_40;
```


### variable _h_K0s_pt_y_all

```cpp
Histo1DPtr _h_K0s_pt_y_all;
```
...
### variable sumKs0_outdwn

```cpp
size_t sumKs0_outdwn;
```


### variable sum_low_pt_loss

```cpp
size_t sum_low_pt_loss;
```


### variable sum_high_pt_loss

```cpp
size_t sum_high_pt_loss;
```
...
Updated on 2022-07-27 at 19:10:02 +0100