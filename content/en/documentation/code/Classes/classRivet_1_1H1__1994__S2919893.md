...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1h1__1994__s2919893/#function-init)**()<br>Initialise projections and histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1h1__1994__s2919893/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Analyse each event.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1h1__1994__s2919893/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1h1__1994__s2919893/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1h1__1994__s2919893/">H1_1994_S2919893</a> )<br>Constructor.  |
...
```cpp
class Rivet::H1_1994_S2919893;
```

H1 energy flow and charged particle spectra. 

**Author**: Peter Richardson Based on the equivalent HZTool analysis 
...
TodoUse units in w comparisons... what are the units? 

TodoIs this profile meant to be filled with 2 weight factors? 

TodoUse angle function 
