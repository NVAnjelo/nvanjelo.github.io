...
title: "Rivet::MC_Onium_PiPi_Decay"
summary: "Add a short analysis description here. "

---

# Rivet::MC_Onium_PiPi_Decay
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[bookHistos](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-bookhistos)**(int id1, int id2, double deltaM) |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pip, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pim, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & onium) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/">MC_Onium_PiPi_Decay</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< long > | **[_incoming](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#variable--incoming)**  |
| vector< long > | **[_outgoing](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#variable--outgoing)**  |
| vector< pair< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a>, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > > | **[_mpipi](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#variable--mpipi)**  |
| vector< pair< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a>, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > > | **[_hel](http://example.org/classes/classrivet_1_1mc__onium__pipi__decay/#variable--hel)**  |
...
Histograms for the \(\pi^+\pi^-\) masses 
