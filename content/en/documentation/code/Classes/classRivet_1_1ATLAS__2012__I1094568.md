...
title: "Rivet::ATLAS_2012_I1094568"
summary: "Top pair production with central jet veto. "

---

# Rivet::ATLAS_2012_I1094568
...
|                | Name           |
| -------------- | -------------- |
| struct | **[Plots](http://example.org/classes/structrivet_1_1atlas__2012__i1094568_1_1plots/)**  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2012__i1094568/">ATLAS_2012_I1094568</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[initializePlots](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-initializeplots)**(<a href="http://example.org/classes/structrivet_1_1atlas__2012__i1094568_1_1plots/">Plots</a> & plots) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| void | **[finalizeGapFraction](http://example.org/classes/classrivet_1_1atlas__2012__i1094568/#function-finalizegapfraction)**(const double total_weight, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> gapFrac, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> vetoPt) |
...
TodoUse <a href="http://example.org/classes/classrivet_1_1missingmomentum/">MissingMomentum</a> instead? 
...
### function finalizeGapFraction

```cpp
inline void finalizeGapFraction(
    const double total_weight,
    Scatter2DPtr gapFrac,
    Histo1DPtr vetoPt
)
```


**Todo**: Should be possible to replace this with a couple of <a href="http://example.org/namespaces/namespaceyoda/">YODA</a> one-lines for diff -> integral and "efficiency division" 

Convert temporary histos to cumulative efficiency scatters 


TodoGet rid of this and use vetoPt->integral(i+1) when points and bins line up? 
