...
title: "Rivet::MC_ZZINC"
summary: "MC validation analysis for Z[ee]Z[mumu] events. "
...
MC validation analysis for Z[ee]Z[mumu] events. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__zzinc/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__zzinc/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__zzinc/#function-finalize)**()<br>Finalize.  |
| | **[MC_ZZINC](http://example.org/classes/classrivet_1_1mc__zzinc/#function-mc-zzinc)**()<br>Default constructor.  |
