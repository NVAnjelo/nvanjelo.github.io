...
title: "Rivet::CLEO_1992_I315181"
summary: "p, Lambda, Lambda_c and Xi spectra at Upsilon(4s) "

---

# Rivet::CLEO_1992_I315181



p, Lambda, Lambda_c and Xi spectra at Upsilon(4s) 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> parent, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & protons, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lambda_c, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lambda, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & xi) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleo__1992__i315181/">CLEO_1992_I315181</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_ups](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#variable--c-ups)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_p](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#variable--h-p)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Lambda_c](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#variable--h-lambda-c)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Lambda](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#variable--h-lambda)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Xi](http://example.org/classes/classrivet_1_1cleo__1992__i315181/#variable--h-xi)**  |
...
### variable _h_Lambda_c

```cpp
Histo1DPtr _h_Lambda_c;
```
