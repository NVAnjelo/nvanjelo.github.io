...
title: "Rivet::ALEPH_1996_I415745"
summary: "Lambda polarization at LEP1. "

---

# Rivet::ALEPH_1996_I415745



Lambda polarization at LEP1. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcAlpha](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| pair< double, double > | **[calcAsymmetry](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-calcasymmetry)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hist, unsigned int mode) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1aleph__1996__i415745/">ALEPH_1996_I415745</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_ctheta](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-ctheta)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_plus_cphi](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-plus-cphi)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_minus_cphi](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-minus-cphi)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_plus_lam](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-plus-lam)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_minus_lam](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-minus-lam)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ctheta_large](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-ctheta-large)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_minus_cphi_low](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-minus-cphi-low)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_minus_cphi_mid](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-minus-cphi-mid)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_minus_cphi_high](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-minus-cphi-high)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_plus_cphi_low](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-plus-cphi-low)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_plus_cphi_mid](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-plus-cphi-mid)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_plus_cphi_high](http://example.org/classes/classrivet_1_1aleph__1996__i415745/#variable--h-plus-cphi-high)**  |
...
```cpp
inline pair< double, double > calcAlpha(
    Histo1DPtr hist
)
```
...
```cpp
inline pair< double, double > calcAsymmetry(
    Scatter2DPtr hist,
    unsigned int mode
)
```
...
### variable _h_plus_cphi

```cpp
BinnedHistogram _h_plus_cphi;
```


### variable _h_minus_cphi

```cpp
BinnedHistogram _h_minus_cphi;
```


### variable _h_plus_lam

```cpp
BinnedHistogram _h_plus_lam;
```


### variable _h_minus_lam

```cpp
BinnedHistogram _h_minus_lam;
```


### variable _h_ctheta_large
...
### variable _h_minus_cphi_low

```cpp
Histo1DPtr _h_minus_cphi_low;
```


### variable _h_minus_cphi_mid

```cpp
Histo1DPtr _h_minus_cphi_mid;
```


### variable _h_minus_cphi_high

```cpp
Histo1DPtr _h_minus_cphi_high;
```


### variable _h_plus_cphi_low

```cpp
Histo1DPtr _h_plus_cphi_low;
```


### variable _h_plus_cphi_mid

```cpp
Histo1DPtr _h_plus_cphi_mid;
```


### variable _h_plus_cphi_high

```cpp
Histo1DPtr _h_plus_cphi_high;
```
