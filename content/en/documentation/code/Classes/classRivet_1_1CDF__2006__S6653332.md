...
title: "Rivet::CDF_2006_S6653332"
summary: "CDF Run II analysis: jet $ p_T $ and $ avoideta $ distributions in Z + (b) jet production. "
...
CDF Run II analysis: jet \( p_T \) and \( \eta \) distributions in Z + (b) jet production.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2006__s6653332/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2006__s6653332/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2006__s6653332/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2006__s6653332/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2006__s6653332/">CDF_2006_S6653332</a> )<br>Constructor.  |
...
```cpp
class Rivet::CDF_2006_S6653332;
```

CDF Run II analysis: jet \( p_T \) and \( \eta \) distributions in Z + (b) jet production. 

**Author**: Lars Sonnenschein


This CDF analysis provides \( p_T \) and \( \eta \) distributions of jets in Z + (b) jet production, before and after tagging. 
...
< TodoThis is y... should be <a href="http://example.org/namespaces/namespacerivet_1_1cuts/#enumvalue-abseta">abseta()</a>? 

< TodoThis is y... should be <a href="http://example.org/namespaces/namespacerivet_1_1cuts/#enumvalue-abseta">abseta()</a>? 

TodoWrite out a warning if there are more than two decay products 

TodoUse jet contents rather than accessing quarks directly 

Todois this HepMC wrangling necessary? 
