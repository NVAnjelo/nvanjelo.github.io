...
title: "Rivet::CMS_2016_I1491950"

---

# Rivet::CMS_2016_I1491950
...
|                | Name           |
| -------------- | -------------- |
| class | **[SpecialDressedLeptons](http://example.org/classes/classrivet_1_1cms__2016__i1491950_1_1specialdressedleptons/)** <br>Special dressed lepton finder.  |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[CMS_2016_I1491950](http://example.org/classes/classrivet_1_1cms__2016__i1491950/#function-cms-2016-i1491950)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2016__i1491950/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2016__i1491950/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2016__i1491950/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function CMS_2016_I1491950

```cpp
inline CMS_2016_I1491950()
```
