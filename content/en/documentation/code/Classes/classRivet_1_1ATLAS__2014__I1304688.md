...
title: "Rivet::ATLAS_2014_I1304688"
summary: "ATLAS 7 TeV jets in ttbar events analysis. "

---

# Rivet::ATLAS_2014_I1304688



ATLAS 7 TeV jets in ttbar events analysis.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2014_I1304688](http://example.org/classes/classrivet_1_1atlas__2014__i1304688/#function-atlas-2014-i1304688)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1304688/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1304688/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1304688/#function-finalize)**() |
...
```cpp
class Rivet::ATLAS_2014_I1304688;
```

ATLAS 7 TeV jets in ttbar events analysis. 

**Author**: 

  * W. H. Bell <a href="mailto:W.Bell@cern.ch">W.Bell@cern.ch</a>
  * <a href="http://example.org/classes/classrivet_1_1a/">A</a>. Grohsjean <a href="mailto:alexander.grohsjean@desy.de">alexander.grohsjean@desy.de</a>

## Public Functions Documentation

### function ATLAS_2014_I1304688

```cpp
inline ATLAS_2014_I1304688()
```
...
TodoWhy not use <a href="http://example.org/classes/classrivet_1_1missingmomentum/">MissingMomentum</a>? 
...
< TodoRemove when C++11 allowed 

< TodoUse normalize(ihpair.second, <a href="http://example.org/classes/classrivet_1_1analysis/#function-crosssection">crossSection()</a>) 
