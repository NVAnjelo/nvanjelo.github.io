...
title: "Rivet::ATLAS_2011_S9120807"
summary: "Measurement of isolated diphoton + X differential cross-sections. "

---

# Rivet::ATLAS_2011_S9120807



Measurement of isolated diphoton + X differential cross-sections.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2011__s9120807/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2011__s9120807/">ATLAS_2011_S9120807</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__s9120807/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| size_t | **[getEtaBin](http://example.org/classes/classrivet_1_1atlas__2011__s9120807/#function-getetabin)**(double eta) const |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__s9120807/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__s9120807/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::ATLAS_2011_S9120807;
```

Measurement of isolated diphoton + X differential cross-sections. 
