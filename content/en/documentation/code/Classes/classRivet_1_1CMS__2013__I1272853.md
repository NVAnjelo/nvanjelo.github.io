...
title: "Rivet::CMS_2013_I1272853"
summary: "CMS W + 2 jet double parton scattering analysis. "

---

# Rivet::CMS_2013_I1272853
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2013_I1272853](http://example.org/classes/classrivet_1_1cms__2013__i1272853/#function-cms-2013-i1272853)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1272853/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1272853/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1272853/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function CMS_2013_I1272853

```cpp
inline CMS_2013_I1272853()
```
...
TodoUse C++11 initialisation syntax 
...
TodoCollapse this into jetpro.jetsByPt(ptGtr(20*GeV) & rapIn(2.0)) 
