...
title: "Rivet::BABAR_2006_I719581"
summary: "Omega decay asymmetries. "

---

# Rivet::BABAR_2006_I719581
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2006__i719581/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2006__i719581/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2006__i719581/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2006__i719581/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2006__i719581/">BABAR_2006_I719581</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ctheta_xic](http://example.org/classes/classrivet_1_1babar__2006__i719581/#variable--h-ctheta-xic)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ctheta_omegac](http://example.org/classes/classrivet_1_1babar__2006__i719581/#variable--h-ctheta-omegac)**  |
...
### variable _h_ctheta_xic

```cpp
Histo1DPtr _h_ctheta_xic;
```


### variable _h_ctheta_omegac

```cpp
Histo1DPtr _h_ctheta_omegac;
```
