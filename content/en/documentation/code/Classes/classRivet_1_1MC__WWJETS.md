...
title: "Rivet::MC_WWJETS"
summary: "MC validation analysis for W^+[enu]W^-[munu] + jets events. "
...
MC validation analysis for W^+[enu]W^-[munu] + jets events. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__wwjets/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__wwjets/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__wwjets/#function-finalize)**()<br>Finalize.  |
| | **[MC_WWJETS](http://example.org/classes/classrivet_1_1mc__wwjets/#function-mc-wwjets)**()<br>Default constructor.  |
