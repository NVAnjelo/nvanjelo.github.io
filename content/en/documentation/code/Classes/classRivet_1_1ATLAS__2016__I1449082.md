...
|                | Name           |
| -------------- | -------------- |
| enum| **[MeasureType](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#enum-measuretype)** { kInclMeas, kmttMeas, kbetaMeas, kptMeas, kNmeas} |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2016_I1449082](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#function-atlas-2016-i1449082)**()<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const double | **[MW](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-mw)**  |
| const double | **[MTOP](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-mtop)**  |
| const size_t | **[kNbins](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-knbins)**  |
| const double | **[bins](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-bins)**  |
| const string | **[measStr](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-measstr)**  |
| const string | **[rangeStr](http://example.org/classes/classrivet_1_1atlas__2016__i1449082/#variable-rangestr)**  |
...
### function ATLAS_2016_I1449082

```cpp
inline ATLAS_2016_I1449082()
```
...
```cpp
const string measStr = {"incl","mtt","beta","ptt"};
```
