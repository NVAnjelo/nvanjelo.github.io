...
title: "Rivet::BABAR_2021_I1844422"
summary: "e+e- > 2pi+ 2pi- 3pi0 and 2pi+ 2pi- 2pi0 eta "

---

# Rivet::BABAR_2021_I1844422



e+e- > 2pi+ 2pi- 3pi0 and 2pi+ 2pi- 2pi0 eta 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2021__i1844422/">BABAR_2021_I1844422</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_2pip2pim3pi0](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-2pip2pim3pi0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_2pip2pimeta](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-2pip2pimeta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_omegapi0eta](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-omegapi0eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_pippim2pi0omega](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-pippim2pi0omega)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_pippim2pi0eta](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-pippim2pi0eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_2pip2pim2pi0eta](http://example.org/classes/classrivet_1_1babar__2021__i1844422/#variable--c-2pip2pim2pi0eta)**  |
...
### variable _c_2pip2pim3pi0

```cpp
CounterPtr _c_2pip2pim3pi0;
```


### variable _c_2pip2pimeta

```cpp
CounterPtr _c_2pip2pimeta;
```


### variable _c_omegapi0eta

```cpp
CounterPtr _c_omegapi0eta;
```


### variable _c_pippim2pi0omega

```cpp
CounterPtr _c_pippim2pi0omega;
```


### variable _c_pippim2pi0eta

```cpp
CounterPtr _c_pippim2pi0eta;
```


### variable _c_2pip2pim2pi0eta

```cpp
CounterPtr _c_2pip2pim2pi0eta;
```
