...
title: "Rivet::ALICE_2021_I1891391"
summary: "Add a short analysis description here. "

---

# Rivet::ALICE_2021_I1891391
...
|                | Name           |
| -------------- | -------------- |
| void | **[fillbyparticles](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-fillbyparticles)**(<a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> & _histo, <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> tp, <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> ap) |
| void | **[S2DProjectionY](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-s2dprojectiony)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> projection, <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> & hist2D) |
| pair< double, double > | **[BackgEstimate](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-backgestimate)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hist) |
| void | **[ZYAM](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-zyam)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hist_final, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hist) |
| Point2D | **[IntegratePeak](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-integratepeak)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> s, pair< double, double > PeakInterval) |
| void | **[IntegratePeakByPT](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-integratepeakbypt)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> s, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> vs[8], pair< double, double > PeakInterval, int pt_interval) |
| void | **[sdivide](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-sdivide)**(<a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> V0hist, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> hhist, <a href="http://example.org/modules/group__useraos/#using-scatter2dptr">Scatter2DPtr</a> ratio_hist, int pt_interval, bool V0mult) |
| int | **[profileIndex](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-profileindex)**(vector< double > cBins, double c) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-finalize)**()<br>Finalize.  |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1alice__2021__i1891391/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1alice__2021__i1891391/">ALICE_2021_I1891391</a> )<br>Constructor.  |
...
### function fillbyparticles

```cpp
inline void fillbyparticles(
    BinnedHistogram & _histo,
    Particle tp,
    Particle ap
)
```
...
### function S2DProjectionY

```cpp
inline void S2DProjectionY(
    Scatter2DPtr projection,
    BinnedHistogram & hist2D
)
```


### function BackgEstimate

```cpp
inline pair< double, double > BackgEstimate(
    Scatter2DPtr hist
)
```
...
```cpp
inline void ZYAM(
    Scatter2DPtr hist_final,
    Scatter2DPtr hist
)
```


### function IntegratePeak

```cpp
inline Point2D IntegratePeak(
    Scatter2DPtr s,
    pair< double, double > PeakInterval
)
```


### function IntegratePeakByPT

```cpp
inline void IntegratePeakByPT(
    Scatter2DPtr s,
    Scatter2DPtr vs[8],
    pair< double, double > PeakInterval,
    int pt_interval
