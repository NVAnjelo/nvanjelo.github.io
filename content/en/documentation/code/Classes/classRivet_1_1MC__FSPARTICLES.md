...
title: "Rivet::MC_FSPARTICLES"
summary: "Analysis looking at various distributions of final state particles. "

---

# Rivet::MC_FSPARTICLES



<a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a> looking at various distributions of final state particles. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__fsparticles/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__fsparticles/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__fsparticles/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__fsparticles/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__fsparticles/">MC_FSPARTICLES</a> )<br>Constructor.  |
...
TodoChoose E/pT ranged based on input energies... can't do anything about kin. cuts, though 
