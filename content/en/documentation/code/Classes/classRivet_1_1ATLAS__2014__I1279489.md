...
title: "Rivet::ATLAS_2014_I1279489"
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2014__i1279489/">ATLAS_2014_I1279489</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[initialisePlots](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-initialiseplots)**(<a href="http://example.org/classes/structrivet_1_1plots/">Plots</a> & plots, const string & phase_space) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillPlots](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-fillplots)**(const <a href="http://example.org/classes/structrivet_1_1variables/">Variables</a> & vars, <a href="http://example.org/classes/structrivet_1_1plots/">Plots</a> & plots, string phase_space) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| void | **[finalizePlots](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-finalizeplots)**(<a href="http://example.org/classes/structrivet_1_1plots/">Plots</a> & plots) |
| void | **[finalizeEfficiencies](http://example.org/classes/classrivet_1_1atlas__2014__i1279489/#function-finalizeefficiencies)**(<a href="http://example.org/classes/structrivet_1_1plots/">Plots</a> & plots) |
...
```cpp
inline void finalizePlots(
    Plots & plots
)
```


### function finalizeEfficiencies

```cpp
inline void finalizeEfficiencies(
    Plots & plots
)
```
