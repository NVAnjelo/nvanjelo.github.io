...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1199269](http://example.org/classes/classrivet_1_1atlas__2012__i1199269/#function-atlas-2012-i1199269)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1199269/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1199269/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1199269/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::ATLAS_2012_I1199269;
```
...
Inclusive isolated gamma gamma cross-sections, differential in M(gg), pT(gg), dphi(gg), cos(theta*)_CS

## Public Functions Documentation

### function ATLAS_2012_I1199269

```cpp
inline ATLAS_2012_I1199269()
```
