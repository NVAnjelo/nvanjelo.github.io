...
title: "Rivet::PDG_HADRON_MULTIPLICITIES_RATIOS"
summary: "Implementation of PDG hadron multiplicities as ratios to $ avoidpi^avoidpm $ multiplicity. "

---

# Rivet::PDG_HADRON_MULTIPLICITIES_RATIOS



Implementation of PDG hadron multiplicities as ratios to \( \pi^\pm \) multiplicity.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities__ratios/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities__ratios/#function-init)**() |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities__ratios/#function-finalize)**() |
| | **[PDG_HADRON_MULTIPLICITIES_RATIOS](http://example.org/classes/classrivet_1_1pdg__hadron__multiplicities__ratios/#function-pdg-hadron-multiplicities-ratios)**()<br>Constructor.  |
...
```cpp
class Rivet::PDG_HADRON_MULTIPLICITIES_RATIOS;
```
...
### function PDG_HADRON_MULTIPLICITIES_RATIOS

```cpp
inline PDG_HADRON_MULTIPLICITIES_RATIOS()
```
