...
title: "Rivet::BABAR_2009_I815035"
summary: "D D* and D* D* cross section. "

---

# Rivet::BABAR_2009_I815035



D D* and D* D* cross section. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2009__i815035/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1babar__2009__i815035/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2009__i815035/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2009__i815035/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2009__i815035/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2009__i815035/">BABAR_2009_I815035</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_D0_Dstar](http://example.org/classes/classrivet_1_1babar__2009__i815035/#variable--c-d0-dstar)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_Dplus_Dstar](http://example.org/classes/classrivet_1_1babar__2009__i815035/#variable--c-dplus-dstar)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_D_Dstar](http://example.org/classes/classrivet_1_1babar__2009__i815035/#variable--c-d-dstar)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c_Dstar_Dstar](http://example.org/classes/classrivet_1_1babar__2009__i815035/#variable--c-dstar-dstar)**  |
...
### variable _c_D0_Dstar

```cpp
CounterPtr _c_D0_Dstar;
```


### variable _c_Dplus_Dstar

```cpp
CounterPtr _c_Dplus_Dstar;
```
...
```cpp
CounterPtr _c_D_Dstar;
```


### variable _c_Dstar_Dstar

```cpp
CounterPtr _c_Dstar_Dstar;
```
