...
title: "Rivet::D0_2004_S5992206"
summary: "D0 Run II angular correlations in di-jet events. "

---

# Rivet::D0_2004_S5992206



D0 Run II angular correlations in di-jet events.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1d0__2004__s5992206/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1d0__2004__s5992206/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1d0__2004__s5992206/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1d0__2004__s5992206/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1d0__2004__s5992206/">D0_2004_S5992206</a> ) |
...
```cpp
class Rivet::D0_2004_S5992206;
```

D0 Run II angular correlations in di-jet events. 
...
* Several \( p_\perp^\text{min} \) cutoffs are probably required to fill the histograms: 
* \( p_\perp^\text{min} = \) 50, 75, 100, 150 GeV for the four pT ranges respecively 
