...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__2008__s7869363/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__2008__s7869363/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__2008__s7869363/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1star__2008__s7869363/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1star__2008__s7869363/">STAR_2008_S7869363</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dNch](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dnch)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_Pi](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-pi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_Piplus](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-piplus)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_Kaon](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-kaon)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_Kaonplus](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-kaonplus)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_AntiProton](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-antiproton)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_dpT_Proton](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-dpt-proton)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_h_pT_vs_Nch](http://example.org/classes/classrivet_1_1star__2008__s7869363/#variable--h-pt-vs-nch)**  |
...
```cpp
Histo1DPtr _h_dpT_Pi;
```


### variable _h_dpT_Piplus

```cpp
Histo1DPtr _h_dpT_Piplus;
```


### variable _h_dpT_Kaon

```cpp
Histo1DPtr _h_dpT_Kaon;
```


### variable _h_dpT_Kaonplus

```cpp
Histo1DPtr _h_dpT_Kaonplus;
```


### variable _h_dpT_AntiProton

```cpp
Histo1DPtr _h_dpT_AntiProton;
```


### variable _h_dpT_Proton

```cpp
Histo1DPtr _h_dpT_Proton;
```


### variable _h_pT_vs_Nch
