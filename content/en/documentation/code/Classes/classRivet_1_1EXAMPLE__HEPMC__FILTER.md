...
title: "Rivet::EXAMPLE_HEPMC_FILTER"
summary: "Just measures a few observables as a demo and writes to a file all the events with thrust < 0.1. "

---

# Rivet::EXAMPLE_HEPMC_FILTER



Just measures a few observables as a demo and writes to a file all the events with thrust < 0.1. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1example__hepmc__filter/#function-init)**()<br>Set up projections and book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1example__hepmc__filter/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1example__hepmc__filter/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1example__hepmc__filter/">EXAMPLE_HEPMC_FILTER</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| std::shared_ptr< RivetHepMC::IO_GenEvent > | **[_writer](http://example.org/classes/classrivet_1_1example__hepmc__filter/#variable--writer)**  |
