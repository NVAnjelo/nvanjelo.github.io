...
title: "Rivet::BABAR_2006_I716277"
summary: "Add a short analysis description here. "

---

# Rivet::BABAR_2006_I716277
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2006__i716277/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1babar__2006__i716277/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2006__i716277/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2006__i716277/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2006__i716277/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2006__i716277/">BABAR_2006_I716277</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_numEtaGamma](http://example.org/classes/classrivet_1_1babar__2006__i716277/#variable--numetagamma)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_numEtaPrimeGamma](http://example.org/classes/classrivet_1_1babar__2006__i716277/#variable--numetaprimegamma)**  |
...
### variable _numEtaPrimeGamma

```cpp
CounterPtr _numEtaPrimeGamma;
```
