...
title: "Rivet::CMS_2018_I1667854"
summary: "Differential cross section of Z boson production in association with jets at 13 TeV. "

---

# Rivet::CMS_2018_I1667854



Differential cross section of Z boson production in association with jets at 13 TeV.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2018__i1667854/">CMS_2018_I1667854</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| std::unique_ptr< <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> > | **[zfinder](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#function-zfinder)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & leptons)<br>Z boson finder.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#function-finalize)**()<br>Normalise histograms etc., after the run.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1cms__2018__i1667854/#variable--mode)**  |
...
```cpp
class Rivet::CMS_2018_I1667854;
```

Differential cross section of Z boson production in association with jets at 13 TeV. 
...
```cpp
inline std::unique_ptr< Particle > zfinder(
...
**Parameters**: 
  ...
  * **leptons** pt-ordered list of electrons or muons from which to build the Z boson 


**Note**: We don't use the standard <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> class in order to stick to the definition of the publication that is simpler than the <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> algorithm.
...
TodoCould be better computed by toIntegral transform on exclusive histo 
