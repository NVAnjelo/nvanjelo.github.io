...
title: "Rivet::OPAL_2000_I502750"
summary: "rho+/- and omega polarization "

---

# Rivet::OPAL_2000_I502750



rho+/- and omega polarization 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| pair< double, double > | **[calcRho](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-calcrho)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| bool | **[findOmegaDecay](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-findomegadecay)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> omega, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pip, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pim) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1opal__2000__i502750/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1opal__2000__i502750/">OPAL_2000_I502750</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_ctheta_rho](http://example.org/classes/classrivet_1_1opal__2000__i502750/#variable--h-ctheta-rho)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_ctheta_omega](http://example.org/classes/classrivet_1_1opal__2000__i502750/#variable--h-ctheta-omega)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ctheta_omega_all](http://example.org/classes/classrivet_1_1opal__2000__i502750/#variable--h-ctheta-omega-all)**  |
...
### function findOmegaDecay

```cpp
inline bool findOmegaDecay(
    Particle omega,
    Particles & pi0,
    Particles & pip,
    Particles & pim
...
### variable _h_ctheta_rho

```cpp
BinnedHistogram _h_ctheta_rho;
```


### variable _h_ctheta_omega

```cpp
BinnedHistogram _h_ctheta_omega;
```


### variable _h_ctheta_omega_all
