...
title: "Rivet::MC_TAUS"
summary: "MC validation analysis for taus. "
...
MC validation analysis for taus. 
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_TAUS](http://example.org/classes/classrivet_1_1mc__taus/#function-mc-taus)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__taus/#function-init)**()<br>Book projections and histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__taus/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__taus/#function-finalize)**()<br>Normalisations etc.  |
