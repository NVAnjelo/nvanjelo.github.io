...
|                | Name           |
| -------------- | -------------- |
| | **[Cut_Gtr](http://example.org/classes/classrivet_1_1cut__gtr/#function-cut-gtr)**(const <a href="http://example.org/namespaces/namespacerivet_1_1cuts/#enum-quantity">Cuts::Quantity</a> qty, const double val) |
| virtual bool | **[operator==](http://example.org/classes/classrivet_1_1cut__gtr/#function-operator==)**(const Cut & ) const<br>Comparison to another Cut.  |
| virtual std::string | **[toString](http://example.org/classes/classrivet_1_1cut__gtr/#function-tostring)**() const<br>String representation.  |

## Protected Functions

|                | Name           |
| -------------- | -------------- |
| virtual bool | **[_accept](http://example.org/classes/classrivet_1_1cut__gtr/#function--accept)**(const <a href="http://example.org/classes/classrivet_1_1cuttablebase/">CuttableBase</a> & o) const |
