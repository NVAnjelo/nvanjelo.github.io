...
title: "Rivet::ATLAS_2017_I1632756"
summary: "Measurement of prompt isolated photon + b/c-jet + X differential cross-sections. "

---

# Rivet::ATLAS_2017_I1632756



Measurement of prompt isolated photon + b/c-jet + X differential cross-sections. 
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2017__i1632756/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2017__i1632756/">ATLAS_2017_I1632756</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2017__i1632756/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| size_t | **[_getEtaBin](http://example.org/classes/classrivet_1_1atlas__2017__i1632756/#function--getetabin)**(double eta_w, bool area_eta) const<br>Return eta bin for either dsigma/dET histogram (area_eta=false) or energy density correction (area_eta=true)  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2017__i1632756/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2017__i1632756/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
