...
title: "Rivet::ATLAS_2014_I1327229"
summary: "Inclusive multilepton search at 8 TeV. "

---

# Rivet::ATLAS_2014_I1327229
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2014_I1327229](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-atlas-2014-i1327229)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| vector< string > | **[getSignalRegions](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-getsignalregions)**()<br>Helper functions.  |
| vector< int > | **[getCutsPerSignalRegion](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-getcutspersignalregion)**(const string & signal_region, int onZ =0)<br>Function giving all cut values per kinematic variable.  |
| void | **[fillEventCountsPerSR](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-filleventcountspersr)**(const string & basic_signal_region, int onZ, double HTlep, double eTmiss, double HTjets, double meff, double min_pT, double mTW) |
| <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> | **[get_tau_neutrino_momentum](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-get-tau-neutrino-momentum)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p)<br>Function returning 4-momentum of daughter-particle if it is a tau neutrino.  |
| void | **[get_prong_number](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-get-prong-number)**(<a href="http://example.org/namespaces/namespacerivet/#typedef-constgenparticleptr">ConstGenParticlePtr</a> p, unsigned int & nprong, bool & lep_decaying_tau)<br>Function calculating the prong number of taus.  |
| double | **[apply_reco_eff](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-apply-reco-eff)**(int flavor, const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p)<br>Function giving fiducial lepton efficiency.  |
| double | **[getUpperLimit](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-getupperlimit)**(const string & signal_region, bool observed)<br>Function giving observed and expected upper limits (on the visible cross-section)  |
| int | **[isonZ](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-isonz)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & particles)<br>Function checking if there is an OSSF lepton pair or a combination of 3 leptons with an invariant mass close to the Z mass.  |
| double | **[isOSSF_mass](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-isossf-mass)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p1, const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p2)<br>function checking if two leptons are an OSSF lepton pair and giving out the invariant mass (0 if no OSSF pair)  |
| bool | **[isOSSF](http://example.org/classes/classrivet_1_1atlas__2014__i1327229/#function-isossf)**(const <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & particles)<br>Function checking if there is an OSSF lepton pair.  |
...
### function ATLAS_2014_I1327229

```cpp
inline ATLAS_2014_I1327229()
```
...
TodoReplace with <a href="http://example.org/classes/classrivet_1_1smearedparticles/">SmearedParticles</a> etc. 
...
### function getSignalRegions

```cpp
inline vector< string > getSignalRegions()
```
...
### function getCutsPerSignalRegion

```cpp
inline vector< int > getCutsPerSignalRegion(
    const string & signal_region,
    int onZ =0
)
```
...
### function fillEventCountsPerSR

```cpp
inline void fillEventCountsPerSR(
    const string & basic_signal_region,
    int onZ,
    double HTlep,
    double eTmiss,
    double HTjets,
...
function fills map _eventCountsPerSR by looping over all signal regions and looking if the event falls into this signal region 


### function get_tau_neutrino_momentum

```cpp
inline FourMomentum get_tau_neutrino_momentum(
    const Particle & p
)
```
...
### function get_prong_number

```cpp
inline void get_prong_number(
...
### function apply_reco_eff

```cpp
inline double apply_reco_eff(
    int flavor,
    const Particle & p
)
```
...
### function isOSSF_mass

```cpp
inline double isOSSF_mass(
    const Particle & p1,
    const Particle & p2
)
```
