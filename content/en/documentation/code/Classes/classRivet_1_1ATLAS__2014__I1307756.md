...
title: "Rivet::ATLAS_2014_I1307756"

---

# Rivet::ATLAS_2014_I1307756
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1307756/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| int | **[getEtaBin](http://example.org/classes/classrivet_1_1atlas__2014__i1307756/#function-getetabin)**(double eta) const |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1307756/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1307756/#function-finalize)**() |
| | **[ATLAS_2014_I1307756](http://example.org/classes/classrivet_1_1atlas__2014__i1307756/#function-atlas-2014-i1307756)**()<br>Constructor.  |
...
### function ATLAS_2014_I1307756

```cpp
inline ATLAS_2014_I1307756()
```
