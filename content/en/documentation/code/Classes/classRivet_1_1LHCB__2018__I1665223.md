...
title: "Rivet::LHCB_2018_I1665223"
summary: "Inelastic xsection in pp collisions at 13 TeV for charged particles in LHCb acceptance. "

---

# Rivet::LHCB_2018_I1665223



Inelastic xsection in pp collisions at 13 TeV for charged particles in LHCb acceptance. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| bool | **[isLongLivedParticle](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-islonglivedparticle)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) |
| bool | **[hasLongLivedParent](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-haslonglivedparent)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p) |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/">LHCB_2018_I1665223</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_ppInel](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#variable--h-ppinel)**  |
| const double | **[ETAMIN](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#variable-etamin)** <br>Cut constants.  |
| const double | **[ETAMAX](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#variable-etamax)**  |
| const double | **[PMIN](http://example.org/classes/classrivet_1_1lhcb__2018__i1665223/#variable-pmin)**  |
...
### function isLongLivedParticle

```cpp
inline bool isLongLivedParticle(
    const Particle & p
)
```


### function hasLongLivedParent

```cpp
inline bool hasLongLivedParent(
    const Particle & p
)
```
