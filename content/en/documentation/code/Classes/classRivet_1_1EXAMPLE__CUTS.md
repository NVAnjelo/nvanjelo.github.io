...
title: "Rivet::EXAMPLE_CUTS"
summary: "Just measures a few random things as an example. "
...
Just measures a few random things as an example. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1example__cuts/#function-init)**()<br>Set up projections and book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1example__cuts/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1example__cuts/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1example__cuts/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1example__cuts/">EXAMPLE_CUTS</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histPt](http://example.org/classes/classrivet_1_1example__cuts/#variable--histpt)** <br>Histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_histMass](http://example.org/classes/classrivet_1_1example__cuts/#variable--histmass)**  |
