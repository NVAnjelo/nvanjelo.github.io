...
title: "Rivet::ATLAS_2011_I944826"

---

# Rivet::ATLAS_2011_I944826
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2011_I944826](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-atlas-2011-i944826)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[getPerpFlightDistance](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-getperpflightdistance)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Rivet::Particle</a> & p) |
| bool | **[daughtersSurviveCuts](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-daughterssurvivecuts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Rivet::Particle</a> & p) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i944826/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2011_I944826

```cpp
inline ATLAS_2011_I944826()
```
...
### function getPerpFlightDistance

```cpp
inline double getPerpFlightDistance(
    const Rivet::Particle & p
)
```


### function daughtersSurviveCuts

```cpp
inline bool daughtersSurviveCuts(
    const Rivet::Particle & p
)
```
...
TodoReplace with <a href="http://example.org/modules/group__analysis__manip/#function-normalize">normalize()</a>? 
