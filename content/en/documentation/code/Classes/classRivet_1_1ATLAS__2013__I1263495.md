...
title: "Rivet::ATLAS_2013_I1263495"
summary: "Inclusive isolated prompt photon analysis with 2011 LHC data. "

---

# Rivet::ATLAS_2013_I1263495
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2013_I1263495](http://example.org/classes/classrivet_1_1atlas__2013__i1263495/#function-atlas-2013-i1263495)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2013__i1263495/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| size_t | **[_getEtaBin](http://example.org/classes/classrivet_1_1atlas__2013__i1263495/#function--getetabin)**(double eta_w, bool area_eta) const<br>Return eta bin for either dsigma/dET histogram (area_eta=false) or energy density correction (area_eta=true)  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2013__i1263495/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2013__i1263495/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2013_I1263495

```cpp
inline ATLAS_2013_I1263495()
```
