...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2016__i1479760/">ATLAS_2016_I1479760</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[calcDeltaPt](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-calcdeltapt)**(const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j1, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j2)<br>Calculate the DeltaPt variable.  |
| double | **[calcDeltaPhiPlanes](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-calcdeltaphiplanes)**(const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j1, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j2, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j3, const <a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & j4)<br>Calculate the DeltaPhi variable between event planes.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#function-finalize)**()<br>Post-run processing.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| map< string, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_hists](http://example.org/classes/classrivet_1_1atlas__2016__i1479760/#variable--hists)** <br>Histograms.  |
...
### function calcDeltaPt

```cpp
inline double calcDeltaPt(
    const Jet & j1,
    const Jet & j2
)
```
...
### function calcDeltaPhiPlanes

```cpp
inline double calcDeltaPhiPlanes(
    const Jet & j1,
    const Jet & j2,
    const Jet & j3,
    const Jet & j4
