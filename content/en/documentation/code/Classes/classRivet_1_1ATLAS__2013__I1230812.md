...
title: "Rivet::ATLAS_2013_I1230812"

---

# Rivet::ATLAS_2013_I1230812
...
|                | Name           |
| -------------- | -------------- |
| double | **[err_incl](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-err-incl)**(const HistoBin1D & M, const HistoBin1D & N, bool hasWeights)<br>Calculate the efficiency error, being careful about div-by-zero.  |
| double | **[err_excl](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-err-excl)**(const HistoBin1D & A, const HistoBin1D & B)<br>Calculate the ratio error, being careful about div-by-zero.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-finalize)**() |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1atlas__2013__i1230812/">ATLAS_2013_I1230812</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1atlas__2013__i1230812/#variable--mode)**  |
...
```cpp
class Rivet::ATLAS_2013_I1230812;
```
...
TodoNote that Zs are accepted with any rapidity: the cuts are on the e/mu: is this correct? 
