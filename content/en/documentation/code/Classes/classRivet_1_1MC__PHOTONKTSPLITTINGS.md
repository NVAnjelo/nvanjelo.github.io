...
title: "Rivet::MC_PHOTONKTSPLITTINGS"
summary: "MC validation analysis for photon + jets events. "

---

# Rivet::MC_PHOTONKTSPLITTINGS
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__photonktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__photonktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__photonktsplittings/#function-finalize)**() |
| | **[MC_PHOTONKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__photonktsplittings/#function-mc-photonktsplittings)**()<br>Default constructor.  |
...
### function MC_PHOTONKTSPLITTINGS

```cpp
inline MC_PHOTONKTSPLITTINGS()
```
