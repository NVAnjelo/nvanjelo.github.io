...
title: "Rivet::CMS_2012_I1298807"
summary: "Inclusive ZZ production cross section and constraints on anomalous triple gauge couplings. "

---

# Rivet::CMS_2012_I1298807
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2012__i1298807/">CMS_2012_I1298807</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#function-init)**()<br>Initialise projections and histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#function-finalize)**() |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_pt_zz](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-pt-zz)** <br>Histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_m_zz](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-m-zz)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_dphi_zz](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-dphi-zz)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_dR_zz](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-dr-zz)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_pt_z1](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-pt-z1)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_pt_l1](http://example.org/classes/classrivet_1_1cms__2012__i1298807/#variable--hist-pt-l1)**  |
...
TodoLooks like there should be a nicer way than this 
...
**Note**: This is all needed to undo bin width factor &ndash; WHY DO PEOPLE USE UNPHYSICAL HISTOGRAMS?!? 
...
### variable _hist_pt_zz

```cpp
Histo1DPtr _hist_pt_zz;
```
...
```cpp
Histo1DPtr _hist_m_zz;
```


### variable _hist_dphi_zz

```cpp
Histo1DPtr _hist_dphi_zz;
```


### variable _hist_dR_zz

```cpp
Histo1DPtr _hist_dR_zz;
```


### variable _hist_pt_z1

```cpp
Histo1DPtr _hist_pt_z1;
```


### variable _hist_pt_l1

```cpp
Histo1DPtr _hist_pt_l1;
```
