...
title: "Rivet::ALICE_2015_PPBCentrality"
summary: "Generic analysis looking at various distributions of final state particles. "

---

# Rivet::ALICE_2015_PPBCentrality
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1alice__2015__ppbcentrality/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1alice__2015__ppbcentrality/">ALICE_2015_PPBCentrality</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1alice__2015__ppbcentrality/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1alice__2015__ppbcentrality/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1alice__2015__ppbcentrality/#function-finalize)**()<br>Finalize.  |
