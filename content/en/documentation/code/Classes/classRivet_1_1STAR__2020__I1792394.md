...
title: "Rivet::STAR_2020_I1792394"
summary: "CEP of h+h- (h=pi,K,p) at sqrt(s)=200 GeV with forward proton tagging. "

---

# Rivet::STAR_2020_I1792394



CEP of h+h- (h=pi,K,p) at sqrt(s)=200 GeV with forward proton tagging. 
...
|                | Name           |
| -------------- | -------------- |
| enum| **[CENTRAL_PARTICLES_PID](http://example.org/classes/classrivet_1_1star__2020__i1792394/#enum-central-particles-pid)** { _PION, _KAON, _PROTON, _nAllowedPids} |
| enum| **[PARTICLE_CHARGE](http://example.org/classes/classrivet_1_1star__2020__i1792394/#enum-particle-charge)** { _PLUS, _MINUS, _nSigns} |
| enum| **[PARTICLE_DIRECTION](http://example.org/classes/classrivet_1_1star__2020__i1792394/#enum-particle-direction)** { _E, _W, _nBeamDirections} |

## Public Functions

|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__2020__i1792394/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__2020__i1792394/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__2020__i1792394/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1star__2020__i1792394/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1star__2020__i1792394/">STAR_2020_I1792394</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const double | **[minPt](http://example.org/classes/classrivet_1_1star__2020__i1792394/#variable-minpt)**  |
| const double | **[maxMinPt](http://example.org/classes/classrivet_1_1star__2020__i1792394/#variable-maxminpt)**  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_h](http://example.org/classes/classrivet_1_1star__2020__i1792394/#variable--h)**  |
| map< string, double > | **[_scaleFactor](http://example.org/classes/classrivet_1_1star__2020__i1792394/#variable--scalefactor)**  |
...
```cpp
const double minPt = { 0.2*GeV, 0.3*GeV, 0.4*GeV };
```
...
```cpp
const double maxMinPt = { 9e9*GeV, 0.7*GeV, 1.1*GeV };
```
...
### variable _scaleFactor

```cpp
map< string, double > _scaleFactor;
```
