...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2011_I921594](http://example.org/classes/classrivet_1_1atlas__2011__i921594/#function-atlas-2011-i921594)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i921594/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| size_t | **[_getEtaBin](http://example.org/classes/classrivet_1_1atlas__2011__i921594/#function--getetabin)**(double eta, bool area_eta) const<br>Return eta bin for either dsigma/dET histogram (area_eta=false) or energy density correction (area_eta=true)  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i921594/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i921594/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2011_I921594

```cpp
inline ATLAS_2011_I921594()
```
