...
title: "Rivet::CLEOC_2011_I875526"
summary: "D -> eta semi-leptonic q^2. "

---

# Rivet::CLEOC_2011_I875526



D -> eta semi-leptonic q^2. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[q2](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-q2)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & B, int mesonID) |
| bool | **[isSemileptonicDecay](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-issemileptonicdecay)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, vector< int > ids) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoc__2011__i875526/">CLEOC_2011_I875526</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_Dp_eta_A](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#variable--h-q2-dp-eta-a)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_q2_Dp_eta_B](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#variable--h-q2-dp-eta-b)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_nD0](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#variable--nd0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_nDp](http://example.org/classes/classrivet_1_1cleoc__2011__i875526/#variable--ndp)**  |
...
### variable _h_q2_Dp_eta_A

```cpp
Histo1DPtr _h_q2_Dp_eta_A;
```


### variable _h_q2_Dp_eta_B

```cpp
Histo1DPtr _h_q2_Dp_eta_B;
```
