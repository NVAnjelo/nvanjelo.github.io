...
title: "Rivet::ATLAS_2016_I1419070"

---

# Rivet::ATLAS_2016_I1419070
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2016_I1419070](http://example.org/classes/classrivet_1_1atlas__2016__i1419070/#function-atlas-2016-i1419070)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2016__i1419070/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2016__i1419070/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| double | **[CalculateNCharge](http://example.org/classes/classrivet_1_1atlas__2016__i1419070/#function-calculatencharge)**(<a href="http://example.org/classes/classrivet_1_1jet/">Jet</a> & jet, double pTcut =0.5) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2016__i1419070/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
### function ATLAS_2016_I1419070

```cpp
inline ATLAS_2016_I1419070()
```
...
### function CalculateNCharge

```cpp
inline double CalculateNCharge(
    Jet & jet,
    double pTcut =0.5
)
```
