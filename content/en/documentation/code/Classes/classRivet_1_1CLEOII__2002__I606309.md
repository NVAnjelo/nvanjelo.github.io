...
title: "Rivet::CLEOII_2002_I606309"
summary: "J/Psi and Psi(2S) spectra at the Upsilon(4S) "

---

# Rivet::CLEOII_2002_I606309



J/Psi and Psi(2S) spectra at the Upsilon(4S) 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> parent, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & charm) |
| void | **[findLeptons](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-findleptons)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lp, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lm) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, pair< double, double > > | **[calcAlpha](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__2002__i606309/">CLEOII_2002_I606309</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weightSum](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--weightsum)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Jpsi](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--h-jpsi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_Psi_prime](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--h-psi-prime)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cTheta_Jpsi](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--h-ctheta-jpsi)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cTheta_Psi_prime](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--h-ctheta-psi-prime)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h2_cTheta_Jpsi](http://example.org/classes/classrivet_1_1cleoii__2002__i606309/#variable--h2-ctheta-jpsi)**  |
...
### variable _h_Psi_prime

```cpp
Histo1DPtr _h_Psi_prime;
```


### variable _h_cTheta_Jpsi

```cpp
Histo1DPtr _h_cTheta_Jpsi;
```


### variable _h_cTheta_Psi_prime

```cpp
Histo1DPtr _h_cTheta_Psi_prime;
```


### variable _h2_cTheta_Jpsi
