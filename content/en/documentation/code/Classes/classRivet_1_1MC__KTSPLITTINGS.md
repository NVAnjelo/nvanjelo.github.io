...
title: "Rivet::MC_KTSPLITTINGS"
summary: "MC validation analysis for jet events. "

---

# Rivet::MC_KTSPLITTINGS
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_KTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__ktsplittings/#function-mc-ktsplittings)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__ktsplittings/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__ktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__ktsplittings/#function-finalize)**() |
...
### function MC_KTSPLITTINGS

```cpp
inline MC_KTSPLITTINGS()
```
