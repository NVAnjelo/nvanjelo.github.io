...
title: "Rivet::CMS_2015_I1385107"
summary: "CMS UE charged particles vs. leading jet at 2.76 TeV. "

---

# Rivet::CMS_2015_I1385107
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2015_I1385107](http://example.org/classes/classrivet_1_1cms__2015__i1385107/#function-cms-2015-i1385107)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2015__i1385107/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| double | **[signedDeltaPhi](http://example.org/classes/classrivet_1_1cms__2015__i1385107/#function-signeddeltaphi)**(double jetphi, double partphi)<br>Local definition of a signed dphi, for use in differentating L and R trans regions.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2015__i1385107/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
...
### function CMS_2015_I1385107

```cpp
inline CMS_2015_I1385107()
```
