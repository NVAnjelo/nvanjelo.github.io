...
title: "Rivet::CMS_2014_I1266056"
summary: "Measurement of gamma + jets + X triple differential cross-sections. "

---

# Rivet::CMS_2014_I1266056



Measurement of gamma + jets + X triple differential cross-sections.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2014_I1266056](http://example.org/classes/classrivet_1_1cms__2014__i1266056/#function-cms-2014-i1266056)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2014__i1266056/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2014__i1266056/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2014__i1266056/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::CMS_2014_I1266056;
```

Measurement of gamma + jets + X triple differential cross-sections. 

**Author**: David Grellscheid 
## Public Functions Documentation

### function CMS_2014_I1266056

```cpp
inline CMS_2014_I1266056()
```
