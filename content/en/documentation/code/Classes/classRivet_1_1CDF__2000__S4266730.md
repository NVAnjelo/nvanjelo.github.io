...
title: "Rivet::CDF_2000_S4266730"
summary: "CDF dijet cross-section, differential in dijet mass. "

---

# Rivet::CDF_2000_S4266730



CDF dijet cross-section, differential in dijet mass. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cdf__2000__s4266730/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cdf__2000__s4266730/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cdf__2000__s4266730/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cdf__2000__s4266730/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cdf__2000__s4266730/">CDF_2000_S4266730</a> ) |
