...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2013__i1261026/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2013__i1261026/">CMS_2013_I1261026</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2013__i1261026/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2013__i1261026/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2013__i1261026/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| void | **[eventDecomp](http://example.org/classes/classrivet_1_1cms__2013__i1261026/#function-eventdecomp)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event, int mult, size_t ibin) |
...
### function eventDecomp

```cpp
inline void eventDecomp(
    const Event & event,
    int mult,
    size_t ibin
)
