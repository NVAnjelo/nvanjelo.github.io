...
title: "Rivet::DELPHI_2001_I526164"
summary: "DELPHI W decay analysis. "

---

# Rivet::DELPHI_2001_I526164



DELPHI W decay analysis. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1delphi__2001__i526164/">DELPHI_2001_I526164</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_qq_K0](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-qq-k0)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_qq_Lam](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-qq-lam)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_qq](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--n-qq)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_p_charged](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-p-charged)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_charged](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-xi-charged)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pT_charged](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-pt-charged)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_ident](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-xi-ident)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_p_chargedB](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-p-chargedb)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_chargedB](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-xi-chargedb)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_pT_chargedB](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--h-pt-chargedb)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_WW](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--n-ww)**  |
| bool | **[_WW](http://example.org/classes/classrivet_1_1delphi__2001__i526164/#variable--ww)**  |
...
### variable _h_p_charged

```cpp
Histo1DPtr _h_p_charged;
```


### variable _h_xi_charged

```cpp
Histo1DPtr _h_xi_charged;
```


### variable _h_pT_charged

```cpp
Histo1DPtr _h_pT_charged;
```


### variable _h_xi_ident

```cpp
Histo1DPtr _h_xi_ident;
```


### variable _h_p_chargedB

```cpp
Histo1DPtr _h_p_chargedB;
```


### variable _h_xi_chargedB

```cpp
Histo1DPtr _h_xi_chargedB;
```


### variable _h_pT_chargedB

```cpp
Histo1DPtr _h_pT_chargedB;
```
