...
title: "Rivet::BABAR_2010_I867611"
summary: "D_1 and D_2 decay distributions. "

---

# Rivet::BABAR_2010_I867611



D_1 and D_2 decay distributions. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2010__i867611/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1babar__2010__i867611/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & dstar, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & d0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi, unsigned int & ncount)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2010__i867611/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2010__i867611/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2010__i867611/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2010__i867611/">BABAR_2010_I867611</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D1_ctheta](http://example.org/classes/classrivet_1_1babar__2010__i867611/#variable--h-d1-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2_ctheta](http://example.org/classes/classrivet_1_1babar__2010__i867611/#variable--h-d2-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D02S_ctheta](http://example.org/classes/classrivet_1_1babar__2010__i867611/#variable--h-d02s-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_DStar02S_ctheta](http://example.org/classes/classrivet_1_1babar__2010__i867611/#variable--h-dstar02s-ctheta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D3_ctheta](http://example.org/classes/classrivet_1_1babar__2010__i867611/#variable--h-d3-ctheta)**  |
...
### variable _h_D02S_ctheta

```cpp
Histo1DPtr _h_D02S_ctheta;
```


### variable _h_DStar02S_ctheta

```cpp
Histo1DPtr _h_DStar02S_ctheta;
```
