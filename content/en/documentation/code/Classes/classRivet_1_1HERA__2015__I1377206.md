...
title: "Rivet::HERA_2015_I1377206"
summary: "Measurement of sigma_red (F2) of H1 and ZEUS at different beam energies. "

---

# Rivet::HERA_2015_I1377206
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1hera__2015__i1377206/">HERA_2015_I1377206</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_sigred](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--h-sigred)**  |
| <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> | **[_h_sigred_cc](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--h-sigred-cc)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2_10](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--hist-q2-10)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2_100](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--hist-q2-100)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2_1000](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--hist-q2-1000)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2_2000](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--hist-q2-2000)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_hist_Q2_3000](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable--hist-q2-3000)**  |
| bool | **[positron](http://example.org/classes/classrivet_1_1hera__2015__i1377206/#variable-positron)**  |
...
TodoDo the event by event analysis here 
...
```cpp
BinnedHistogram _h_sigred;
```


### variable _h_sigred_cc

```cpp
BinnedHistogram _h_sigred_cc;
```


### variable _hist_Q2_10

```cpp
Histo1DPtr _hist_Q2_10;
```


### variable _hist_Q2_100

```cpp
Histo1DPtr _hist_Q2_100;
```


### variable _hist_Q2_1000

```cpp
Histo1DPtr _hist_Q2_1000;
```


### variable _hist_Q2_2000

```cpp
Histo1DPtr _hist_Q2_2000;
```


### variable _hist_Q2_3000

```cpp
Histo1DPtr _hist_Q2_3000;
```
