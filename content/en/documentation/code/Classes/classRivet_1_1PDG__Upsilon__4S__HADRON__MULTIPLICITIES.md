...
title: "Rivet::PDG_Upsilon_4S_HADRON_MULTIPLICITIES"
summary: "Add a short analysis description here. "

---

# Rivet::PDG_Upsilon_4S_HADRON_MULTIPLICITIES
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, map< int, unsigned int > & ncount) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/">PDG_Upsilon_4S_HADRON_MULTIPLICITIES</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< int > | **[_ihistos](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#variable--ihistos)**  |
| map< int, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_histos](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#variable--histos)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_wSum](http://example.org/classes/classrivet_1_1pdg__upsilon__4s__hadron__multiplicities/#variable--wsum)**  |
