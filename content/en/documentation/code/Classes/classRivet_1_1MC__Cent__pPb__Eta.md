...
title: "Rivet::MC_Cent_pPb_Eta"

---

# Rivet::MC_Cent_pPb_Eta
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__cent__ppb__eta/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__cent__ppb__eta/">MC_Cent_pPb_Eta</a> ) |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__cent__ppb__eta/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__cent__ppb__eta/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__cent__ppb__eta/#function-finalize)**()<br>Finalize.  |
