...
title: "Rivet::CMS_2012_PAS_FSQ_12_020"
summary: "CMS underlying event in leading track events at 7 TeV. "

---

# Rivet::CMS_2012_PAS_FSQ_12_020



CMS underlying event in leading track events at 7 TeV.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/">CMS_2012_PAS_FSQ_12_020</a> )<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| constexpr double | **[AREA](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable-area)** <br>eta-phi area of the transverse region  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_NchgPden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--nchgpden1)** <br>Histograms.  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_NchgPMXden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--nchgpmxden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_NchgPMNden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--nchgpmnden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_NchgPDFden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--nchgpdfden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_PTsumPden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--ptsumpden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_PTsumPMXden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--ptsumpmxden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_PTsumPMNden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--ptsumpmnden1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_PTsumPDFden1](http://example.org/classes/classrivet_1_1cms__2012__pas__fsq__12__020/#variable--ptsumpdfden1)**  |
...
```cpp
class Rivet::CMS_2012_PAS_FSQ_12_020;
```

CMS underlying event in leading track events at 7 TeV. 
...
```cpp
static constexpr double AREA = 2*0.8 * M_PI/3;
```
...
```cpp
Profile1DPtr _NchgPden1;
```

Histograms. 

### variable _NchgPMXden1

```cpp
Profile1DPtr _NchgPMXden1;
```


### variable _NchgPMNden1

```cpp
Profile1DPtr _NchgPMNden1;
```


### variable _NchgPDFden1

```cpp
Profile1DPtr _NchgPDFden1;
```


### variable _PTsumPden1

```cpp
Profile1DPtr _PTsumPden1;
```


### variable _PTsumPMXden1

```cpp
Profile1DPtr _PTsumPMXden1;
```


### variable _PTsumPMNden1

```cpp
Profile1DPtr _PTsumPMNden1;
```


### variable _PTsumPDFden1

```cpp
Profile1DPtr _PTsumPDFden1;
```


-------------------------------

Updated on 2022-07-27 at 19:09:54 +0100