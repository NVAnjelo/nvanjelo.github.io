...
title: "Rivet::CMS_2016_I1471281"
summary: "Measurement of the W and Z bosons pT produced in pp collisions at sqrt(s)=8 TeV. "

---

# Rivet::CMS_2016_I1471281
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2016__i1471281/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2016__i1471281/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2016__i1471281/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[CMS_2016_I1471281](http://example.org/classes/classrivet_1_1cms__2016__i1471281/#function-cms-2016-i1471281)**(std::string name ="CMS_2016_I1471281")<br>Constructor.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1cms__2016__i1471281/#variable--mode)**  |
...
### function CMS_2016_I1471281

```cpp
inline CMS_2016_I1471281(
    std::string name ="CMS_2016_I1471281"
)
```
