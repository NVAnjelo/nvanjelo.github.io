...
title: "Rivet::MC_QCD_PARTONS"
summary: "Generic analysis looking at kt splitting scales of partons. "

---

# Rivet::MC_QCD_PARTONS
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__qcd__partons/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__qcd__partons/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__qcd__partons/#function-finalize)**()<br>Finalize.  |
| | **[MC_QCD_PARTONS](http://example.org/classes/classrivet_1_1mc__qcd__partons/#function-mc-qcd-partons)**()<br>Constructor.  |
...
### function MC_QCD_PARTONS

```cpp
inline MC_QCD_PARTONS()
```
