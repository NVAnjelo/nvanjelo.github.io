...
title: "Rivet::ATLAS_2012_I1093738"
summary: "Measurement of isolated gamma + jet + X differential cross-sections. "

---

# Rivet::ATLAS_2012_I1093738



Measurement of isolated gamma + jet + X differential cross-sections.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| | **[ATLAS_2012_I1093738](http://example.org/classes/classrivet_1_1atlas__2012__i1093738/#function-atlas-2012-i1093738)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1093738/#function-init)**() |
| int | **[getEtaBin](http://example.org/classes/classrivet_1_1atlas__2012__i1093738/#function-getetabin)**(double eta, int what) const |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1093738/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1093738/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
...
```cpp
class Rivet::ATLAS_2012_I1093738;
```

Measurement of isolated gamma + jet + X differential cross-sections. 

**Author**: Giovanni Marchiori 

Inclusive isolated gamma + jet cross-sections, differential in pT(gamma), for various photon and jet rapidity configurations.

## Public Functions Documentation

### function ATLAS_2012_I1093738

```cpp
inline ATLAS_2012_I1093738()
```
...
TodoThis looks equivalent to median(ptDensities[b]) &ndash; isn't SKIPNHARDJETS meant to be used as an offset? 
