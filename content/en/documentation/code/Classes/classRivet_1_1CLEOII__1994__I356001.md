...
title: "Rivet::CLEOII_1994_I356001"
summary: "Add a short analysis description here. "

---

# Rivet::CLEOII_1994_I356001
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#function-init)**()<br>Book histograms and initialise projections before the run.  |
...
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1cleoii__1994__i356001/">CLEOII_1994_I356001</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_3S](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--n-3s)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_n_2S](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--n-2s)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_2S_neutral](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-2s-neutral)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_1S_neutral](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-1s-neutral)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_2S_ex](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-2s-ex)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_2S_in](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-2s-in)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_1S_ex](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-1s-ex)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_3S_1S_in](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-3s-1s-in)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_2S_1S_ex](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-2s-1s-ex)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_2S_1S_in](http://example.org/classes/classrivet_1_1cleoii__1994__i356001/#variable--h-2s-1s-in)**  |
...
### variable _h_3S_2S_neutral

```cpp
Histo1DPtr _h_3S_2S_neutral;
```


### variable _h_3S_1S_neutral

```cpp
Histo1DPtr _h_3S_1S_neutral;
```


### variable _h_3S_2S_ex

```cpp
Histo1DPtr _h_3S_2S_ex;
```


### variable _h_3S_2S_in

```cpp
Histo1DPtr _h_3S_2S_in;
```


### variable _h_3S_1S_ex

```cpp
Histo1DPtr _h_3S_1S_ex;
```


### variable _h_3S_1S_in

```cpp
Histo1DPtr _h_3S_1S_in;
```


### variable _h_2S_1S_ex

```cpp
Histo1DPtr _h_2S_1S_ex;
```


### variable _h_2S_1S_in

```cpp
Histo1DPtr _h_2S_1S_in;
```
