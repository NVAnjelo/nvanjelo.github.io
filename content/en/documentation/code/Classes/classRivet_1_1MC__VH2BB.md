...
|                | Name           |
| -------------- | -------------- |
| | **[MC_VH2BB](http://example.org/classes/classrivet_1_1mc__vh2bb/#function-mc-vh2bb)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__vh2bb/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__vh2bb/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__vh2bb/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| vector< double > | **[boostAngles](http://example.org/classes/classrivet_1_1mc__vh2bb/#function-boostangles)**(const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & b1, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & b2, const <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & vb) |
...
### function boostAngles

```cpp
inline vector< double > boostAngles(
    const FourMomentum & b1,
    const FourMomentum & b2,
    const FourMomentum & vb
)
```


This should take in the four-momenta of two b's (jets/hadrons) and a vector boson, for the process VB*->VBH with H->bb It should return the smallest angle between the virtual vector boson and one of the b's, in the rest frame of the Higgs boson. It should also return (as the second element of the vector) the angle between the b's, in the rest frame of the Higgs boson. 
