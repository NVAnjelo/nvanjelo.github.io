...
title: "Rivet::ATLAS_2012_I1095236"

---

# Rivet::ATLAS_2012_I1095236
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1095236/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1095236/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1095236/#function-finalize)**() |
| | **[ATLAS_2012_I1095236](http://example.org/classes/classrivet_1_1atlas__2012__i1095236/#function-atlas-2012-i1095236)**()<br>Constructor.  |
...
```cpp
class Rivet::ATLAS_2012_I1095236;
```
...
### function ATLAS_2012_I1095236

```cpp
inline ATLAS_2012_I1095236()
```
