...
title: "Rivet::ARGUS_1989_I280943"
summary: "D_1 and D_2 spectra and decay distributions. "

---

# Rivet::ARGUS_1989_I280943



D_1 and D_2 spectra and decay distributions. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1argus__1989__i280943/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1argus__1989__i280943/#function-finddecayproducts)**(<a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> mother, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & dstar, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & d0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi, unsigned int & ncount)<br>Recursively walk the decay tree to find decay products of _p_.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1argus__1989__i280943/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1argus__1989__i280943/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1argus__1989__i280943/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1argus__1989__i280943/">ARGUS_1989_I280943</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D1_rate](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d1-rate)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2_rate](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d2-rate)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D1_x](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d1-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2_x](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d2-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D1_alpha](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d1-alpha)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_D2_alpha](http://example.org/classes/classrivet_1_1argus__1989__i280943/#variable--h-d2-alpha)**  |
...
### variable _h_D1_alpha

```cpp
Histo1DPtr _h_D1_alpha;
```


### variable _h_D2_alpha

```cpp
Histo1DPtr _h_D2_alpha;
```
