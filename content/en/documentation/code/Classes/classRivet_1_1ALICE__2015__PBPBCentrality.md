...
title: "Rivet::ALICE_2015_PBPBCentrality"

---

# Rivet::ALICE_2015_PBPBCentrality
...
|                | Name           |
| -------------- | -------------- |
| | **[ALICE_2015_PBPBCentrality](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#function-alice-2015-pbpbcentrality)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#function-init)**()<br>Initialize this analysis.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Analyse a single event.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#function-finalize)**()<br>Finalize this analysis.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_v0m](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#variable--v0m)** <br>The distribution of V0M multiplicity.  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_imp](http://example.org/classes/classrivet_1_1alice__2015__pbpbcentrality/#variable--imp)** <br>The distribution of impact parameters.  |
...
```cpp
class Rivet::ALICE_2015_PBPBCentrality;
```
...
### function ALICE_2015_PBPBCentrality

```cpp
inline ALICE_2015_PBPBCentrality()
```
