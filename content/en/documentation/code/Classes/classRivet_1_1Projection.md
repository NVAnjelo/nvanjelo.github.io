...
Base class for all <a href="http://example.org/namespaces/namespacerivet/">Rivet</a> projections.  [More...](#detailed-description)
...
Inherited by [Rivet::AxesDefinition](http://example.org/classes/classrivet_1_1axesdefinition/), [Rivet::Beam](http://example.org/classes/classrivet_1_1beam/), [Rivet::BeamThrust](http://example.org/classes/classrivet_1_1beamthrust/), [Rivet::CentralEtHCM](http://example.org/classes/classrivet_1_1centralethcm/), [Rivet::CentralityEstimator](http://example.org/classes/classrivet_1_1centralityestimator/), [Rivet::Correlators](http://example.org/classes/classrivet_1_1correlators/), [Rivet::DISDiffHadron](http://example.org/classes/classrivet_1_1disdiffhadron/), [Rivet::DISKinematics](http://example.org/classes/classrivet_1_1diskinematics/), [Rivet::DISRapidityGap](http://example.org/classes/classrivet_1_1disrapiditygap/), [Rivet::EventMixingBase](http://example.org/classes/classrivet_1_1eventmixingbase/), [Rivet::FParameter](http://example.org/classes/classrivet_1_1fparameter/), [Rivet::GammaGammaKinematics](http://example.org/classes/classrivet_1_1gammagammakinematics/), [Rivet::GammaGammaLeptons](http://example.org/classes/classrivet_1_1gammagammaleptons/), [Rivet::Hemispheres](http://example.org/classes/classrivet_1_1hemispheres/), [Rivet::HepMCHeavyIon](http://example.org/classes/classrivet_1_1hepmcheavyion/), [Rivet::InitialQuarks](http://example.org/classes/classrivet_1_1initialquarks/), [Rivet::JetFinder](http://example.org/classes/classrivet_1_1jetfinder/), [Rivet::JetShape](http://example.org/classes/classrivet_1_1jetshape/), [Rivet::METFinder](http://example.org/classes/classrivet_1_1metfinder/), [Rivet::ParisiTensor](http://example.org/classes/classrivet_1_1parisitensor/), [Rivet::ParticleFinder](http://example.org/classes/classrivet_1_1particlefinder/), [Rivet::SingleValueProjection](http://example.org/classes/classrivet_1_1singlevalueprojection/), [Rivet::TriggerCDFRun0Run1](http://example.org/classes/classrivet_1_1triggercdfrun0run1/), [Rivet::TriggerCDFRun2](http://example.org/classes/classrivet_1_1triggercdfrun2/), [Rivet::TriggerProjection](http://example.org/classes/classrivet_1_1triggerprojection/), [Rivet::TriggerUA5](http://example.org/classes/classrivet_1_1triggerua5/)
...
| std::set< ConstProjectionPtr > | **[getProjections](http://example.org/classes/classrivet_1_1projection/#function-getprojections)**() const<br>Get the contained projections, including recursion.  |
| bool | **[hasProjection](http://example.org/classes/classrivet_1_1projection/#function-hasprojection)**(const std::string & name) const<br>Does this applier have a projection registered under the name _name_?  |
| template <typename PROJ \> <br>const PROJ & | **[getProjection](http://example.org/classes/classrivet_1_1projection/#function-getprojection)**(const std::string & name) const |
| const <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> & | **[getProjection](http://example.org/classes/classrivet_1_1projection/#function-getprojection)**(const std::string & name) const |
| template <typename PROJ \> <br>const PROJ & | **[get](http://example.org/classes/classrivet_1_1projection/#function-get)**(const std::string & name) const |
...
| void | **[markAsOwned](http://example.org/classes/classrivet_1_1projection/#function-markasowned)**() const<br>Mark this object as owned by a proj-handler.  |
...
| Cmp< <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> > | **[mkNamedPCmp](http://example.org/classes/classrivet_1_1projection/#function-mknamedpcmp)**(const <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> & otherparent, const std::string & pname) const |
| Cmp< <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> > | **[mkPCmp](http://example.org/classes/classrivet_1_1projection/#function-mkpcmp)**(const <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> & otherparent, const std::string & pname) const |
| virtual <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> & | **[operator=](http://example.org/classes/classrivet_1_1projection/#function-operator=)**(const <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> & )<br>Block <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> copying.  |
| <a href="http://example.org/classes/classrivet_1_1projectionhandler/">ProjectionHandler</a> & | **[getProjHandler](http://example.org/classes/classrivet_1_1projection/#function-getprojhandler)**() const<br>Get a reference to the ProjectionHandler for this thread.  |
| template <typename PROJ \> <br>const PROJ & | **[declareProjection](http://example.org/classes/classrivet_1_1projection/#function-declareprojection)**(const PROJ & proj, const std::string & name)<br>Register a contained projection.  |
| template <typename PROJ \> <br>const PROJ & | **[declare](http://example.org/classes/classrivet_1_1projection/#function-declare)**(const PROJ & proj, const std::string & name)<br>Register a contained projection (user-facing version)  |
| template <typename PROJ \> <br>const PROJ & | **[declare](http://example.org/classes/classrivet_1_1projection/#function-declare)**(const std::string & name, const PROJ & proj)<br>Register a contained projection (user-facing, arg-reordered version)  |
...
Base class for all <a href="http://example.org/namespaces/namespacerivet/">Rivet</a> projections. 

<a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> is the base class of all Projections to be used by <a href="http://example.org/namespaces/namespacerivet/">Rivet</a>. A <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> object can be assigned to an <a href="http://example.org/classes/classrivet_1_1event/">Event</a> object and will then define a processed part of the information available in the <a href="http://example.org/classes/classrivet_1_1event/">Event</a>, which then can be used by other <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> objects and/or <a href="http://example.org/classes/classrivet_1_1analysis/">Analysis</a> objects.

The main virtual functions to be overridden by concrete sub-classes are <a href="http://example.org/classes/classrivet_1_1axesdefinition/#function-project">project(const Event &)</a> and compare(const Projection &). 
...
Block <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> copying. 
...
<a href="http://example.org/classes/classrivet_1_1event/">Event</a> is a friend. 
...
The Cmp specialization for <a href="http://example.org/classes/classrivet_1_1projection/">Projection</a> is a friend. 
