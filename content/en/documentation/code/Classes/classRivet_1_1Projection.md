...
Base class for all <a href="/documentation/code/namespaces/namespacerivet/">Rivet</a> projections.  [More...](#detailed-description)
...
Inherited by [Rivet::AxesDefinition](/documentation/code/classes/classrivet_1_1axesdefinition/), [Rivet::Beam](/documentation/code/classes/classrivet_1_1beam/), [Rivet::BeamThrust](/documentation/code/classes/classrivet_1_1beamthrust/), [Rivet::CentralEtHCM](/documentation/code/classes/classrivet_1_1centralethcm/), [Rivet::CentralityEstimator](/documentation/code/classes/classrivet_1_1centralityestimator/), [Rivet::Correlators](/documentation/code/classes/classrivet_1_1correlators/), [Rivet::DISDiffHadron](/documentation/code/classes/classrivet_1_1disdiffhadron/), [Rivet::DISKinematics](/documentation/code/classes/classrivet_1_1diskinematics/), [Rivet::DISRapidityGap](/documentation/code/classes/classrivet_1_1disrapiditygap/), [Rivet::EventMixingBase](/documentation/code/classes/classrivet_1_1eventmixingbase/), [Rivet::FParameter](/documentation/code/classes/classrivet_1_1fparameter/), [Rivet::GammaGammaKinematics](/documentation/code/classes/classrivet_1_1gammagammakinematics/), [Rivet::GammaGammaLeptons](/documentation/code/classes/classrivet_1_1gammagammaleptons/), [Rivet::Hemispheres](/documentation/code/classes/classrivet_1_1hemispheres/), [Rivet::HepMCHeavyIon](/documentation/code/classes/classrivet_1_1hepmcheavyion/), [Rivet::InitialQuarks](/documentation/code/classes/classrivet_1_1initialquarks/), [Rivet::JetFinder](/documentation/code/classes/classrivet_1_1jetfinder/), [Rivet::JetShape](/documentation/code/classes/classrivet_1_1jetshape/), [Rivet::METFinder](/documentation/code/classes/classrivet_1_1metfinder/), [Rivet::ParisiTensor](/documentation/code/classes/classrivet_1_1parisitensor/), [Rivet::ParticleFinder](/documentation/code/classes/classrivet_1_1particlefinder/), [Rivet::SingleValueProjection](/documentation/code/classes/classrivet_1_1singlevalueprojection/), [Rivet::TriggerCDFRun0Run1](/documentation/code/classes/classrivet_1_1triggercdfrun0run1/), [Rivet::TriggerCDFRun2](/documentation/code/classes/classrivet_1_1triggercdfrun2/), [Rivet::TriggerProjection](/documentation/code/classes/classrivet_1_1triggerprojection/), [Rivet::TriggerUA5](/documentation/code/classes/classrivet_1_1triggerua5/)
...
| virtual unique_ptr< <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> > | **[clone](/documentation/code/classes/classrivet_1_1projection/#function-clone)**() const =0<br>Clone on the heap.  |
| virtual | **[~Projection](/documentation/code/classes/classrivet_1_1projection/#function-~projection)**()<br>The destructor.  |
| virtual std::string | **[name](/documentation/code/classes/classrivet_1_1projection/#function-name)**() const<br>Get the name of the projection.  |
| bool | **[valid](/documentation/code/classes/classrivet_1_1projection/#function-valid)**() const<br>Get the state of the projetion.  |
| bool | **[failed](/documentation/code/classes/classrivet_1_1projection/#function-failed)**() const<br>Get the state of the projetion.  |
| virtual void | **[project](/documentation/code/classes/classrivet_1_1projection/#function-project)**(const <a href="/documentation/code/classes/classrivet_1_1event/">Event</a> & e) =0 |
| virtual CmpState | **[compare](/documentation/code/classes/classrivet_1_1projection/#function-compare)**(const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & p) const =0 |
| bool | **[before](/documentation/code/classes/classrivet_1_1projection/#function-before)**(const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & p) const |
| virtual const std::set< PdgIdPair > | **[beamPairs](/documentation/code/classes/classrivet_1_1projection/#function-beampairs)**() const |
| <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & | **[addPdgIdPair](/documentation/code/classes/classrivet_1_1projection/#function-addpdgidpair)**(PdgId beam1, PdgId beam2) |
| std::set< ConstProjectionPtr > | **[getProjections](/documentation/code/classes/classrivet_1_1projection/#function-getprojections)**() const<br>Get the contained projections, including recursion.  |
| bool | **[hasProjection](/documentation/code/classes/classrivet_1_1projection/#function-hasprojection)**(const std::string & name) const<br>Does this applier have a projection registered under the name _name_?  |
| template <typename PROJ \> <br>const PROJ & | **[getProjection](/documentation/code/classes/classrivet_1_1projection/#function-getprojection)**(const std::string & name) const |
| const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & | **[getProjection](/documentation/code/classes/classrivet_1_1projection/#function-getprojection)**(const std::string & name) const |
| template <typename PROJ \> <br>const PROJ & | **[get](/documentation/code/classes/classrivet_1_1projection/#function-get)**(const std::string & name) const |
| template <typename PROJ  =Projection\> <br>std::enable_if_t< std::is_base_of< <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a>, PROJ >::value, const PROJ & > | **[applyProjection](/documentation/code/classes/classrivet_1_1projection/#function-applyprojection)**(const <a href="/documentation/code/classes/classrivet_1_1event/">Event</a> & evt, const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & proj) const |
...
| void | **[markAsOwned](/documentation/code/classes/classrivet_1_1projection/#function-markasowned)**() const<br>Mark this object as owned by a proj-handler.  |

## Protected Functions

|                | Name           |
| -------------- | -------------- |
| <a href="/documentation/code/classes/classrivet_1_1log/">Log</a> & | **[getLog](/documentation/code/classes/classrivet_1_1projection/#function-getlog)**() const<br>Get a <a href="/documentation/code/classes/classrivet_1_1log/">Log</a> object based on the getName() property of the calling projection object.  |
| void | **[setName](/documentation/code/classes/classrivet_1_1projection/#function-setname)**(const std::string & name)<br>Used by derived classes to set their name.  |
| void | **[fail](/documentation/code/classes/classrivet_1_1projection/#function-fail)**()<br>Set the projection in an unvalid state.  |
| Cmp< <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> > | **[mkNamedPCmp](/documentation/code/classes/classrivet_1_1projection/#function-mknamedpcmp)**(const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & otherparent, const std::string & pname) const |
| Cmp< <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> > | **[mkPCmp](/documentation/code/classes/classrivet_1_1projection/#function-mkpcmp)**(const <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> & otherparent, const std::string & pname) const |
...
| <a href="/documentation/code/classes/classrivet_1_1projectionhandler/">ProjectionHandler</a> & | **[getProjHandler](/documentation/code/classes/classrivet_1_1projection/#function-getprojhandler)**() const<br>Get a reference to the ProjectionHandler for this thread.  |
| template <typename PROJ \> <br>const PROJ & | **[declareProjection](/documentation/code/classes/classrivet_1_1projection/#function-declareprojection)**(const PROJ & proj, const std::string & name)<br>Register a contained projection.  |
| template <typename PROJ \> <br>const PROJ & | **[declare](/documentation/code/classes/classrivet_1_1projection/#function-declare)**(const PROJ & proj, const std::string & name)<br>Register a contained projection (user-facing version)  |
| template <typename PROJ \> <br>const PROJ & | **[declare](/documentation/code/classes/classrivet_1_1projection/#function-declare)**(const std::string & name, const PROJ & proj)<br>Register a contained projection (user-facing, arg-reordered version)  |
...
```cpp
class Rivet::Projection;
```

Base class for all <a href="/documentation/code/namespaces/namespacerivet/">Rivet</a> projections. 

<a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> is the base class of all Projections to be used by <a href="/documentation/code/namespaces/namespacerivet/">Rivet</a>. A <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> object can be assigned to an <a href="/documentation/code/classes/classrivet_1_1event/">Event</a> object and will then define a processed part of the information available in the <a href="/documentation/code/classes/classrivet_1_1event/">Event</a>, which then can be used by other <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> objects and/or <a href="/documentation/code/classes/classrivet_1_1analysis/">Analysis</a> objects.

The main virtual functions to be overridden by concrete sub-classes are <a href="/documentation/code/classes/classrivet_1_1axesdefinition/#function-project">project(const Event &)</a> and compare(const Projection &). 
...
```cpp
virtual Projection & operator=(
    const Projection & 
)
```

Block <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> copying. 
...
<a href="/documentation/code/classes/classrivet_1_1event/">Event</a> is a friend. 

### friend Cmp< Projection >
...
The Cmp specialization for <a href="/documentation/code/classes/classrivet_1_1projection/">Projection</a> is a friend. 
