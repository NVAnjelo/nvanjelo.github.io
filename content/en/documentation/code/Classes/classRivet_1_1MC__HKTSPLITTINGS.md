...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__hktsplittings/#function-init)**()<br>Book histograms.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__hktsplittings/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & e)<br>Do the analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__hktsplittings/#function-finalize)**()<br>Finalize.  |
| | **[MC_HKTSPLITTINGS](http://example.org/classes/classrivet_1_1mc__hktsplittings/#function-mc-hktsplittings)**()<br>Default constructor.  |
...
### function MC_HKTSPLITTINGS

```cpp
inline MC_HKTSPLITTINGS()
```
