...
title: "Rivet::STAR_BES_CALIB"

---

# Rivet::STAR_BES_CALIB
...
|                | Name           |
| -------------- | -------------- |
| | **[STAR_BES_CALIB](http://example.org/classes/classrivet_1_1star__bes__calib/#function-star-bes-calib)**() |
| virtual void | **[init](http://example.org/classes/classrivet_1_1star__bes__calib/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1star__bes__calib/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1star__bes__calib/#function-finalize)**() |
...
### function STAR_BES_CALIB

```cpp
inline STAR_BES_CALIB()
```
