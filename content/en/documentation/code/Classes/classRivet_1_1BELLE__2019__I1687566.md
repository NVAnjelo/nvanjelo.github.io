...
title: "Rivet::BELLE_2019_I1687566"
summary: "Transverse Lambda polarization. "

---

# Rivet::BELLE_2019_I1687566



Transverse Lambda polarization. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1belle__2019__i1687566/">BELLE_2019_I1687566</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_pip](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-pip)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_pim](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-pim)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_Kp](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-kp)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_Km](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-km)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_pip](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-pip)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_pim](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-pim)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_Kp](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-kp)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_Km](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-km)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_inc](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-inc)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_prompt](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-prompt)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_sigma](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-lam-sigma)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_inc](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-inc)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_prompt](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-prompt)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_bar_sigma](http://example.org/classes/classrivet_1_1belle__2019__i1687566/#variable--p-bar-sigma)**  |
...
```cpp
Profile1DPtr _p_lam_inc;
```


### variable _p_lam_prompt

```cpp
Profile1DPtr _p_lam_prompt;
```


### variable _p_lam_sigma

```cpp
Profile1DPtr _p_lam_sigma;
```
...
```cpp
Profile1DPtr _p_bar_inc;
```


### variable _p_bar_prompt

```cpp
Profile1DPtr _p_bar_prompt;
```


### variable _p_bar_sigma

```cpp
Profile1DPtr _p_bar_sigma;
```


-------------------------------

Updated on 2022-07-27 at 19:09:47 +0100