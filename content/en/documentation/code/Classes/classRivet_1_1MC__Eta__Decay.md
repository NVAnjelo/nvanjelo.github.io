...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__eta__decay/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1mc__eta__decay/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pip, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pim, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & pi0, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & eta, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & gamma) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__eta__decay/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__eta__decay/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__eta__decay/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__eta__decay/">MC_Eta_Decay</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mgammagamma](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--mgammagamma)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mpi0gamma](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--mpi0gamma)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mpipgamma](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--mpipgamma)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mpimgamma](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--mpimgamma)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mpippim](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--mpippim)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_photonenergy](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--photonenergy)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_dpippim](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpippim)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_dpi0pi0](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpi0pi0)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_dpi0pip](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpi0pip)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_dpi0pim](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpi0pim)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_dpipeta](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpipeta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_dpimeta](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpimeta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_dpi0eta](http://example.org/classes/classrivet_1_1mc__eta__decay/#variable--dpi0eta)**  |
...
Histograms for the decay \(\eta\to\pi^0\gamma\gamma\) Histogram for the mass of \(\gamma\gamma\)
...
Histograms for the decay \(\eta\to\pi^+\pi^-\gamma\) Histogram for the mass of \(\pi^+\gamma\)
...
Histograms for the decay \(\eta\pi\pi\pi\) and \(\eta'\to\eta\pi\pi\). Histogram for the mass of \(\pi^+\pi^-\)
