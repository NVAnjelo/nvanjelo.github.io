...
|                | Name           |
| -------------- | -------------- |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classnantest/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classnantest/">NanTest</a> ) |
| virtual void | **[init](http://example.org/classes/classnantest/#function-init)**() |
| virtual void | **[analyze](http://example.org/classes/classnantest/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Rivet::Event</a> & event) |
