...
title: "Rivet::LHCB_2018_I1662483"
summary: "Measurement of forward top pair production in the mu e channel at LHCb. "

---

# Rivet::LHCB_2018_I1662483



Measurement of forward top pair production in the mu e channel at LHCb.  [More...](#detailed-description)
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/">LHCB_2018_I1662483</a> )<br>Default constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_fiducial_xsect](http://example.org/classes/classrivet_1_1lhcb__2018__i1662483/#variable--h-fiducial-xsect)** <br>Histogram.  |
...
```cpp
class Rivet::LHCB_2018_I1662483;
```

Measurement of forward top pair production in the mu e channel at LHCb. 

Both leptons with pt > 20 GeV and in pseudorapidity range 2.0 - 4.5. Leptons are separated from each other by a dR of 0.1. Leading jet is required to be a b-jet with pt > 20 GeV and pseudorapidity in range 2.2 - 4.2. The jet is separated from both leptons by dR of 0.5. 
