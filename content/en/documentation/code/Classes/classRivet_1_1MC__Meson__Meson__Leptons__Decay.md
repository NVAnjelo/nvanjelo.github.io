...
title: "Rivet::MC_Meson_Meson_Leptons_Decay"
summary: "MC decay M -> M l+ l-. "

---

# Rivet::MC_Meson_Meson_Leptons_Decay
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[bookHistos](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-bookhistos)**(int id1, int id2, int il, double dM) |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lp, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & lm, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & scalar, <a href="http://example.org/classes/classrivet_1_1particles/">Particles</a> & vector) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/">MC_Meson_Meson_Leptons_Decay</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| vector< long > | **[_incomingV](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--incomingv)**  |
| vector< long > | **[_outgoingP](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--outgoingp)**  |
| vector< long > | **[_outgoingf_V](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--outgoingf-v)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mff_V](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mff-v)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mPf](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mpf)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mPfbar](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mpfbar)**  |
| vector< long > | **[_incoming_P](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--incoming-p)**  |
| vector< long > | **[_outgoingV](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--outgoingv)**  |
| vector< long > | **[_outgoingf_P](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--outgoingf-p)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mff_P](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mff-p)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mVf](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mvf)**  |
| vector< <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_mVfbar](http://example.org/classes/classrivet_1_1mc__meson__meson__leptons__decay/#variable--mvfbar)**  |
