...
title: "Rivet::ATLAS_2011_I928289_W"

---

# Rivet::ATLAS_2011_I928289_W
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2011__i928289__w/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2011__i928289__w/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[fillPlots1D](http://example.org/classes/classrivet_1_1atlas__2011__i928289__w/#function-fillplots1d)**(const <a href="http://example.org/classes/classrivet_1_1wfinder/">WFinder</a> & wfinder, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist_plus, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist_minus) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2011__i928289__w/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2011_I928289_W](http://example.org/classes/classrivet_1_1atlas__2011__i928289__w/#function-atlas-2011-i928289-w)**()<br>Constructor.  |
...
inline void fillPlots1D(
    const WFinder & wfinder,
    Histo1DPtr hist_plus,
    Histo1DPtr hist_minus
)
```
...
### function ATLAS_2011_I928289_W

```cpp
inline ATLAS_2011_I928289_W()
```
