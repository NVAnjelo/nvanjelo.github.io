...
title: "Rivet::TASSO_1989_I266893"
summary: "baryons at 34.8 and 42.1 GeV "

---

# Rivet::TASSO_1989_I266893



baryons at 34.8 and 42.1 GeV 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1tasso__1989__i266893/">TASSO_1989_I266893</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_p](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-p)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_pL](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-pl)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_pTIn](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-ptin)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_pTOut](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-ptout)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_rap](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-rap)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_lam_x](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-lam-x)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_S_1](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--p-lam-s-1)**  |
| <a href="http://example.org/modules/group__useraos/#using-profile1dptr">Profile1DPtr</a> | **[_p_lam_S_2](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--p-lam-s-2)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_p](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-p)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_pL](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-pl)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_pTIn](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-ptin)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_pTOut](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-ptout)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_rap](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-rap)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_xi_x](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--h-xi-x)**  |
| int | **[_ih](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable--ih)**  |
| double | **[sqs](http://example.org/classes/classrivet_1_1tasso__1989__i266893/#variable-sqs)**  |
...
```cpp
Histo1DPtr _h_lam_pL;
```


### variable _h_lam_pTIn

```cpp
Histo1DPtr _h_lam_pTIn;
```


### variable _h_lam_pTOut

```cpp
Histo1DPtr _h_lam_pTOut;
```
...
```cpp
Histo1DPtr _h_xi_pTIn;
```


### variable _h_xi_pTOut

```cpp
Histo1DPtr _h_xi_pTOut;
```
