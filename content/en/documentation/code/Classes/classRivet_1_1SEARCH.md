...
title: "Rivet::SEARCH"
summary: "Rivet search-analysis demo. "
...
<a href="http://example.org/namespaces/namespacerivet/">Rivet</a> search-analysis demo. 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1search/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1search/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1search/#function-finalize)**()<br>Normalise SR counters to give the expected event yields.  |
| | **[DEFAULT_RIVET_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1search/#function-default-rivet-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1search/">SEARCH</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| map< string, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> > | **[_hists](http://example.org/classes/classrivet_1_1search/#variable--hists)** <br>Histograms.  |
| map< string, <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> > | **[_srs](http://example.org/classes/classrivet_1_1search/#variable--srs)** <br>Signal region yield counters.  |
| <a href="http://example.org/classes/structrivet_1_1cutflows/">Cutflows</a> | **[_flows](http://example.org/classes/classrivet_1_1search/#variable--flows)** <br>Cut-flow monitors.  |
