...
title: "Rivet::PLUTO_1983_I191161"
summary: "average pT w.r.t. thrust and sphericity axes "

---

# Rivet::PLUTO_1983_I191161



average pT w.r.t. thrust and sphericity axes 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1pluto__1983__i191161/">PLUTO_1983_I191161</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| YODA::Dbn1D | **[_p_thrust_pt](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-thrust-pt)**  |
| YODA::Dbn1D | **[_p_thrust_pt2](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-thrust-pt2)**  |
| YODA::Dbn1D | **[_p_thrust_sum_pt](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-thrust-sum-pt)**  |
| YODA::Dbn1D | **[_p_thrust_sum_pt2](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-thrust-sum-pt2)**  |
| YODA::Dbn1D | **[_p_sphere_pt](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-sphere-pt)**  |
| YODA::Dbn1D | **[_p_sphere_pt2](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-sphere-pt2)**  |
| YODA::Dbn1D | **[_p_sphere_sum_pt](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-sphere-sum-pt)**  |
| YODA::Dbn1D | **[_p_sphere_sum_pt2](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable--p-sphere-sum-pt2)**  |
| double | **[sqs](http://example.org/classes/classrivet_1_1pluto__1983__i191161/#variable-sqs)**  |
...
### variable _p_thrust_pt

```cpp
YODA::Dbn1D _p_thrust_pt;
```


### variable _p_thrust_pt2

```cpp
YODA::Dbn1D _p_thrust_pt2;
```


### variable _p_thrust_sum_pt

```cpp
YODA::Dbn1D _p_thrust_sum_pt;
```


### variable _p_thrust_sum_pt2

```cpp
YODA::Dbn1D _p_thrust_sum_pt2;
```


### variable _p_sphere_pt

```cpp
YODA::Dbn1D _p_sphere_pt;
```


### variable _p_sphere_pt2

```cpp
YODA::Dbn1D _p_sphere_pt2;
```


### variable _p_sphere_sum_pt

```cpp
YODA::Dbn1D _p_sphere_sum_pt;
```


### variable _p_sphere_sum_pt2

```cpp
YODA::Dbn1D _p_sphere_sum_pt2;
```
