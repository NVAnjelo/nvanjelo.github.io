...
title: "Rivet::ATLAS_2014_I1300647"

---

# Rivet::ATLAS_2014_I1300647
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| void | **[FillPlots1d](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-fillplots1d)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zfinder, <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| void | **[FillPlots3d](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-fillplots3d)**(const <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> & zfinder, <a href="http://example.org/classes/classrivet_1_1binnedhistogram/">BinnedHistogram</a> & binnedHist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2014_I1300647](http://example.org/classes/classrivet_1_1atlas__2014__i1300647/#function-atlas-2014-i1300647)**()<br>Constructor.  |
...
### function FillPlots1d

```cpp
inline void FillPlots1d(
    const ZFinder & zfinder,
    Histo1DPtr hist
)
```


### function FillPlots3d

```cpp
inline void FillPlots3d(
    const ZFinder & zfinder,
    BinnedHistogram & binnedHist
)
```
...
### function ATLAS_2014_I1300647

```cpp
inline ATLAS_2014_I1300647()
```
