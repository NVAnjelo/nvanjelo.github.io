...
title: "Rivet::BABAR_2012_I892684"
summary: "e+e- > K+K- + pi+pi-, pi0pi0 or K+K- "

---

# Rivet::BABAR_2012_I892684



e+e- > K+K- + pi+pi-, pi0pi0 or K+K- 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1babar__2012__i892684/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findChildren](http://example.org/classes/classrivet_1_1babar__2012__i892684/#function-findchildren)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & p, map< long, int > & nRes, int & ncount) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1babar__2012__i892684/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1babar__2012__i892684/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1babar__2012__i892684/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1babar__2012__i892684/">BABAR_2012_I892684</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cKpKmpippim](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--ckpkmpippim)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cKstarKpi](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--ckstarkpi)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cphipippim](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--cphipippim)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cphif0_980](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--cphif0-980)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cphif0_600](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--cphif0-600)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cKpKmpi0pi0](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--ckpkmpi0pi0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_cphif0pi0pi0](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--cphif0pi0pi0)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_c2Kp2Km](http://example.org/classes/classrivet_1_1babar__2012__i892684/#variable--c2kp2km)**  |
...
```cpp
CounterPtr _cKstarKpi;
```


### variable _cphipippim
...
### variable _cphif0_980

```cpp
CounterPtr _cphif0_980;
```


### variable _cphif0_600

```cpp
CounterPtr _cphif0_600;
```


### variable _cKpKmpi0pi0

```cpp
CounterPtr _cKpKmpi0pi0;
```


### variable _cphif0pi0pi0

```cpp
CounterPtr _cphif0pi0pi0;
```
...
Updated on 2022-07-27 at 19:09:45 +0100