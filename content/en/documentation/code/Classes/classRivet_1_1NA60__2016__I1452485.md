...
title: "Rivet::NA60_2016_I1452485"
summary: "form factors for omega->pi and eta->gamma "

---

# Rivet::NA60_2016_I1452485



form factors for omega->pi and eta->gamma 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| void | **[findDecayProducts](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#function-finddecayproducts)**(const <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> & mother, unsigned int & nstable, unsigned int & npi, unsigned int & nmup, unsigned int & nmum, unsigned int & ngamma, <a href="http://example.org/classes/classrivet_1_1fourmomentum/">FourMomentum</a> & ptot) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1na60__2016__i1452485/">NA60_2016_I1452485</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_eta](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#variable--h-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_omega](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#variable--h-omega)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weight_eta](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#variable--weight-eta)**  |
| <a href="http://example.org/modules/group__useraos/#using-counterptr">CounterPtr</a> | **[_weight_omega](http://example.org/classes/classrivet_1_1na60__2016__i1452485/#variable--weight-omega)**  |
...
### variable _weight_eta

```cpp
CounterPtr _weight_eta;
```


### variable _weight_omega
