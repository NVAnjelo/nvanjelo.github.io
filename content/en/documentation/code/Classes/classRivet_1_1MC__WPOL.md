...
title: "Rivet::MC_WPOL"
summary: "MC validation analysis for W polarisation. "
...
MC validation analysis for W polarisation. 
...
|                | Name           |
| -------------- | -------------- |
| | **[MC_WPOL](http://example.org/classes/classrivet_1_1mc__wpol/#function-mc-wpol)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__wpol/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__wpol/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__wpol/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
