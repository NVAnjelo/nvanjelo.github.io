...
|                | Name           |
| -------------- | -------------- |
| | **[CMS_2017_I1497519](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#function-cms-2017-i1497519)**()<br>Constructor.  |
| virtual void | **[init](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| std::unique_ptr< <a href="http://example.org/classes/classrivet_1_1particle/">Particle</a> > | **[zfinder](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#function-zfinder)**(const std::vector< <a href="http://example.org/classes/classrivet_1_1dressedlepton/">DressedLepton</a> > & leptons) |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#function-finalize)**()<br>Normalise histograms etc., after the run.  |

## Protected Attributes

|                | Name           |
| -------------- | -------------- |
| size_t | **[_mode](http://example.org/classes/classrivet_1_1cms__2017__i1497519/#variable--mode)**  |
...
### function CMS_2017_I1497519

```cpp
inline CMS_2017_I1497519()
```
...
inline std::unique_ptr< Particle > zfinder(
    const std::vector< DressedLepton > & leptons
)
```
...
**Parameters**: 
  ...
  * **leptons** pt-ordered of electron or muon collection to use to build the Z boson 


Z boson finder. Note: we don't use the standard <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> class in order to stick to the definition of the publication that is simpler than the <a href="http://example.org/classes/classrivet_1_1zfinder/">ZFinder</a> algorithm 
