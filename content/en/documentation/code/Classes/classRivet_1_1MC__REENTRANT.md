...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1mc__reentrant/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1mc__reentrant/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1mc__reentrant/#function-finalize)**()<br>Finalize.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1mc__reentrant/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1mc__reentrant/">MC_REENTRANT</a> )<br>Constructor.  |
...
```cpp
class Rivet::MC_REENTRANT;
```


Generic analysis looking att pp pseudorepidity distributions at two collision energies. It usess the possibility to read in a pre-exixsting yoda file, and if histograms for both energies are filled when <a href="http://example.org/classes/classrivet_1_1mc__reentrant/#function-finalize">finalize()</a> is called, a ratio plot is produced. 
