...
title: "Rivet::HyperCP_2005_I677384"
summary: "asymmetry in Omega-> Lambda K "

---

# Rivet::HyperCP_2005_I677384



asymmetry in Omega-> Lambda K 
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| pair< double, double > | **[calcAlpha](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#function-calcalpha)**(<a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> hist) |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[RIVET_DEFAULT_ANALYSIS_CTOR](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#function-rivet-default-analysis-ctor)**(<a href="http://example.org/classes/classrivet_1_1hypercp__2005__i677384/">HyperCP_2005_I677384</a> )<br>Constructor.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetaP](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#variable--h-cthetap)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetaM](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#variable--h-cthetam)**  |
| <a href="http://example.org/modules/group__useraos/#using-histo1dptr">Histo1DPtr</a> | **[_h_cthetaAll](http://example.org/classes/classrivet_1_1hypercp__2005__i677384/#variable--h-cthetaall)**  |
...
```cpp
Histo1DPtr _h_cthetaM;
```


### variable _h_cthetaAll

```cpp
Histo1DPtr _h_cthetaAll;
```
