...
title: "Rivet::ATLAS_2012_I1082936"

---

# Rivet::ATLAS_2012_I1082936
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[init](http://example.org/classes/classrivet_1_1atlas__2012__i1082936/#function-init)**()<br>Book histograms and initialise projections before the run.  |
| virtual void | **[analyze](http://example.org/classes/classrivet_1_1atlas__2012__i1082936/#function-analyze)**(const <a href="http://example.org/classes/classrivet_1_1event/">Event</a> & event)<br>Perform the per-event analysis.  |
| virtual void | **[finalize](http://example.org/classes/classrivet_1_1atlas__2012__i1082936/#function-finalize)**()<br>Normalise histograms etc., after the run.  |
| | **[ATLAS_2012_I1082936](http://example.org/classes/classrivet_1_1atlas__2012__i1082936/#function-atlas-2012-i1082936)**()<br>Constructor.  |
...
### function ATLAS_2012_I1082936

```cpp
inline ATLAS_2012_I1082936()
```
