...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginMC/MC_PARTONICTOPS.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginMC/MC_PARTONICTOPS.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::MC_PARTONICTOPS](http://example.org/classes/classrivet_1_1mc__partonictops/)** <br>Find and plot partonic top properties (requires tops in event record)  |
...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      declare(PartonicTops(PartonicTops::DecayMode::ALL, true, false, Cuts::OPEN, PartonicTops::WhichTop::FIRST), "AllTopsFirst"); 
