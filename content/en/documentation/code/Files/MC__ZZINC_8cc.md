...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginMC/MC_ZZINC.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginMC/MC_ZZINC.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::MC_ZZINC](http://example.org/classes/classrivet_1_1mc__zzinc/)** <br>MC validation analysis for Z[ee]Z[mumu] events.  |
...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      book(_h_ZZ_dphi ,"ZZ_dphi", 25, 0.0, PI);  
    ...
    void analyze(const Event& e) {
      ...
      const double m_epmm = (epmm.mass2() > 0) ? epmm.mass() : 0; 
