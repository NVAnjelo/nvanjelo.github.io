...
title: "/home/anarendran/Documents/temp/rivet/src/Core/yamlcpp/yaml-cpp/node/impl.h"

---

# /home/anarendran/Documents/temp/rivet/src/Core/yamlcpp/yaml-cpp/node/impl.h
...
inline void Node::reset(const RIVET_YAML::Node& rhs) {
  if (!m_isValid || !rhs.m_isValid)
    throw InvalidNode(m_invalidKey);
  m_pMemory = rhs.m_pMemory;
  m_pNode = rhs.m_pNode;
