...
title: "/home/anarendran/Documents/temp/rivet/src/Tools/Random.cc"

---

# /home/anarendran/Documents/temp/rivet/src/Tools/Random.cc
...
namespace Rivet {
  ...
  double rand01() {
    const double x = generate_canonical<double, 32>(rng()); 
    //cout << "RAND01 -> " << x << endl;
    return x;
  }
