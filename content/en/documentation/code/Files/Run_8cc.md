...
title: "/home/anarendran/Documents/temp/rivet/src/Core/Run.cc"

---

# /home/anarendran/Documents/temp/rivet/src/Core/Run.cc
...
|                | Name           |
| -------------- | -------------- |
| union | **[Rivet::magic_t](http://example.org/classes/unionrivet_1_1magic__t/)** <br>Byte/number conversion via union, for HepMC file inspection.  |
...
namespace Rivet {
  ...
  bool Run::openFile(const std::string& evtfile, double weight) {
    ...
    if (!_hepmcReader) {
      ...
      while (back < 200 && backnonempty < 100 && _istr) { 
        char c = _istr->get();
        back++;
        if (c == '\n') {
