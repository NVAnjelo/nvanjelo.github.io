...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginLEP/OPAL_1993_S2692198.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginLEP/OPAL_1993_S2692198.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::OPAL_1993_S2692198](http://example.org/classes/classrivet_1_1opal__1993__s2692198/)** <br>OPAL photon production.  |
    ...
    void analyze(const Event& e) {
      ...
      for (size_t ix = 0; ix < photons.size(); ++ix) {
        ...
        for (size_t j = 0; j < _nPhotonDurham->numBins(); ++j) {
          bool accept(true);
          double ycut = _nPhotonDurham->bin(j).xMid(); 
        ...
        for (size_t j = 0; j < _nPhotonJade->numBins(); ++j) {
          bool accept(true);
          double ycut = _nPhotonJade->bin(j).xMid(); 
          double dcut = sqr(evis)*ycut;
