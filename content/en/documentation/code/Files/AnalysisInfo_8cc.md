...
title: "/home/anarendran/Documents/temp/rivet/src/Core/AnalysisInfo.cc"

---

# /home/anarendran/Documents/temp/rivet/src/Core/AnalysisInfo.cc
...
|                | Name           |
| -------------- | -------------- |
|  | **[THROW_INFOERR](http://example.org/files/analysisinfo_8cc/#define-throw-infoerr)**(KEY)  |
|  | **[TRY_GETINFO](http://example.org/files/analysisinfo_8cc/#define-try-getinfo)**(KEY, VAR)  |
|  | **[TRY_GETINFO_DEFAULT](http://example.org/files/analysisinfo_8cc/#define-try-getinfo-default)**(KEY, VAR, DEFAULT)  |
|  | **[TRY_GETINFO_DBL](http://example.org/files/analysisinfo_8cc/#define-try-getinfo-dbl)**(KEY, VAR, DEFAULT)  |
|  | **[TRY_GETINFO_DBL_DEFAULT](http://example.org/files/analysisinfo_8cc/#define-try-getinfo-dbl-default)**(KEY, VAR, DEFAULT)  |
|  | **[TRY_GETINFO_SEQ](http://example.org/files/analysisinfo_8cc/#define-try-getinfo-seq)**(KEY, VAR)  |
...
try { if (doc[KEY] && !doc[KEY].IsNull()) ai->_ ## VAR = doc[KEY].as<string>(); } catch (...) { THROW_INFOERR(KEY); }
```


### define TRY_GETINFO_DEFAULT
...
try { if (doc[KEY] && !doc[KEY].IsNull()) ai->_ ## VAR = doc[KEY].as<string>(); } catch (...) { ai->_ ## VAR = DEFAULT; }
```


### define TRY_GETINFO_DBL
...
try { if (doc[KEY] && !doc[KEY].IsNull()) ai->_ ## VAR = doc[KEY].as<double>(); } catch (...) { THROW_INFOERR(KEY); }
```


### define TRY_GETINFO_DBL_DEFAULT
...
try { if (doc[KEY] && !doc[KEY].IsNull()) ai->_ ## VAR = doc[KEY].as<double>(); } catch (...) { ai->_ ## VAR = DEFAULT; }
```


### define TRY_GETINFO_SEQ
