...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginCMS/CMS_2015_I1370682.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginCMS/CMS_2015_I1370682.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::CMS_2015_I1370682](http://example.org/classes/classrivet_1_1cms__2015__i1370682/)** <br>Pseudo-top analysis from CMS.  |
  ...
  namespace {
    ...
    void PseudoTop::project(const Event& e) {
      ...
      if (nWLepCand == 0) { // Full hadronic case
        ...
        const pair<size_t, size_t>& idPair1 = wLepCandIdxs.begin()->second;
        const pair<size_t, size_t>& idPair2 = (++wLepCandIdxs.begin())->second;  
        const Jet& w1dau1 = leptons[idPair1.first];
        const Particle& w1dau2 = neutrinos[idPair1.second];
