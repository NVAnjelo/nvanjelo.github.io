...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginCMS/CMS_2018_I1711625.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginCMS/CMS_2018_I1711625.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::CMS_2018_I1711625](http://example.org/classes/classrivet_1_1cms__2018__i1711625/)** <br>Drell-Yan differential cross section measurement @ 13 TeV.  |
...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      book(_h_massMuMu, 3, 1, 1); 
      book(_h_massMuMuFiducial, 5, 1, 1); 
      book(_h_massEEFiducial, 6, 1, 1); 
    }
    ...
    void finalize() {
      ...
      scale(_h_massMuMu, crossSection()/picobarn/sumOfWeights()); 
      scale(_h_massMuMuFiducial, crossSection()/picobarn/sumOfWeights()); 
      scale(_h_massEEFiducial, crossSection()/picobarn/sumOfWeights()); 
