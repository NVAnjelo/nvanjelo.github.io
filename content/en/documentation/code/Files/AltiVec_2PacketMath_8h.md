...
title: "/home/anarendran/Documents/temp/rivet/include/Rivet/Math/eigen3/src/Core/arch/AltiVec/PacketMath.h"

---

# /home/anarendran/Documents/temp/rivet/include/Rivet/Math/eigen3/src/Core/arch/AltiVec/PacketMath.h
...
|                | Name           |
| -------------- | -------------- |
|  | **[EIGEN_CACHEFRIENDLY_PRODUCT_THRESHOLD](http://example.org/files/altivec_2packetmath_8h/#define-eigen-cachefriendly-product-threshold)**  |
|  | **[EIGEN_HAS_SINGLE_INSTRUCTION_MADD](http://example.org/files/altivec_2packetmath_8h/#define-eigen-has-single-instruction-madd)**  |
|  | **[EIGEN_HAS_SINGLE_INSTRUCTION_CJMADD](http://example.org/files/altivec_2packetmath_8h/#define-eigen-has-single-instruction-cjmadd)**  |
|  | **[EIGEN_ARCH_DEFAULT_NUMBER_OF_REGISTERS](http://example.org/files/altivec_2packetmath_8h/#define-eigen-arch-default-number-of-registers)**  |
|  | **[_EIGEN_DECLARE_CONST_FAST_Packet4f](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-fast-packet4f)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_FAST_Packet4i](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-fast-packet4i)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_Packet4f](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-packet4f)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_Packet4i](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-packet4i)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_Packet2d](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-packet2d)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_Packet2l](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-packet2l)**(NAME, X)  |
|  | **[_EIGEN_DECLARE_CONST_Packet4f_FROM_INT](http://example.org/files/altivec_2packetmath_8h/#define--eigen-declare-const-packet4f-from-int)**(NAME, X)  |
|  | **[DST_CHAN](http://example.org/files/altivec_2packetmath_8h/#define-dst-chan)**  |
|  | **[DST_CTRL](http://example.org/files/altivec_2packetmath_8h/#define-dst-ctrl)**(size, count, stride)  |
|  | **[_EIGEN_MASK_ALIGNMENT](http://example.org/files/altivec_2packetmath_8h/#define--eigen-mask-alignment)**  |
|  | **[_EIGEN_ALIGNED_PTR](http://example.org/files/altivec_2packetmath_8h/#define--eigen-aligned-ptr)**(x)  |
|  | **[EIGEN_PPC_PREFETCH](http://example.org/files/altivec_2packetmath_8h/#define-eigen-ppc-prefetch)**(ADDR)  |
...
### define _EIGEN_DECLARE_CONST_FAST_Packet4f
