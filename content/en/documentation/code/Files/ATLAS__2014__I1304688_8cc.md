...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginATLAS/ATLAS_2014_I1304688.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginATLAS/ATLAS_2014_I1304688.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::ATLAS_2014_I1304688](http://example.org/classes/classrivet_1_1atlas__2014__i1304688/)** <br>ATLAS 7 TeV jets in ttbar events analysis.  |
...
namespace Rivet {
  ...
  public:
    ...
    void finalize() {
      ...
      typedef map<unsigned int, Histo1DPtr>::value_type IDtoHisto1DPtr; 
      for (IDtoHisto1DPtr ihpair : _hMap) scale(ihpair.second, norm); 
      // Calc averages
      for (unsigned int ihist = 0; ihist < _histLimit ; ihist++) {
        unsigned int threshLimit = _thresholdLimit(ihist);
        for (unsigned int ithres = 0; ithres < threshLimit; ithres++) {
