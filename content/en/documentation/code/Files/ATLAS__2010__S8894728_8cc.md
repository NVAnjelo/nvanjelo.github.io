...
title: "/home/anarendran/Documents/temp/rivet/analyses/pluginATLAS/ATLAS_2010_S8894728.cc"

---

# /home/anarendran/Documents/temp/rivet/analyses/pluginATLAS/ATLAS_2010_S8894728.cc
...
|                | Name           |
| -------------- | -------------- |
| class | **[Rivet::ATLAS_2010_S8894728](http://example.org/classes/classrivet_1_1atlas__2010__s8894728/)**  |
    ...
    inline void _moments_to_stddev(Profile1DPtr moment_profiles[], Scatter2DPtr target_dps) {
      for (size_t b = 0; b < moment_profiles[0]->numBins(); ++b) { // loop over points
        ...
        if (numentries > 0) {
          ...
          sd = fuzzyLessEquals(var,0.) ? 0 : sqrt(var); 
        }
